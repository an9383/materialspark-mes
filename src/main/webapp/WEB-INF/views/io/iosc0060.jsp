...
<!-- 									<th class="text-center">승인구분</th> -->
			...
			<!--======================== .right-sidebar 등록,수정 ========================-->
                  <div class="right-list right-sidebar right-sidebar-fix" id="rfSidenav" style="width:65%; padding-bottom:0px;">
                    ...
                    <div class="row">
	                    <div class="col-md-2">
							<button type="button" class="btn btn-danger float-left mr-2" id="btnCancel" disabled>출하 취소</button>
	                    	<button type="button" class="btn btn-warning float-center mr-2" id="btnReturn" disabled>검사 반품</button>                    
	                    </div>
	                    <div class="col-md-5">
	                    	<button type="button" class="btn btn-primary float-center mr-2 btnSwitching" id="btnReturnSwitching" disabled>교체(검사 반품)</button>
	                    	<button type="button" class="btn btn-primary float-center mr-2 btnSwitching" id="btnCommonSwitching" disabled>교체(일반)</button>
	                    </div>
	                    <div class="col-md-5">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<!-- <h6>출하 취소 확인</h6> -->
      	<p>*해당 PO로 출하된 제품들 중 선택된 제품이 출하 취소됩니다.</p>
      	<p>*불량 상태가 정상인 제품들만 출하 취소가 가능합니다.</p>
      </div>
      <div class="modal-footer">
      	<button type="button" class="btn btn-danger" id="btnCancelCheck" data-dismiss="modal" style="min-width:70px;">출하 취소</button>
...
//             { data: 'approvalNm'},
    ...
    $('#btnCancel').on('click', function(){
    	...
    	if ( i == 0) {
			toastr.warning("출하 취소할 포장 No를 선택해 주세요!");
			return false;
		}
...
//     	$.ajax({
//             url: '<c:url value="/io/productOutputCancelCheck"/>',
//             type: 'GET',
//             data: {
//             	'menuAuth'	:	menuAuth,
//             	'poSeq'		:	function() { return poSeq; },
    ...
    $('#btnCancelCheck').on('click', function(){
		...
		$('#productShipmentTableDtl tbody tr').each(function(){
		 	if ( $(this).hasClass("selected") ){
				...
				rowData.removeTrayGubun = 'cancelTray';
