	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">포장리스트</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
				...
				<div class="table-responsive">
					<table id="productOutputDtlTable" class="table table-bordered">
						<thead class="thead-light">
							<!--==========table thead 추가==========-->
							<tr>
								<th style="min-width:100px;" class="text-center">포장일</th>
						...
						<tfoot>
							<tr>
								<td colspan="14" class="text-center">합계</td>
...
<script>
	...
	let productOutputDtlTable = $('#productOutputDtlTable').on( 'error.dt', function ( e, settings, techNote, message ) {
        ...
        scrollCollapse: true,
        lengthChange : true,
        pageLength: (factoryCode == '003' ? 12 : 20),
       ajax: {
        ...
        columnDefs: [
        	{ targets: [15] , render: $.fn.dataTable.render.number( ',' )},
        	{ targets: [15], className: 'text-right' }, 
        	{ targets: [19, 20], visible : (factoryCode == '003' ? true : false)},
		...
		drawCallback: function () {
			...
			//전역변수들
			var sumOutputQty = $('#productOutputDtlTable').DataTable().column(15,{ page: 'all'} ).data().sum();
...
// 	}
	...
	html1 += '<select class="custom-select" id="dateGubun"> <option value="001">포장일</option> <option value="002">마감일</option> <option value="003">작업일</option> </select> &nbsp;<div class="form-group input-sub m-0 row">';
	...
	if (factoryCode == '003') {
		html1 += '&nbsp;&nbsp;&nbsp;<input type="text" style="width:11%" class="form-control" placeholder="파레트번호를 입력해주세요." id="searchPoGroup">';
	}
