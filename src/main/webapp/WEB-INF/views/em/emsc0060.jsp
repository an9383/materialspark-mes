	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">계측기점검주기</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
				...
				<div class="card mb-2" id="formBox">
					...
					<div class="card-header card-tab p-0 mb-2">
						...
						<ul class="nav nav-tabs card-header-tabs m-0">
							<li class="nav-item">
								<a class="nav-link active show" id="tab1Nav" data-toggle="tab" href="#tab1">점검주기등록</a>
							</li>
							<li class="nav-item">
								<a class="nav-link disabled d-none" id="tab4Nav" data-toggle="tab" href="#tab4">교정이력사항</a>
							</li>
							<li class="nav-item">
		...
		$.ajax({
			...
			success : function(res) {
				...
				if (data.imageFile1 != '' && data.imageFile1 != null) {
					$('#imageFile1').attr("src",'/em/measureInstrmtAdmFileDownload?changedFile1Nm=' + changedFile1Nm   
																								+'&mitCdVal=' + mitCdVal
																								);
