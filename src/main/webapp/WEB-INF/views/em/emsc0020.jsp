					...
					<div id="addForm" class="d-none"> 
						...
						<form id="size">
							<table class="table table-bordered" id="timeView">
								...
								<tr>
									<th>조건	</th>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewWpLeftCond" 				name="wpLeftCond" 				style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewWpRightCond" 				name="wpRightCond" 				style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPitchLeftCond" 			name="pitchLeftCond" 			style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPitchRightCond" 			name="pitchRightCond" 			style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfWingLeftCond" 			name="ppfWingLeftCond" 			style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfWingRightCond"			name="ppfWingRightCond"			style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfDepthLeftCond" 			name="ppfDepthLeftCond" 		style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfDepthRightCond" 		name="ppfDepthRightCond" 		style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewFilmCond" 					name="filmCond" 				style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewMetalDepthCond" 			name="metalDepthCond" 			style="max-width:100%"  class="form-control number-float1"></input></td>
									...
									<td colspan="3"><input type="number" maxlength="8" min="-1000" max="1000" step="0.001" id="sizeViewBurrCond" 	name="burrCond" 				style="max-width:100%;" class="form-control number-float3"></input></td>
									</tr>
								<tr>
									<th>공차 (+)</th>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewWpLeftAlwncePlus" 			name="wpLeftAlwncePlus" 			style="max-width:100%;"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewWpRightAlwncePlus"			name="wpRightAlwncePlus" 			style="max-width:100%;"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPitchLeftAlwncePlus" 		name="pitchLeftAlwncePlus" 			style="max-width:100%;"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPitchRightAlwncePlus" 		name="pitchRightAlwncePlus" 		style="max-width:100%;"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfWingLeftAlwncePlus" 	name="ppfWingLeftAlwncePlus" 		style="max-width:100%;"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfWingRightAlwncePlus" 	name="ppfWingRightAlwncePlus"		style="max-width:100%;"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfDepthLeftAlwncePlus" 	name="ppfDepthLeftAlwncePlus" 		style="max-width:100%;"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfDepthRightAlwncePlus" 	name="ppfDepthRightAlwncePlus" 		style="max-width:100%;"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewFilmAlwncePlus" 			name="filmAlwncePlus" 				style="max-width:100%;"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewMetalDepthAlwncePlus" 		name="metalDepthAlwncePlus" 		style="max-width:100%;"  class="form-control number-float1"></input></td>
									...
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.001" id="sizeViewThCenterAlwncePlus" 		name="thCenterAlwncePlu" 			style="max-width:100%;"  class="form-control number-float3"></input></td>
									...
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.001" id="sizeViewGapOfLayerPlus" 			name="gapOfLayerPlus" 				style="max-width:100%"  class="form-control number-float3"></input></td>
									<td colspan="3"><input type="number" maxlength="8" min="-1000" max="1000" step="0.001" id="sizeViewBurrAlwncePlus" name="burrAlwncePlus" 			style="max-width:100%;"  class="form-control number-float3"></input></td>
								</tr>
								<tr>
									<th>공차 (-)</th>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewWpLeftAlwnceMinus" 			name="wpLeftAlwnceMinus" 			style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewWpRightAlwnceMinus" 			name="wpRightAlwnceMinus" 			style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPitchLeftAlwnceMinus" 			name="pitchLeftAlwnceMinus" 		style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPitchRightAlwnceMinus" 		name="pitchRightAlwnceMinus" 		style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfWingLeftAlwnceMinus" 		name="ppfWingLeftAlwnceMinus" 		style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfWingRightAlwnceMinus" 		name="ppfWingRightAlwnceMinus" 		style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfDepthLeftAlwnceMinus" 		name="ppfDepthLeftAlwnceMinus" 		style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewPpfDepthRightAlwnceMinus" 		name="ppfDepthRightAlwnceMinus" 	style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewFilmAlwnceMinus" 				name="filmAlwnceMinus" 				style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.1" id="sizeViewMetalDepthAlwnceMinus" 		name="metalDepthAlwnceMinus" 		style="max-width:100%"  class="form-control number-float1"></input></td>
									<td><input type="number"  maxlength="8" min="-1000" max="1000" step="0.001" id="sizeViewMetalThicknessAlwnceMinus" 	name="metalThicknessAlwnceMinus" 	style="max-width:100%"  class="form-control number-float3"></input></td>
									<td><input type="number"  maxlength="8" min="-1000" max="1000" step="0.001" id="sizeViewThCenterAlwnceMinus" 		name="thCenterAlwnceMinus" 			style="max-width:100%"  class="form-control number-float3"></input></td>
									<td><input type="number"  maxlength="8" min="-1000" max="1000" step="0.001" id="sizeViewThEdgeAlwnceMinus" 			name="thEdgeAlwnceMinus" 			style="max-width:100%"  class="form-control number-float3"></input></td>
									<td><input type="number" maxlength="6" min="-1000" max="1000" step="0.001" id="sizeViewGapOfLayerMinus" 			name="gapOfLayerMinus" 				style="max-width:100%"  class="form-control number-float3"></input></td>
									<td colspan="3"><input type="number"  maxlength="8" min="-1000" max="1000" step="0.001" id="sizeViewBurrAlwnceMinus"name="burrAlwnceMinus"				style="max-width:100%"  class="form-control number-float3"></input></td>
								</tr>
							</table>
						</form>
					</div>
	      ...
	      <div class="modal-body" style="overflow:auto;">
	      	<hr class="text-secondary">	         
                ...
                <table id="sizeTable" class="table table-bordered" style="min-width:1300px">
                    <thead class="thead-light">
                    <tr>
						<th style="min-width: 50px">치수코드</th>
						<th style="min-width: 100px">치수명</th>
						<th style="min-width: 100px">Welding Park (좌) 조건</th>
						<th style="min-width: 100px">Welding Park (우) 조건</th>
						<th style="min-width: 100px">Pitch (좌) 조건</th>
						<th style="min-width: 100px">Pitch (우) 조건</th>
						<th style="min-width: 100px">P.P Film  날개 (좌) 조건</th>
						<th style="min-width: 100px">P.P Film  날개 (우) 조건</th>
						<th style="min-width: 100px">P.P Film  폭 (좌) 조건</th>
						<th style="min-width: 100px">P.P Film  폭 (우) 조건</th>
						<th style="min-width: 100px">필름 조건</th>
						<th style="min-width: 100px">Metal(폭) 조건</th>
						<th style="min-width: 120px">Metal(두께) 조건</th>
						<th style="min-width: 120px">총두께(Center) 조건</th>
						<th style="min-width: 120px">총두께(Edge) 조건</th>
						<th style="min-width: 120px">레이러 간격 조건</th>
						<th style="min-width: 120px">BURR 조건</th>
                    </tr>
                    </thead>
				</table>
...
<script>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.result == 'ok') {
                        ...
                        $('#sizeViewGapOfLayerPlus').val(sizeData.gapOfLayerPlus);
                        $('#sizeViewGapOfLayerMinus').val(sizeData.gapOfLayerMinus);
	...
	$('#btnSave').click(function(){
		...
		sizeData.pitchRightCond				= $("#sizeViewPitchRightCond").val();
		...
		sizeData.pitchRightAlwncePlus		= $("#sizeViewPitchRightAlwncePlus").val();
		...
		sizeData.gapOfLayerPlus				= $("#sizeViewGapOfLayerPlus").val();
		...
		sizeData.pitchRightAlwnceMinus		= $("#sizeViewPitchRightAlwnceMinus").val();
		...
		sizeData.gapOfLayerMinus			= $("#sizeViewGapOfLayerMinus").val();
	...
	function uiProc(flag)
   	{ 		
        ...
        $("#sizeViewGapOfLayerPlus").attr("disabled",flag);
        ...
        $("#sizeViewGapOfLayerMinus").attr("disabled",flag);
		...
		if(sizeTable == null || sizeTable == undefined)	{
			sizeTable = $('#sizeTable').DataTable({
				...
				columns: [
					...
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['wpLeftAlwnceMinus'].concat(' ['.concat(row['wpLeftCond'].concat('] +').concat(row['wpLeftAlwncePlus']))));
		                }
		            },
		            {
		                render: function(data, type, row) {
		                    return '-'.concat(row['wpRightAlwnceMinus'].concat(' ['.concat(row['wpRightCond'].concat('] +').concat(row['wpRightAlwncePlus']))));
		                }
		            },
		            {
		                render: function(data, type, row) {
		                    return '-'.concat(row['pitchLeftAlwnceMinus'].concat(' ['.concat(row['pitchLeftCond'].concat('] +').concat(row['pitchLeftAlwncePlus']))));
		                }
		            },
		            {
		                render: function(data, type, row) {
		                    return '-'.concat(row['pitchRightAlwnceMinus'].concat(' ['.concat(row['pitchRightCond'].concat('] +').concat(row['pitchRightAlwncePlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['ppfWingLeftAlwnceMinus'].concat(' ['.concat(row['ppfWingLeftCond'].concat('] +').concat(row['ppfWingLeftAlwncePlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['ppfWingRightAlwnceMinus'].concat(' ['.concat(row['ppfWingRightCond'].concat('] +').concat(row['ppfWingRightAlwncePlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['ppfDepthLeftAlwnceMinus'].concat(' ['.concat(row['ppfDepthLeftCond'].concat('] +').concat(row['ppfDepthLeftAlwncePlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['ppfDepthRightAlwnceMinus'].concat(' ['.concat(row['ppfDepthRightCond'].concat('] +').concat(row['ppfDepthRightAlwncePlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['filmAlwnceMinus'].concat(' ['.concat(row['filmCond'].concat('] +').concat(row['filmAlwncePlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['metalDepthAlwnceMinus'].concat(' ['.concat(row['metalDepthCond'].concat('] +').concat(row['metalDepthAlwncePlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['metalThicknessAlwnceMinus'].concat(' ['.concat(row['metalThicknessCond'].concat('] +').concat(row['metalThicknessAlwncePlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['thCenterAlwnceMinus'].concat(' ['.concat(row['thCenterCond'].concat('] +').concat(row['thCenterAlwncePlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['thEdgeAlwnceMinus'].concat(' ['.concat(row['thEdgeCond'].concat('] +').concat(row['thEdgeAlwncePlus']))));
		                }
		            },
		            {
		                render: function(data, type, row) {
		                    return '-'.concat(row['gapOfLayerMinus'].concat(' ['.concat(row['gapOfLayerCond'].concat('] +').concat(row['gapOfLayerPlus']))));
		                }
		            },
					{
		                render: function(data, type, row) {
		                    return '-'.concat(row['burrAlwnceMinus'].concat(' ['.concat(row['burrCond'].concat('] +').concat(row['burrAlwncePlus']))));
		                }
		            },
				],
				order: [
		    	...
		    	sizeCondCd = $(this).closest('tr').attr('id');
		         $.ajax({
                    ...
                    success: function (res) {
                        ...
                        $('#sizeViewPitchRightCond').val(data.pitchRightCond);                      
                        $('#sizeViewPitchRightAlwncePlus').val(data.pitchRightAlwncePlus);          
                        $('#sizeViewPitchRightAlwnceMinus').val(data.pitchRightAlwnceMinus);        
                        ...
                        $('#sizeViewGapOfLayerPlus').val(data.gapOfLayerPlus);
                        $('#sizeViewGapOfLayerMinus').val(data.gapOfLayerMinus);
