...
<div class="app pda_mo_wrap" style="display: flex; flex-direction: column; height: 100%;">
	<header class="pda_mo_hd">
		<a href="/pdsc0070" class="float-left"><img class="p-2" src="/resources/assets/images/mo_home_wh.png"></a> <a href="/pdsc3060"><p class="mo_main_title">창고위치 지정</p></a>
	</header>
	<!--====-sortbox-->
	<div class="mo_sortbox">
		...
		<!-- <div class="col-12 row p-1">
			<div class="col-3">
				<div class="mo_sort_title ml-1">
					<label style="font-size: 20px;line-height: 10px;background-color: lightpink;">미료</label>
				</div>
			</div>
			...
			<div class="col-3">
				<div class="mo_sort_title ml-1">
					<label style="font-size: 20px;line-height: 10px;background-color: lightgreen;">완공</label>
				</div>
			</div>
			<div class="form-group input-sub col-3 m-0 p-0">
		...
		<!-- 창고 번호 선택 하는 부분 -->
		<div class="col-12 row p-1">
			<div class="col-4 mo_sort_title">창고지정</div>
...
// 				}
	...
	function uiProc(flag) {
		...
		$('#location').attr('disabled', flag);					//창고버튼
		...
		if(event.keyCode == 13){
			...
			$.ajax({
				...
				data : {
					...
					'completeYn'	:	function() { return "'Y'";				},	//완공된 상태의 자재만
					'goodsStatus'	:	function() { return "'002', '004'";		},
				},
				success : function(res) {
					let data = res.data;
