...
<div class="page-wrapper" id="page-wrapper">
	    ...
	    <div class="modal-dialog modal-lg" role="document" style="margin-top: 3%;">
	        <div class="modal-content" style="width: 70%; margin-left: 20%; margin-top: 20%;">
	            ...
	            <div class="modal-body">
					...
					<label>*교체 전(MetalLot)가 생산실적(Tray)에 등록되어있는 경우 교체가 불가합니다.</label>
	...
	<!--주자재 교체 모달 -->
	<!-- 작업자 변경 모달 -->
	<div class="modal fade bs-example-modal-lg shadow-lg" id="workerChangeModal" tabindex="-1" role="dialog" aria-labelledby="workerChangeModalLabel" aria-hidden="true" data-keyboard="false">
		<div class="row">
		    <div class="modal-dialog modal-lg" role="document" style="width: 85vh;">
		        <div class="modal-content" style="width: 60%; margin-left: 30%; margin-top: 20%;" id="workerChangeContent">
		            <div class="modal-header">
		           		<h5 class="modal-title" id="workerChangeModalLabel">작업자 변경 확인</h5>
		           		<div>
		           			<button type="button" class="btn btn btn-primary touch6" id="btnWorkerHistory">이전 작업자 조회</button>
		           		</div>
		            </div>
		            <div class="modal-body">
		            	<br>
						<div class="mb-2 row">
							<label class="input-label-sm touch6">작업자 조회</label>
							<input type="hidden" class="form-control" id="workerIdCd"  name="workerIdCd">
							<input type="hidden" class="form-control" id="workTeamCd"  name="workTeamCd">
		                    <div class="input-sub m-0">
								<input type="text" class="form-control touch6" id="workerIdNm"  name="workerIdNm" readonly>
		                 	  	<button type="button" class="btn btn-primary input-sub-search" style="height: 30px;" id="btnSelectWorkerId" onClick="selectPreWorkCharger('prodWorker')">
									<span class="oi oi-magnifying-glass" style="font-size: 20px;"></span>
						        </button>
					        </div>
				        </div>
				        <h6>진행중인 작업자가 있습니다. 작업자를 변경하시겠습니까?</h6>
				    	<p id="workerChangeModalAfter"></p>
				    </div>
		            <div class="modal-footer" id="divSudel">
		            	<button type="button" class="btn btn btn-primary touch6" style="width: 16%;" id="btnModalWorkerChange">변경</button>
		            	<button type="button" class="btn btn-secondary touch6" style="width: 16%;" data-dismiss="modal">닫기</button>
		            </div>
		        </div>
		    </div>
		    ...
		    <!-- 이전 작업자 조회 -->
			<div class="modal-dialog modal-lg" style="width: 85vh; display: none;" id="workerHistoryModal">
				<div class="modal-content" style="width: 60%; margin-top: 20%;" id="workerHistoryContent">
					<div class="modal-header">
						<h5 class="modal-title" id="">이전 작업자 정보 확인</h5>
<!-- 						<label style="font-size: 22px;font-weight: 300;line-height: 30px; margin-left: 20px;" id="workerHistoryLabel"></label> -->
						<button type="button" class="close" id="workerHistoryClose">
							<span aria-hidden="true">←</span>
						</button>
					</div>
					
					<label class="ml-3">*현재 작업지시 번호( <span style="font-weight: 600;" id="workerHistoryLabel"></span> )로 조회됩니다.</label>
					
					 <div class="modal-body">
					 	<!-- 이전 작업자테이블 조회 -->
					 	<table class="table table-sm table-bordered" id="workerHistoryTable">
					 		<thead>
					 			<tr>
					 				<th>작업자</th>
					 				<th>작업 상태</th>
	...
	<!-- 										<input type="text" id="notRunningDesc" name="notRunningDesc" style="max-width: 100%;" class="form-control"/> -->
										</td>
									</tr>
										...
										<td>
											...
											<!-- <div class="row">
												<div class="col-9 text-center">
													<label id="notRunningLabel_052">생산-공정 조정</label>
												</div>
												<div class="col-3 text-center">
													<input type="radio" style="width:20px; height:20px" value="052" id="notRunningType_052" name="notRunningType">
												</div>	
											</div>
											
											<div class="row mt-2">
												<div class="col-9 text-center">
													<label id="notRunningLabel_053">생산-원자재불량 교체</label>
												</div>
												<div class="col-3 text-center">
													<input type="radio" style="width:20px; height:20px" value="053" id="notRunningType_053" name="notRunningType">
												</div>	
											</div>
											
											<div class="row mt-2">
												<div class="col-9 text-center">
													<label id="notRunningLabel_054">생산-교체 Loss</label>
												</div>
												<div class="col-3 text-center">
													<input type="radio" style="width:20px; height:20px" value="054" id="notRunningType_054" name="notRunningType">
												</div>	
											</div>
												
											<div class="row mt-2">
												<div class="col-9 text-center">
													<label id="notRunningLabel_055">생산-설비 부품 교체</label>
												</div>
												<div class="col-3 text-center">
													<input type="radio" style="width:20px; height:20px" value="055" id="notRunningType_055" name="notRunningType">
												</div>	
											</div>-->
										</td>
									</tr>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn btn-secondary touch6" id="btnNotRunningCancel" data-dismiss="modal" style="min-width: 70px;">취소</button>
				</div>
			</div>
		</div>
	</div>
	<!-- 비가동 시작 모달 -->
	<!-- 잔량등록 모달 -->
	<div class="modal fade bd-example-modal-lg" id="remainQtyPopUpModal" tabindex="-1" role="dialog" aria-labelledby="remainQtyPopUpModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="remainQtyPopUpLabel">잔량등록</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					...
					<table id="remainQtyPopUpTable" class="table table-bordered" style="width:70%; margin-left:auto; margin-right:auto;">
						<colgroup>
							<col width="40%">
							<col width="60%">
						</colgroup>
						<thead class="thead-light">
							<tr>
								<th>바코드</th>
								<td class="text-center" id="rqBarcodeNo" style="font-size: 18px; font-weight: 100;"></td>
							</tr>
							<tr>
								<th>가입고량</th>
								<td class="text-center" id="rqPreInWhsQty" style="font-size: 18px; font-weight: 100;"></td>
							</tr>
							<tr>
								<th>잔량</th>
								<td><input type="text" class="form-control number-float2 text-right" id="rqRemainQty" value="0" min="0" max="100" style="font-size: 18px; font-weight: 100; margin-left: 18%;"></td>
							</tr>
						</thead>
					</table>
					<hr class="text-secondary">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary touch6" style="width: 13%;" id="btnRqSave">저장</button>
					<button type="button" class="btn btn-secondary touch6" style="width: 13%;" data-dismiss="modal">닫기</button>
				</div>
			</div>
		</div>
	</div>
	...
	<header class="page-title-bar row">
		...
		<h5 class="monitor-status">
			<span class="monitor-status" id="monitoringLoder" style="margin-left:auto; display:none" >
				<img src="<c:url value='/resources/assets/images/loader2.gif'/>" style="width: 26px;">&nbsp;&nbsp;
			</span>
		</h5>
		<h5 id="agtEquipListTitle" class="" style="display: none;">
		</h5>
	</header>
	<!-- #main============================================================== -->
				...
				<div class="card-body p-3">
					...
					<div class="row" style="position:relative">
						...
						<div>
							...
							<label class="input-label-sm touch6 mt-3" style="font-size: 25px; font-weight: 300; position: absolute; left: 0;" id="workUserNm">현재 작업자가 없습니다.</label>
							<input type="hidden" id="workUserCd">
						</div>
						<!-- 
						<div class="form-group input-sub m-0 row">
							<input class="form-control" style="width:97px;" type="text" id="ordDate" name="ordDate" />
						...
						<div class="row">
							<div style="display: flex; flex-direction: column;">
								<button type="button" class="btn btn-primary ml-3 touch6" id="btnAddWorkOrder" style="margin-top:3px;">작업지시 추가</button>
								<button type="button" class="btn btn-danger  ml-3 touch6"  id="btnDeleteWorkOrder" style="margin-top:3px;">작업지시 삭제</button>
							</div>
							
							<div style="display: flex; flex-wrap: wrap; width: 15rem; align-content: flex-start;">
								<button type="button" class="btn btn-primary ml-4 touch6" id="btnStart" style="margin-top:3px; width: 100px; height: 47px;">작업 시작</button>
								<button type="button" class="btn btn-primary ml-1 touch6 d-none" id="btnReStart" style="margin-top:3px; width: 100px; height: 47px; background-color: sienna;color: white;">완료 취소</button>
								<button type="button" class="btn btn-primary ml-4 touch6 d-none" id="btnCancel" style="margin-top:3px; width: 100px; height: 47px;">진행 취소</button>
								<button type="button" class="btn btn-success ml-1 touch6" id="btnEnd" style="margin-top:3px; width: 100px; height: 47px;">작업 종료</button>
								<button type="button" class="btn btn-danger ml-4 touch6" id="btnNotRunning_start" style="margin-top:3px;  width: 100px; height: 46px;">비가동 시작</button>
								<button type="button" class="btn ml-1 touch6" id="btnNotRunning_end" style="margin-top:3px;  width: 100px; height: 46px; color: #ffffff; background-color: #EC935E; border-color: #db6e2d;">비가동 종료</button>
							</div>
							
							<div style="display: flex; flex-direction: column;">
								<button type="button" class="btn btn-primary ml-3 touch6 d-none" id="btnOrdLotNoFirstStepNew"	style="margin-top:3px;">초물</button>						
								<button type="button" class="btn btn-primary ml-3 touch6" id="btnOrdLotNoSecondStepNew"	style="margin-top:3px;	display:none;">중물</button>
								<button type="button" class="btn btn-primary ml-3 touch6" id="btnOrdLotNoThirdStepNew"	style="margin-top:3px;	display:none;">종물</button>
							</div>
...
<!-- 							<button type="button" class="btn btn-primary float-right touch6 d-none" id="btnCancel" style="margin-right: 5px;">진행 취소</button> -->
				...
				<div class="card" id="workOrderTableCard">
					<div class="col-md-12 matrl-top-list w_scroll" style="overflow:scroll; min-height:285px; max-height:285px;">
						<div class="table-responsive">
							<table id="workOrderTable" class="table table-bordered">
								...
								<thead class="thead-light">
									<tr>
										...
										<th style="width:40px">초물등록여부</th>
										<th style="width:40px">시작시간</th>
										<th style="width:40px">종료시간</th>
									</tr>
								</thead>
							</table>
						</div>
					...
					<div class="col-md-12 matrl-bottom-list" style="min-height: 320px;">
						...
						<div class="table-responsive w_scroll" style="max-height: 260px;">
			...
			<div class="right-list right-70" id="rightList" style="width:9.5%; min-height:825px;">
				...
				<div class="btn-group-vertical" id="btnCard" style="width: 100%;">
					...
					<button type="button" class="btn btn-primary btn-lg btnRight" style="    display: none;" id="btnFaulty">불량중량 입력</button>
					
					<button type="button" class="btn btn-purple btn-lg btnRight" style="    display: none;" id="btnMonitoring">POP 모니터링</button>
					
					<button type="button" class="btn btn-orange btn-lg btnRight" style="    display: none;" id="btnMonitoringHistory">모니터링 기록</button>
					<span><br></span>
					<button type="button" class="btn btn-outline-secondary btn-lg btnRight btn-primary" id="btnMonitoringOnOff" style="color:white;     display: none;">모니터링 ON</button>


					<button type="button" class="btn btn-primary btn-lg btnRight" id="btnWorkerChange">작업자 변경</button>
					<span><br></span>
					...
					<span><br></span>
					<button type="button" class="btn btn-primary btn-lg btnRight" id="btnOutput">생산실적 조회</button>
					<span><br></span>
					...
					<span><br></span>
					<button type="button" class="btn btn-primary btn-lg btnRight" id="btnRemainQty">잔량등록</button>
					<span><br></span>
					<!-- 
				...
				<div class="d-none" id="outPutCard"><!-- right-list 클래스 추가 후 rowspan 부분 회색으로 되지만 스크롤, 및 띠 생김 -->
					...
					<div style="width: 80vh; overflow-x: auto;">
						<table class="table table-bordered" id="outputCardTable" style="padding-left:0px; padding-right:0px;">
							<thead class="thead-light">
								<tr>
			                        <th class="text-center" style="min-width:140px;">생산전표번호</th>
			                        <th class="text-center" style="min-width:70px;">전표일자</th>
			                        <th class="text-center" style="min-width:65px;">생산 수량(Ea)</th>
			                        <th class="text-center" style="min-width:55px;">비전 검사<br> 수량(Ea)</th>
			                        <th class="text-center" style="min-width:65px;">총 합 수량<br>(Ea)</th>
									<th class="text-center" style="min-width:40px;">생산<br>작업자</th>
			                        <th class="text-center" style="min-width:60px;">검사<br>작업자</th>
			                        <th class="text-center" style="min-width:50px;">상태</th>
								</tr>
							</thead>
							<tfoot>
								<tr>
									<td colspan="2" style="text-align: center">합계</td>
									<td colspan="" id="output_sumProduceCnt" style="text-align:right;">0</td>
									<td colspan="" id="output_sumVisionCnt" style="text-align:right; color:orange">0</td>
									<td colspan="" id="output_sumTotalCnt" style="text-align:right;">0</td>
...
<%-- 							<colgroup><col width="70%"></colgroup>		 --%>
				...
				<!-- 생산실적(Tray) 
				<div class="d-none" id="trayCard">
					<div class="table-responsive">
						<table class="table table-sm table-bordered" id="trayLabelTable">
							<thead></thead>
							<tbody></tbody>
						</table>
						<br><br>
						<div class="eow" id="sudelDiv"></div>
					</div>
				</div>
				생산실적(Tray)끝 -->
...
<div class="modal fade" id="changeRegistrantPopUp" tabindex="-1" role="dialog" aria-labelledby="workOrdEndCheckPopupModalLabel" aria-hidden="true" style="z-index:1049;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="changeRegistrantLabel">생산작업자 변경 확인</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				...
				<div class="input-sub m-0 ">
				 ...
				 <label><h6>생산완료된 작업자 상태값이 변경됩니다.</h6></label>
				 <h6>변경하시겠습니까?</h6>
				
			</div>
			<div class="modal-footer">			
				<button type="button" class="btn btn-danger touch6" id="bntchangeRegistrant" data-dismiss="modal" style="min-width: 70px;" disabled>생산작업자 변경</button>
...
<div class="modal fade bd-example-modal-lg" id="changeRegistranUserListAllPopUp" tabindex="-1" role="dialog" aria-labelledby="workOrdEndCancelPopupModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" style="min-width: 1300px">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="changeRegistranUserAllLabel">변경 가능한 생산작업자 목록</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<div class="modal fade bd-example-modal-lg" id="ordLotNoStepModal" tabindex="-1" role="dialog" aria-labelledby="matrlDtlTableModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" style="min-width:800px;">
		<div class="modal-content w_scroll" style="height: 93vh;overflow-y: scroll;overflow-x: hidden;">
...
<%-- 											<colgroup><col width="10%"></colgroup> --%>
											<tr>
						                        ...
						                        <th rowspan="3" class="touch3">시료</th>
						                        <th rowspan="3" class="touch3">조건</th>
						                        <th colspan="1" class="touch3">측정시간</th>
											</tr>
											<tr>
												<th class="touch3">초물</th>
						                        <th class="touch3" style="display: none;">중물</th>
						                        <th class="touch3" style="display: none;">종물</th>
											</tr>
											<tr>
												<td><input type="time" maxlength="5" class="form-control text-center touch3" id="firstRegTime" placeholder="HH:MM" disabled></td>
						                        <td style="display: none;"><input type="time" maxlength="5" class="form-control text-center touch3" id="secondRegTime" placeholder="HH:MM" disabled></td>
						                        <td style="display: none;"><input type="time" maxlength="5" class="form-control text-center touch3" id="thirdRegTime" placeholder="HH:MM" disabled></td>
											</tr>
											<tr>
												<th class="touch3">예열</th>
												<th class="touch3"></th>
												<th class="touch3"><span id="warmupCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstWarmupCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondWarmupCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdWarmupCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3" rowspan="2">가접1</th>
												<th class="touch3">(상)</th>
												<th class="touch3"><span id="fitup1UpCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFitup1UpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFitup1UpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFitup1UpCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하)</th>
												<th class="touch3"><span id="fitup1DownCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFitup1DownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFitup1DownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFitup1DownCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3" rowspan="4">가접2</th>
												<th class="touch3">(상좌)</th>
												<th class="touch3"><span id="fitup2UpleftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFitup2UpleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFitup2UpleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFitup2UpleftCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하좌)</th>
												<th class="touch3"><span id="fitup2DownleftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFitup2DownleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFitup2DownleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFitup2DownleftCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(상우)</th>
												<th class="touch3"><span id="fitup2UprightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFitup2UprightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFitup2UprightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFitup2UprightCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하우)</th>
												<th class="touch3"><span id="fitup2DownrightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFitup2DownrightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFitup2DownrightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFitup2DownrightCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3" rowspan="2">롤히터</th>
												<th class="touch3">(상)</th>
												<th class="touch3"><span id="rollheatUpCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstRollheatUpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondRollheatUpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdRollheatUpCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하)</th>
												<th class="touch3"><span id="rollheatDownCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstRollheatDownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondRollheatDownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdRollheatDownCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3" rowspan="4">1차</th>
												<th class="touch3">(상좌)</th>
												<th class="touch3"><span id="firstUpleftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFirstUpleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFirstUpleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFirstUpleftCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하좌)</th>
												<th class="touch3"><span id="firstDownleftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFirstDownleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFirstDownleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFirstDownleftCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(상우)</th>
												<th class="touch3"><span id="firstUprightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFirstUprightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFirstUprightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFirstUprightCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하우)</th>
												<th class="touch3"><span id="firstDownrightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFirstDownrightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFirstDownrightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFirstDownrightCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3" rowspan="2">1차 푸셔</th>
												<th class="touch3">(상)</th>
												<th class="touch3"><span id="push1UpCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstPush1UpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondPush1UpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdPush1UpCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하)</th>
												<th class="touch3"><span id="push1DownCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstPush1DownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondPush1DownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdPush1DownCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3" rowspan="4">2차</th>
												<th class="touch3">(상좌)</th>
												<th class="touch3"><span id="secondUpleftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstSecondUpleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondSecondUpleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdSecondUpleftCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하좌)</th>
												<th class="touch3"><span id="secondDownleftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstSecondDownleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondSecondDownleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdSecondDownleftCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(상우)</th>
												<th class="touch3"><span id="secondUprightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstSecondUprightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondSecondUprightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdSecondUprightCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하우)</th>
												<th class="touch3"><span id="secondDownrightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstSecondDownrightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondSecondDownrightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdSecondDownrightCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3" rowspan="4">3차</th>
												<th class="touch3">(상좌)</th>
												<th class="touch3"><span id="thirdUpleftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstThirdUpleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondThirdUpleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdThirdUpleftCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하좌)</th>
												<th class="touch3"><span id="thirdDownleftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstThirdDownleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondThirdDownleftCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdThirdDownleftCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(상우)</th>
												<th class="touch3"><span id="thirdUprightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstThirdUprightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondThirdUprightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdThirdUprightCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하우)</th>
												<th class="touch3"><span id="thirdDownrightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstThirdDownrightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondThirdDownrightCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdThirdDownrightCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3" rowspan="2">진접1</th>
												<th class="touch3">(상)</th>
												<th class="touch3"><span id="jinjeop1UpCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstJinjeop1UpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondJinjeop1UpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdJinjeop1UpCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하)</th>
												<th class="touch3"><span id="jinjeop1DownCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstJinjeop1DownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondJinjeop1DownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdJinjeop1DownCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3" rowspan="2">진접2</th>
												<th class="touch3">(상)</th>
												<th class="touch3"><span id="jinjeop2UpCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstJinjeop2UpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondJinjeop2UpCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdJinjeop2UpCond" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(하)</th>
												<th class="touch3"><span id="jinjeop2DownCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstJinjeop2DownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondJinjeop2DownCond"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdJinjeop2DownCond" disabled></td>
											</tr>
										</table>
									</div>
									<div class="tab-pane fade" id="tab2">
...
<%-- 											<colgroup><col width="10%"></colgroup> --%>
											...
											<tr>
												...
												<th><span class="cond touch3" id="wpLeftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstWpLeftAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondWpLeftAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdWpLeftAlwnce" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(우)</th>
												<th class="touch3"><span id="wpRightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstWpRightAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondWpRightAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdWpRightAlwnce" disabled></td>
											</tr>
											<tr>
												<th rowspan="2" class="touch3">Pitch</th>
												<th class="touch3">(좌)</th>
												<th class="touch3"><span class="cond" id="pitchLeftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstPitchLeftAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondPitchLeftAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdPitchLeftAlwnce" disabled></td>
											</tr>                                                                                       
											<tr>
												<th class="touch3">(우)</th>
												<th class="touch3"><span class="cond" id="pitchRightCond"></span></th>                                                                         
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstPitchRightAlwnce" ></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondPitchRightAlwnce" ></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdPitchRightAlwnce" disabled></td>
											</tr>
											<tr>
												<th rowspan="2" class="touch3">P.P Film 날개</th>
												<th class="touch3">(좌)</th>
												<th class="touch3"><span class="cond" id="ppfWingLeftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstPpfWingLeftAlwnce" ></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondPpfWingLeftAlwnce" ></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdPpfWingLeftAlwnce" disabled></td>
											</tr>
											<tr>
												<th class="touch3">(우)</th>
												<th class="touch3"><span class="cond" id="ppfWingRightCond"></span></th>                                                                         
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstPpfWingRightAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondPpfWingRightAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdPpfWingRightAlwnce" disabled></td>
											</tr>
											<tr>                                
												<th rowspan="2" class="touch3">P.P Film 폭</th>
												<th class="touch3">(좌)</th>
												<th><span class="cond" id="ppfDepthLeftCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstPpfDepthLeftAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondPpfDepthLeftAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdPpfDepthLeftAlwnce" disabled></td>
											</tr>
											<tr>                                                                                        
												<th class="touch3">(우)</th>
												<th class="touch3"><span class="cond" id="ppfDepthRightCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstPpfDepthRightAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondPpfDepthRightAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdPpfDepthRightAlwnce" disabled></td>
											</tr>
											<tr>                                
												<th class="touch3">Film</th>
												<th class="touch3">총길이</th>
												<th class="touch3"><span class="cond" id="filmCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstFilmAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondFilmAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdFilmAlwnce" disabled></td>
											</tr>
											<tr>
												<th rowspan="2" class="touch3">METAL</th>
												<th class="touch3">폭</th>
												<th class="touch3"><span class="cond" id="metalDepthCond"></span></th>
												<td><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstMetalDepthAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondMetalDepthAlwnce"></td>
												<td style="display: none;"><input maxlength="6" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdMetalDepthAlwnce" disabled></td>
											</tr>
											<tr>
												<th class="touch3">두께</th>
												<th class="touch3"><span class="cond" id="metalThicknessCond"></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstMetalThicknessAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondMetalThicknessAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdMetalThicknessAlwnce" disabled></td>
											</tr>
											<tr>
												<th rowspan="2" class="touch3">총두께</th>
												<th class="touch3">Center</th>
												<th class="touch3"><span class="cond" id="thCenterCond"></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstThCenterAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondThCenterAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdThCenterAlwnce" disabled></td>
											</tr>                                                                                       
											<tr>
												<th class="touch3">Edge</th>
												<th class="touch3"><span class="cond" id="thEdgeCond"></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstThEdgeAlwncePlus"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondThEdgeAlwncePlus"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdThEdgeAlwncePlus" disabled></td>
											</tr>
											<tr>
												<th rowspan="3" class="touch3">Burr (MAX)</th>
												<th class="touch3">Metal</th>
												<th class="touch3"><span class="cond" id="burrCond"></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBurrMetalAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBurrMetalAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBurrMetalAlwnce" disabled></td>
											</tr>
											<tr>
												<th class="touch3">R-Cut</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBurrRcutAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBurrRcutAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBurrRcutAlwnce"disabled></td>
											</tr>
											<tr>
												<th class="touch3">R끝단</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBurrRedgeAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBurrRedgeAlwnce"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBurrRedgeAlwnce" disabled></td>
											</tr>
											<tr>
												<th rowspan="2" class="touch3">돌기크기<br>좌상</th>
												<th class="touch3">높이</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBulgeLeftupHeight"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBulgeLeftupHeight"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBulgeLeftupHeight" disabled></td>
											</tr>
											<tr>
												<th class="touch3">넓이</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBulgeLeftupWidth"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBulgeLeftupWidth"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBulgeLeftupWidth" disabled></td>
											</tr>
											<tr>
												<th rowspan="2" class="touch3">돌기크기<br>좌하</th>
												<th class="touch3">높이</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBulgeLeftdownHeight"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBulgeLeftdownHeight"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBulgeLeftdownHeight" disabled></td>
											</tr>
											<tr>
												<th class="touch3">넓이</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBulgeLeftdownWidth"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBulgeLeftdownWidth"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBulgeLeftdownWidth" disabled></td>
											</tr>
											<tr>
												<th rowspan="2" class="touch3">돌기크기<br>우상</th>
												<th class="touch3">높이</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBulgeRightupHeight"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBulgeRightupHeight"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBulgeRightupHeight" disabled></td>
											</tr>
											<tr>
												<th class="touch3">넓이</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBulgeRightupWidth"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBulgeRightupWidth"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBulgeRightupWidth" disabled></td>
											</tr>
											<tr>
												<th rowspan="2" class="touch3">돌기크기<br>우하</th>
												<th class="touch3">높이</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBulgeRightdownHeight"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBulgeRightdownHeight"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBulgeRightdownHeight" disabled></td>
											</tr>
											<tr>
												<th class="touch3">넓이</th>
												<th class="touch3"><span class="cond" id=""></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstBulgeRightdownWidth"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondBulgeRightdownWidth"></td>
												<td style="display: none;"><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdBulgeRightdownWidth" disabled></td>
											</tr>
										</table>
									</div>
								</div>
...
<div class="modal fade" id="ptfe1PopupModal" tabindex="-1" role="dialog" aria-labelledby="ptfe1PopupModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
		...
		<table class="table table-bordered">
			<colgroup>
				...
				<tr>
				    <th>주야 구분</th>
				    <td class="text-center">
				    	<select class="custom-select custom-select-md touch6" id="ptfe1DayNight" style="min-width:100%;" disabled>				    	
      ...
      <div class="modal-footer">
      	<button type="button" class="btn btn-danger mr-a touch6" id="ptfe1Delete" style="min-width:70px;">삭제</button>
		...
		<table class="table table-bordered">
			<colgroup>
				...
				<tr>
				    <th>교체 일자</th>
				    <td class="text-center">
				    	<input type="datetime-local" id="ptfe2Date" min="1900-01-01T00:00" max="2100-12-31T00:00" class="form-control dayTime touch6" style="min-width:100%; padding-right: 0px; padding-left:3px;" disabled>
				    </td>				 
				</tr>
				<tr>
				    <th>주야 구분</th>
				    <td class="text-center">
				    	<select class="custom-select custom-select-md touch6" id="ptfe2DayNight" style="min-width:100%;" disabled>				    	
				    		<option value="D">주간</option>
				    		<option value="N">야간</option>
				    	 </select>
				    </td>				 
		...
		<div class="modal-content" style="width: 190vh;margin-left: -52vh;">
			...
			<div class="modal-body">
				...
				<div class="mt-1 mb-3" style="display: flex;border: 1px solid black;width: 30vh;align-items: center;justify-content: center;flex-wrap: nowrap;">
						<div style="width: 30px;height: 30px;background-color: indianred;border-radius: 50px;" id="mixColor"></div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p style="margin-bottom:0px;">*작업이 완료된 경우 삭제 시 다음 작지에서도 값이 삭제 됩니다.</p>
			</div>
			<div class="modal-footer">
...
<script>
	...
	let menuAuth = 'posc3010';
	let currentHref = 'posc3010';
	...
	var workerChange_userNumber	= "${userNumber}";

	
	if(factoryCode == '001'){
		//1공장 코드
		$("#btnFaulty").attr('style', "");
		...
		//3공장 코드
		$("#btnFaulty").attr('style', "display: none;");
	}
	else{
		toastr.error("시스템오류입니다. 관리자에게 문의해주세요.");
	}
	...
	var workerChange_workTeamCd = null;			//작업조

	let trayFunctionCheck = false;
...
// 		rowsGroup: [ [0], [1] ],
		...
		drawCallback: function( settings ) {
			$('#outputCardTable tbody tr td').css('height','30px');
			//전역변수들
			let output_sumProduceCnt = $('#outputCardTable').DataTable().column(2,{ page: 'all'} ).data().sum();
			let output_sumVisionCnt = $('#outputCardTable').DataTable().column(3,{ page: 'all'} ).data().sum();
			let output_sumTotalCnt = output_sumProduceCnt + output_sumVisionCnt;
			$('#output_sumProduceCnt').html(addCommas(output_sumProduceCnt));
			$('#output_sumVisionCnt').html(addCommas(output_sumVisionCnt));
			$('#output_sumTotalCnt').html(addCommas(output_sumTotalCnt));
		},
  	...
  	let html4 = '<div class="row">';
	html4 += '<button type="button" class="btn btn-primary float-right touch6 ml-2" id="btnRegistrantChange">생산 작업자 변경</button>';
	html4 += '</div>';
	$('#outputCardTable_length').html(html4);
		...
		columns: [
				...
				render: function(data, type, row) {
					if (factoryCode == '002') {
						if (row['workGubunCd'] == 'D') {
							return '<p style="color:red; font-weight:bold; margin-bottom:0px;">' + data + '</p>';
						} else if( row['workGubunCd'] == 'N') {
							return '<p style="color:blue; font-weight:bold; margin-bottom:0px;">' + data + '</p>';
						}
					} else if (factoryCode == '003') {
						return data;						
					}
			...
			{ data: 'planRegDate',
				render: function(data, type, row) {
					if (factoryCode == '002') {
						if (row['workGubunCd'] == 'D') {
							return '<p style="color:red; font-weight:bold; margin-bottom:0px;">' + moment(data).format("YYYY-MM-DD") + '</p>';
						} else if( row['workGubunCd'] == 'N') {
							return '<p style="color:blue; font-weight:bold; margin-bottom:0px;">' + moment(data).format("YYYY-MM-DD") + '</p>';
						}
					} else if (factoryCode == '003') {
						return data;						
					}
...
// 			}            
		...
		columns: [
			...
			{ data: 'workOrdNo',
	       		render: function(data, type, row, meta) {
					if (factoryCode == '002') {
						if( row['ordGubun'] == 'D') {
							return '<p style="color:red; font-weight:bold; margin-bottom:0px;">' + row['workOrdNo'] + '</p>';
		           		} else if( row['ordGubun'] == 'N') {
		           			return '<p style="color:blue; font-weight:bold; margin-bottom:0px;">' + row['workOrdNo'] + '</p>';
		               	}
					} else if (factoryCode == '003') {
						return '<p style="font-weight:bold; margin-bottom:0px;">' + row['workOrdNo'] + '</p>';
					}
	       		}
			},
			{ data: 'workStatusNm',
			...
			{ data: 'workTeamCd',
				render: function(data, type, row, meta) {
					...
					if(data == '' || data == null){
						html += selectBoxHtml(workTeamCode, 'workTeamCd' + row['workNo'], userTeamCd, row, meta);
					}else{
			...
			*/		
			{ data: 'firstStepCheckNm',
				render: function(data, type, row, meta) {
					
					var html = '<label onClick="firstStepCreat('+meta.row+');" style="';
						html +='width: 80%;" class=" ';
					if(data == "등록"){
						html +='btn btn-success touch6" >초물</label>';
					}else {
						html +='btn btn-primary touch6" >초물</label>';
					}
	...
	$('#workOrderTable tbody').on('click', 'tr', function () {
		...
		workerChange_workTeamCd	= workOrderTable.row(this).data().workTeamCd;
		firstStepCheck			= workOrderTable.row(this).data().firstStepCheck;
			...
			//}
				...
				if ( $(this).hasClass("selected") ) {
					...
					/* if (!(sideView == null) && !(sideView == '')) {
						...
						if(sideView == 'output' || sideView == 'downtime'){
...
// 										}
					...
					if(sideviewstatus == 'downtime'){
						$('#btnDowntime').trigger('click');
					}
...
// 	    }
    ...
    $('#workOrderMatrlTable tbody').on('click', 'tr', function () {
        ...
        if ($(this).hasClass('selected')) {
			...
			//if($('#workOrderMatrlTable').DataTable().row(this).data().faultyStatus="002"){
			//	//불량 등록 취소
			//	$('#btnMatrlFaulty').addClass('d-none');
			//	$('#btnMatrlFaultyCancel').removeClass('d-none');
			//} else if($('#workOrderMatrlTable').DataTable().row(this).data().faultyStatus="001"){
			//	//기존 불량 등록
			//	$('#btnMatrlFaultyCancel').addClass('d-none');
			//	$('#btnMatrlFaulty').removeClass('d-none');
			//} else {
			//	//기존 불량 등록
			//	$('#btnMatrlFaultyCancel').addClass('d-none');
			//	$('#btnMatrlFaulty').removeClass('d-none');
...
//    		if ((mainMatrlCd.substring(0,1) == 'A') || (mainMatrlCd.substring(0,1) == 'N')) {
	...
	$('#btnStart').on('click', function() {
		...
		if($("#workStatusCd"+workOrdIndex).val() == "P") {
			workOrderStatus("S");
			if(trayFunctionCheck) {
				workerChange_workStartCreate();	//작업자 등록
				trayLabelCreateFun();			//생산실적트레이 발행(등록)
			}
		} else {
    ...
    $('#btnCancel').on('click', function() {
		...
		//엣지 외관에 등록 되어있는지 확인
		$.ajax({
            url: '<c:url value="po/workOrdOutputSubCheck"/>',
            type: 'POST',
            async: false,
            data: {
            	'menuAuth'	 		: 		menuAuth,
		...
		$.ajax({
			...
			success: function (res) {
				...
				if (res.result == 'ok') {
					...
					toastr.warning('생산실적(Tray)에 값이 등록되어 있습니다.<br>삭제 후 다시 시도해주세요!', '', {timeOut: 5000});
					checkWorkOrdStatusTemp = true;
					return false;
				} else {
					toastr.error(res.message);
...
//             	'workStatusCd'		: 		function() { return workStatusCd; },	//선택한 작업지시
		...
		if (checkWorkOrdStatusTemp) {
			...
			//삭제 ajax
			$.ajax({
				url : '<c:url value="/po/workerChangeDelete"/>',
				type : 'POST',
				data : {
		        	'equipCd'				:	function() { return equipCd; 						},	//설비코드
		        	'workOrdNo'				:	function() { return workOrdNo; 						},	//작업지시번호
		        	'ordDate'				:	function() { return ordDateCal.replace(/-/g, ''); 	}	//작지일자
				},
				success : function(res) {
					let data = res.data;
					if (res.result == 'ok') {
			...
			//생산실적트레이 삭제--나중에 함수(workOrderStatus) ajax(Controller)에 선언해주기
			$.ajax({
				url : '<c:url value="po/productionPerfTrayDelete"/>',
				type : 'POST',
				async: false,
				data : {
					...
					'equipCd'			:		function() { return equipCd;	},
		           	'workOrdNo'			:		function() { return workOrdNo;	},
		           	'deleteGubun'		:		function() { return "001";		}
				},
				success: function (res) {
					let data = res.data;
					if (res.result == 'ok') {
	...
	$('#btnEnd').on('click', function() {
    	...
    	if(firstStepCheck == '0'){
    		toastr.warning("초물등록 후 작업종료를 해주세요.");
			return false;
    	}
    ...
    function workOrderStatus(status) {
    	var workOrdNo = $("#workOrdNo" + workOrdIndex).val();
  		$.ajax({
			url: '<c:url value="/po/workOrderUpdateStatus_F1F2F3"/>',
			type: 'POST',
			async: false,
			data: {
				'menuAuth'			:	menuAuth,
			...
			success: function (res) {
				...
				if (res.result == 'ok') {
					...
					matrlIndex = "";
					matrlRowCnt = "";
					trayFunctionCheck = true;
				} else if (res.result == 'fail') {
					$('#workOrderTable').DataTable().ajax.reload( function () {});
					$('#workOrderMatrlTable').DataTable().clear().draw();
					toastr.warning(res.message, '', {timeOut: 5000});
					trayFunctionCheck = false;
				} else if (res.result == 'error') {
					$('#workOrderTable').DataTable().ajax.reload( function () {});
					$('#workOrderMatrlTable').DataTable().clear().draw();
					toastr.error(res.message, '', {timeOut: 5000});
	...
	*/
	...
	$('#left-expand').on('click', function(){
		...
		$("#rightList").animate({
			...
			//$('#btnOrdLotNoFirstStepNew').removeClass('d-none');	//초물 버튼
			$('#btnOrdLotNoSecondStepNew').removeClass('d-none');	//중물 버튼
			$('#btnOrdLotNoThirdStepNew').removeClass('d-none');	//종물 버튼
			$('#btnPtfe1Faulty').removeClass('d-none');				//1차 진접 테프론 교체
			$('#btnPtfe2Faulty').removeClass('d-none');				//2차 진접 테프론 교체
			$('#btnReStart').removeClass('d-none');
			if (workStatusCd == "S") {
				$('#btnCancel').removeClass('d-none');
				$('#btnStart').addClass('d-none');
	...
	//초중종물 등록 버튼 click
	$('#btnFirstStepInsert, #btnSecondStepInsert, #btnThirdStepInsert').on('click',function() {
		...
		$.ajax({
			...
			success: function (res) {
				...
				if (res.result == 'ok') {
					...
					$('#workOrderTable').DataTable().$('tr.selected').find('td').eq(8).find('label').removeClass('btn-primary');
					$('#workOrderTable').DataTable().$('tr.selected').find('td').eq(8).find('label').addClass('btn-success');
					...
					if(res.checkCreate != null && res.checkCreate !='') {
						$('#workOrderTable').DataTable().$('tr.selected').find('td').eq(8).find('label').removeClass('btn-primary');
						$('#workOrderTable').DataTable().$('tr.selected').find('td').eq(8).find('label').addClass('btn-success');
					}
...
// 				$('#btnWorkOrdRetv').trigger('click');
    ...
    $('#btnStepDelete').on('click', function() {    	
		...
		$('#deleteStepPopupModal').attr('style', 'z-index: 99999; display: block;background-color: #0000002b;');
    	$('#deleteStepPopupModal').modal('show');
    });

   //초물 삭제 확인
    $('#deleteStepCheck').on('click', function() {
//     	$('#deleteStepCheck').addClass('d-none');
    	$('#deleteStepCheck').attr('disabled', true);
    	$('#my-spinner').show();
...
// 					$('#btnStepReload').trigger('click');
					...
					$('#workOrderTable').DataTable().$('tr.selected').find('td').eq(8).find('label').removeClass('btn-success');
					$('#workOrderTable').DataTable().$('tr.selected').find('td').eq(8).find('label').addClass('btn-primary');
...
// 				$('#btnWorkOrdRetv').trigger('click');
		...
		$('#deleteStepCheck').attr('disabled', false);
    });
	...
	let rqbarcodeNoVal = '';
	let rqremainQtyVal = '';
	$('#btnRemainQty').on('click', function() {
		if (workOrdNo == null) {
			toastr.warning("작업지시를 선택해주세요!");
			return false;
		}
		//자재행 선택하였는지 확인
		if ($("#workOrderMatrlTable").find(".selected").length != 1) {
			toastr.warning("잔량을 등록할 주자재(MetalLot)를 선택해주세요!");
			return false;
		}
		if (mainMatrlLotNo == null || mainMatrlLotNo == '') {
			toastr.warning("잔량을 등록할 주자재(MetalLot)를 선택해주세요!");
		...
		$('#workOrderMatrlTable tbody tr').each(function(){
		 	if($(this).hasClass('selected')){
		 		rqbarcodeNoVal = $(this).find('td').eq(6).html();
			}
		});
		$('#rqBarcodeNo').text(rqbarcodeNoVal);
		...
		$.ajax({
			...
			async : false,
			data : {
				'barcodeNo' : function() {return rqbarcodeNoVal;},
			},
			success : function(res) {
				let data = res.data;
				console.log(data);
				...
				if (data != null) {
					if(data[0].remainQty == null){
						rqremainQtyVal = 0;
						$('#rqRemainQty').attr('max', 100);
					} else {
						rqremainQtyVal = data[0].remainQty;
						$('#rqRemainQty').attr('max', data[0].preInWhsQty);
					}
					$('#rqPreInWhsQty').text(data[0].preInWhsQty);
				} else {
		...
		$('#rqRemainQty').val(rqremainQtyVal);
		
		$('#remainQtyPopUpModal').modal('show');
		
	});
	
	//잔량등록 저장
	$('#btnRqSave').on('click', function() {
		if(!$.trim($('#rqRemainQty').val())) {
			toastr.warning("잔량을 입력해주세요.");
			$('#rqRemainQty').focus();
			return false;
		}
		if($('#rqRemainQty').val() <= 0) {
			toastr.warning("잔량을 양수로 입력해주세요.");
			$('#rqRemainQty').focus();
			return false;
		}
		...
		$.ajax({
			...
			data: {
				'menuAuth'		: 	function() { return menuAuth; },
				'barcodeNo'		: 	function() { return rqbarcodeNoVal; },
				'remainQty'		: 	function() { return $('#rqRemainQty').val(); },
				'rqSaveCheck'	: 	function() { return 'Y'; },
			},
			success: function (res) {
				let result = res.result;
				if (res.result == 'ok') {
					toastr.success("잔량이 등록되었습니다.");
				} else if (res.result == 'fail') {
					toastr.warning(res.message, '', {timeOut: 5000});
				} else if (res.result == 'error') {
					toastr.error(res.message, '', {timeOut: 5000});
			...
			complete : function() {
				$('#remainQtyPopUpModal').modal('hide');
				$('#my-spinner').hide();
			}
		}); 
	});
	...
	$('#btnFaulty').on('click', function() {
		...
		if (checkWorkOrdStatusTemp) {
			...
			$("#rightList").animate({
				...
				$('#btnPtfe1Faulty').addClass('d-none');			//1차 진접 테프론 교체
				$('#btnPtfe2Faulty').addClass('d-none');			//2차 진접 테프론 교체
				$('#workUserNm').addClass('d-none');				//작업자
			});
...
// 	    }        
			...
			data: {
   	        ...
   	        success: function (res) {
				...
				//치수 조건
   	            if (res.result == 'ok') {
   	            	if( creatStatusCd == 1 ){
	   	   	            if( ( parseFloat(condStepData.wpLeftCond) - parseFloat(condStepData.wpLeftAlwnceMinus)) > $('#firstWpLeftAlwnce').val() || ( parseFloat(condStepData.wpLeftCond) + parseFloat(condStepData.wpLeftAlwncePlus)) < $('#firstWpLeftAlwnce').val()){
							$('#firstWpLeftAlwnce').css('color','red');
						} else{
							$('#firstWpLeftAlwnce').css('color','');
						} // Welding Part 좌
	   	   	            if( ( parseFloat(condStepData.wpRightCond) - parseFloat(condStepData.wpRightAlwnceMinus)) > $('#firstWpRightAlwnce').val() || ( parseFloat(condStepData.wpRightCond) + parseFloat(condStepData.wpRightAlwncePlus)) < $('#firstWpRightAlwnce').val()){
							$('#firstWpRightAlwnce').css('color','red');
						} else{
							$('#firstWpRightAlwnce').css('color','');
						} // Welding Part 우
	   	   	            if( ( parseFloat(condStepData.pitchLeftCond) - parseFloat(condStepData.pitchLeftAlwnceMinus)) > $('#firstPitchLeftAlwnce').val() || ( parseFloat(condStepData.pitchLeftCond) + parseFloat(condStepData.pitchLeftAlwncePlus)) < $('#firstPitchLeftAlwnce').val()){
							$('#firstPitchLeftAlwnce').css('color','red');
						} else{
							$('#firstPitchLeftAlwnce').css('color','');
						} // Pitch 좌
	   	   	            if( ( parseFloat(condStepData.pitchRightCond) - parseFloat(condStepData.pitchRightAlwnceMinus)) > $('#firstPitchRightAlwnce').val() || ( parseFloat(condStepData.pitchRightCond) + parseFloat(condStepData.pitchRightAlwncePlus)) < $('#firstPitchRightAlwnce').val()){
							$('#firstPitchRightAlwnce').css('color','red');
						} else{
							$('#firstPitchRightAlwnce').css('color','');
						} // Pitch 우
	   	   	            if( (parseFloat(condStepData.ppfWingLeftCond) - parseFloat(condStepData.ppfWingLeftAlwnceMinus)) > $('#firstPpfWingLeftAlwnce').val() || ( parseFloat(condStepData.ppfWingLeftCond) + parseFloat(condStepData.ppfWingLeftAlwncePlus)) < $('#firstPpfWingLeftAlwnce').val()){
							$('#firstPpfWingLeftAlwnce').css('color','red');
						} else{
							$('#firstPpfWingLeftAlwnce').css('color','');
						} // P.P Flim 날개 좌
	   	   	            if( ( parseFloat(condStepData.ppfWingRightCond) - parseFloat(condStepData.ppfWingRightAlwnceMinus)) > $('#firstPpfWingRightAlwnce').val() || ( parseFloat(condStepData.ppfWingRightCond) + parseFloat(condStepData.ppfWingRightAlwncePlus)) < $('#firstPpfWingRightAlwnce').val()){
							$('#firstPpfWingRightAlwnce').css('color','red');
						} else{
							$('#firstPpfWingRightAlwnce').css('color','');
						} // P.P Flim 날개 우			
	   	   	            if( ( parseFloat(condStepData.ppfDepthLeftCond) - parseFloat(condStepData.ppfDepthLeftAlwnceMinus)) > $('#firstPpfDepthLeftAlwnce').val() || ( parseFloat(condStepData.ppfDepthLeftCond) + parseFloat(condStepData.ppfDepthLeftAlwncePlus)) < $('#firstPpfDepthLeftAlwnce').val()){
							$('#firstPpfDepthLeftAlwnce').css('color','red');
						} else{
							$('#firstPpfDepthLeftAlwnce').css('color','');
						} // P.P Flim 폭 좌
	   	   	            if( ( parseFloat(condStepData.ppfDepthRightCond) - parseFloat(condStepData.ppfDepthRightAlwnceMinus)) > $('#firstPpfDepthRightAlwnce').val() || ( parseFloat(condStepData.ppfDepthRightCond) + parseFloat(condStepData.ppfDepthRightAlwncePlus)) < $('#firstPpfDepthRightAlwnce').val()){
							$('#firstPpfDepthRightAlwnce').css('color','red');
						} else{
							$('#firstPpfDepthRightAlwnce').css('color','');
						} // P.P Flim 폭 우												
	   	   	            if( ( parseFloat(condStepData.filmCond) - parseFloat(condStepData.filmAlwnceMinus)) > $('#firstFilmAlwnce').val() || ( parseFloat(condStepData.filmCond) + parseFloat(condStepData.filmAlwncePlus)) < $('#firstFilmAlwnce').val()){
							$('#firstFilmAlwnce').css('color','red');
						} else{
							$('#firstFilmAlwnce').css('color','');
						} // Flim 총길이 											
	   	   	            if( ( parseFloat(condStepData.metalDepthCond) - parseFloat(condStepData.metalDepthAlwnceMinus)) > $('#firstMetalDepthAlwnce').val() || ( parseFloat(condStepData.metalDepthCond) + parseFloat(condStepData.metalDepthAlwncePlus)) < $('#firstMetalDepthAlwnce').val()){
							$('#firstMetalDepthAlwnce').css('color','red');
						} else{
							$('#firstMetalDepthAlwnce').css('color','');
						} // METAL 폭 				
	   	   	            if( ( parseFloat(condStepData.metalThicknessCond) - parseFloat(condStepData.metalThicknessAlwnceMinus)) > $('#firstMetalThicknessAlwnce').val() || ( parseFloat(condStepData.metalThicknessCond) + parseFloat(condStepData.metalThicknessAlwncePlus)) < $('#firstMetalThicknessAlwnce').val()){
							$('#firstMetalThicknessAlwnce').css('color','red');
						} else{
							$('#firstMetalThicknessAlwnce').css('color','');
						} // METAL 두께 								
	   	   	            if( ( parseFloat(condStepData.thCenterCond) - parseFloat(condStepData.thCenterAlwnceMinus)) > $('#firstThCenterAlwnce').val() || ( parseFloat(condStepData.thCenterCond) + parseFloat(condStepData.thCenterAlwncePlus)) < $('#firstThCenterAlwnce').val()){
							$('#firstThCenterAlwnce').css('color','red');
						} else{
							$('#firstThCenterAlwnce').css('color','');
						} // 총두께 Center 							
	   	   	            if( ( parseFloat(condStepData.thEdgeCond) - parseFloat(condStepData.thEdgeAlwnceMinus)) > $('#firstThEdgeAlwncePlus').val() || ( parseFloat(condStepData.thEdgeCond) + parseFloat(condStepData.thEdgeAlwncePlus)) < $('#firstThEdgeAlwncePlus').val()){
							$('#firstThEdgeAlwncePlus').css('color','red');
						} else{
							$('#firstThEdgeAlwncePlus').css('color','');
						} // 총두께 Edge 		
	   	   	            if( ( parseFloat(condStepData.burrCond) - parseFloat(condStepData.burrAlwnceMinus)) > $('#firstBurrMetalAlwnce').val() || ( parseFloat(condStepData.burrCond) + parseFloat(condStepData.burrAlwncePlus)) < $('#firstBurrMetalAlwnce').val()){
							$('#firstBurrMetalAlwnce').css('color','red');
						} else{
							$('#firstBurrMetalAlwnce').css('color','');
						} // Burr(MAX) Metal 																
    	   	   	    } else { 
		...
		$.ajax({
			...
			success: function (res) {
				...
				if(res.result == 'ok') {
					//console.log(data);
					if( creatStatusCd == 1 ){
						if( ( parseFloat(data.warmupCond) - parseFloat(data.warmupAlwnceMinus)) > $('#firstWarmupCond').val() || ( parseFloat(data.warmupCond) + parseFloat(data.warmupAlwncePlus)) < $('#firstWarmupCond').val()){
							$('#firstWarmupCond').css('color','red');
						} else{
							$('#firstWarmupCond').css('color','');
						}//예열
						if( ( parseFloat(data.fitup1UpCond) - parseFloat(data.fitup1UpAlwnceMinus)) > $('#firstFitup1UpCond').val() || ( parseFloat(data.fitup1UpCond) + parseFloat(data.fitup1UpAlwncePlus)) < $('#firstFitup1UpCond').val()){
							$('#firstFitup1UpCond').css('color','red');
						} else{
							$('#firstFitup1UpCond').css('color','');
						}// 가접1 상
						if( ( parseFloat(data.fitup1DownCond) - parseFloat(data.fitup1DownAlwnceMinus)) > $('#firstFitup1DownCond').val() || ( parseFloat(data.fitup1DownCond) + parseFloat(data.fitup1DownAlwncePlus)) < $('#firstFitup1DownCond').val()){
							$('#firstFitup1DownCond').css('color','red');
						} else{
							$('#firstFitup1DownCond').css('color','');
						} // 가접1 하
						if( ( parseFloat(data.fitup2UpleftCond) - parseFloat(data.fitup2UpleftAlwnceMinus)) > $('#fitup2UpleftCond').val() || ( parseFloat(data.fitup2UpleftCond) + parseFloat(data.fitup2UpleftAlwncePlus)) < $('#fitup2UpleftCond').val()){
							$('#firstFitup2UpleftCond').css('color','red');
						} else{
							$('#firstFitup2UpleftCond').css('color','');
						}// 가접2 상좌
						if( ( parseFloat(data.fitup2DownleftCond) - parseFloat(data.fitup2DownleftAlwnceMinus)) > $('#firstFitup2DownleftCond').val() || ( parseFloat(data.fitup2DownleftCond) + parseFloat(data.fitup2DownleftAlwncePlus)) < $('#firstFitup2DownleftCond').val()){
							$('#firstFitup2DownleftCond').css('color','red');
						} else{
							$('#firstFitup2DownleftCond').css('color','');
						}// 가접2 하좌
						if( ( parseFloat(data.fitup2UprightCond) - parseFloat(data.fitup2UprightAlwnceMinus)) > $('#firstFitup2UprightCond').val() || ( parseFloat(data.fitup2UprightCond) + parseFloat(data.fitup2UprightAlwncePlus)) < $('#firstFitup2UprightCond').val()){
							$('#firstFitup2UprightCond').css('color','red');
						} else{
							$('#firstFitup2UprightCond').css('color','');
						}//가접2 상우
						if( ( parseFloat(data.fitup2DownrightCond) - parseFloat(data.fitup2DownrightAlwnceMinus)) > $('#firstFitup2DownrightCond').val() || ( parseFloat(data.fitup2DownrightCond) + parseFloat(data.fitup2DownrightAlwncePlus)) < $('#firstFitup2DownrightCond').val()){
							$('#firstFitup2DownrightCond').css('color','red');
						} else{
							$('#firstFitup2DownrightCond').css('color','');
						}  //가접2 하우
						if( ( parseFloat(data.rollheatUpCond) - parseFloat(data.rollheatUpAlwnceMinus)) > $('#firstRollheatUpCond').val() || ( parseFloat(data.rollheatUpCond) + parseFloat(data.rollheatUpAlwncePlus)) < $('#firstRollheatUpCond').val()){
							$('#firstRollheatUpCond').css('color','red');
						} else{
							$('#firstRollheatUpCond').css('color','');
						} // 롤히터 상
						if( ( parseFloat(data.rollheatDownCond) - parseFloat(data.rollheatDownAlwnceMinus)) > $('#firstRollheatDownCond').val() || ( parseFloat(data.rollheatDownCond) + parseFloat(data.rollheatDownAlwncePlus)) < $('#firstRollheatDownCond').val()){
							$('#firstRollheatDownCond').css('color','red');
						} else{
							$('#firstRollheatDownCond').css('color','');
						}// 롤히터 하
						if( ( parseFloat(data.firstUpleftCond) - parseFloat(data.firstUpleftAlwnceMinus)) > $('#firstFirstUpleftCond').val() || ( parseFloat(data.firstUpleftCond) + parseFloat(data.firstUpleftAlwncePlus)) < $('#firstFirstUpleftCond').val()){
							$('#firstFirstUpleftCond').css('color','red');
						} else{
							$('#firstFirstUpleftCond').css('color','');
						}// 1차 상좌
						if( ( parseFloat(data.firstDownleftCond) - parseFloat(data.firstDownleftAlwnceMinus)) > $('#firstFirstDownleftCond').val() || ( parseFloat(data.firstDownleftCond) + parseFloat(data.firstDownleftAlwncePlus)) < $('#firstFirstDownleftCond').val()){
							$('#firstFirstDownleftCond').css('color','red');
						}  else{
							$('#firstFirstDownleftCond').css('color','');
						}// 1차 하좌
						if( ( parseFloat(data.firstUprightCond) - parseFloat(data.firstUprightAlwnceMinus)) > $('#firstFirstUprightCond').val() || ( parseFloat(data.firstUprightCond) + parseFloat(data.firstUprightAlwncePlus)) < $('#firstFirstUprightCond').val()){
							$('#firstFirstUprightCond').css('color','red');
						}  else{
							$('#firstFirstUprightCond').css('color','');
						}// 1차 상우
						if( ( parseFloat(data.firstDownrightCond) - parseFloat(data.firstDownrightAlwnceMinus)) > $('#firstFirstDownrightCond').val() || ( parseFloat(data.firstDownrightCond) + parseFloat(data.firstDownrightAlwncePlus)) < $('#firstFirstDownrightCond').val()){
							$('#firstFirstDownrightCond').css('color','red');
						} else{
							$('#firstFirstDownrightCond').css('color','');
						}// 1차 하우
						if( ( parseFloat(data.push1UpCond) - parseFloat(data.push1UpAlwnceMinus)) > $('#firstPush1UpCond').val() || ( parseFloat(data.push1UpCond) + parseFloat(data.push1UpAlwncePlus)) < $('#firstPush1UpCond').val()){
							$('#firstPush1UpCond').css('color','red');
						} else{
							$('#firstPush1UpCond').css('color','');
						}// 1차 푸셔 상
						if( ( parseFloat(data.push1DownCond) - parseFloat(data.push1DownAlwnceMinus)) > $('#firstPush1DownCond').val() || ( parseFloat(data.push1DownCond) + parseFloat(data.push1DownAlwncePlus)) < $('#firstPush1DownCond').val()){
							$('#firstPush1DownCond').css('color','red');
						} else{
							$('#firstPush1DownCond').css('color','');
						}// 1차 푸셔 하
						if( ( parseFloat(data.secondUpleftCond) - parseFloat(data.secondUpleftAlwnceMinus)) > $('#firstSecondUpleftCond').val() || ( parseFloat(data.secondUpleftCond) + parseFloat(data.secondUpleftAlwncePlus)) < $('#firstSecondUpleftCond').val()){
							$('#firstSecondUpleftCond').css('color','red');
						} else{
							$('#firstSecondUpleftCond').css('color','');
						} // 2차 상좌
						if( ( parseFloat(data.secondDownleftCond) - parseFloat(data.secondDownleftAlwnceMinus)) > $('#firstSecondDownleftCond').val() || ( parseFloat(data.secondDownleftCond) + parseFloat(data.secondDownleftAlwncePlus)) < $('#firstSecondDownleftCond').val()){
							$('#firstSecondDownleftCond').css('color','red');
						} else{
							$('#firstSecondDownleftCond').css('color','');
						}// 2차 하좌
						if( ( parseFloat(data.secondUprightCond) - parseFloat(data.secondUprightAlwnceMinus)) > $('#firstSecondUprightCond').val() || ( parseFloat(data.secondUprightCond) + parseFloat(data.secondUprightAlwncePlus)) < $('#firstSecondUprightCond').val()){
							$('#firstSecondUprightCond').css('color','red');
						} else{
							$('#firstSecondUprightCond').css('color','');
						}// 2차 상우
						if( ( parseFloat(data.secondDownrightCond) - parseFloat(data.secondDownrightAlwnceMinus)) > $('#firstSecondDownrightCond').val() || ( parseFloat(data.secondDownrightCond) + parseFloat(data.secondUprightAlwncePlus)) < $('#firstSecondDownrightCond').val()){
							$('#firstSecondDownrightCond').css('color','red');
						} else{
							$('#firstSecondDownrightCond').css('color','');
						} // 2차 하우
						if( ( parseFloat(data.thirdUpleftCond) - parseFloat(data.thirdUpleftAlwnceMinus)) > $('#firstThirdUpleftCond').val() || ( parseFloat(data.thirdUpleftCond) + parseFloat(data.thirdUpleftAlwncePlus)) < $('#firstThirdUpleftCond').val()){
							$('#firstThirdUpleftCond').css('color','red');
						} else{
							$('#firstThirdUpleftCond').css('color','');
						} // 3차 상좌
						if( ( parseFloat(data.thirdDownleftCond) - parseFloat(data.thirdDownleftAlwnceMinus)) > $('#firstThirdDownleftCond').val() || ( parseFloat(data.thirdDownleftCond) + parseFloat(data.thirdDownleftAlwncePlus)) < $('#firstThirdDownleftCond').val()){
							$('#firstThirdDownleftCond').css('color','red');
						} else{
							$('#firstThirdDownleftCond').css('color','');
						}// 3차 하좌
						if( ( parseFloat(data.thirdUprightCond) - parseFloat(data.thirdUprightAlwnceMinus)) > $('#firstThirdUprightCond').val() || ( parseFloat(data.thirdUprightCond) + parseFloat(data.thirdUprightAlwncePlus)) < $('#firstThirdUprightCond').val()){
							$('#firstThirdUprightCond').css('color','red');
						} else{
							$('#firstThirdUprightCond').css('color','');
						}// 3차 상우
						if( ( parseFloat(data.thirdDownrightCond) - parseFloat(data.thirdDownrightAlwnceMinus)) > $('#firstThirdDownrightCond').val() || ( parseFloat(data.thirdDownrightCond) + parseFloat(data.thirdDownrightAlwncePlus)) < $('#firstThirdDownrightCond').val()){
							$('#firstThirdDownrightCond').css('color','red');
						} else{
							$('#firstThirdDownrightCond').css('color','');
						} // 3차 하우
						if( ( parseFloat(data.jinjeop1UpCond) - parseFloat(data.jinjeop1UpAlwnceMinus)) > $('#firstJinjeop1UpCond').val() || ( parseFloat(data.jinjeop1UpCond) + parseFloat(data.jinjeop1UpAlwncePlus)) < $('#firstJinjeop1UpCond').val()){
							$('#firstJinjeop1UpCond').css('color','red');
						} else{
							$('#firstJinjeop1UpCond').css('color','');
						} // 진접1 상						
						if( ( parseFloat(data.jinjeop1DownCond) - parseFloat(data.jinjeop1DownAlwnceMinus)) > $('#firstJinjeop1DownCond').val() || ( parseFloat(data.jinjeop1DownCond) + parseFloat(data.jinjeop1DownAlwncePlus)) < $('#firstJinjeop1DownCond').val()){
							$('#firstJinjeop1DownCond').css('color','red');
						} else{
							$('#firstJinjeop1DownCond').css('color','');
						} // 진접1 하
						if( ( parseFloat(data.jinjeop2UpCond) - parseFloat(data.jinjeop2UpAlwnceMinus)) > $('#firstJinjeop2UpCond').val() || ( parseFloat(data.jinjeop2UpCond) + parseFloat(data.jinjeop2UpAlwncePlus)) < $('#firstJinjeop2UpCond').val()){
							$('#firstJinjeop2UpCond').css('color','red');
						} else{
							$('#firstJinjeop2UpCond').css('color','');
						} // 진접2 상
						if( ( parseFloat(data.jinjeop2DownCond) - parseFloat(data.jinjeop2DownAlwnceMinus)) > $('#firstJinjeop2DownCond').val() || ( parseFloat(data.jinjeop2DownCond) + parseFloat(data.jinjeop2DownAlwncePlus)) < $('#firstJinjeop2DownCond').val()){
							$('#firstJinjeop2DownCond').css('color','red');
						} else{
							$('#firstJinjeop2DownCond').css('color','');
						} // 진접2 하
    ...
    $('#btnOutputSave').on('click', function() {
		...
		if(outputBtnStat == 'add') {
			url = '<c:url value="/po/outputCntDataCreate_F3"/>';
		} else{
             ...
             success: function (res) {
				if (res.result == 'ok') {
					...
					if (outputBtnStat == 'add') {
						...
						//DGS Redis사용
						/* if (ordLotNoStepCd == '001' || ordLotNoStepCd == '002' || ordLotNoStepCd == '003') {
							$.ajax({
								url: '<c:url value="/po/workOrderStepInsertRedis_DB0_F2F3"/>',
								type: 'POST',
								async: false,
	...
	$('#btnDeleteOutputSubCheck').on('click', function() {
    	...
    	$.ajax({
			url: '<c:url value="po/outputCntDataDelete_F3"/>',
			type: 'POST',
			async: false,
			data: {
            	'menuAuth'	 	: 		menuAuth,
	...
	$('#dayBtnSave').on('click', function() {
		...
		//} else if ( dayPrcssFaultySearchData == "fail" ) {
			let url = '<c:url value="po/createFaultyAll_F3_2"/>';
		//}
				...
				$('#downtimeDtl').DataTable().ajax.reload(function() {
					$.ajax({
						...
						data: {
			   	        	...
			   	        	'downtimeCd'		:   function() { return downtimeCd;						}
			   	        },
			   	        success: function (res) {
			   	        	var data = res.data;
			   	        	if (res.result == "ok"){
...
// 			html += '<tr>' + header1 + '</tr>';
	...
	function replaceFaultyCodeTableDay() {
		...
		$.each(replaceFaultyCode, function (index, item) {
			if(item.baseCd != "004" && item.baseCd != "008"){
...
// 			html += '<tr>' + header1 + '</tr>';
	...
	$('#btnMatrlFaulty').on('click', function() {
		...
		if (faultyStatusScan == '불량' || faultyStatusScan == '재불량') {
	...
	/* 	if($('#matrlFaultytable').DataTable().data().count() == 0){
		...
		if( faultyStatusScan == '불량' ) {
			faultyStatusUpdate("001");	//정상
		} else if ( faultyStatusScan == '재불량' ) {
			faultyStatusUpdate("003");	//불량 재투입
		}
...
// 		faultyStatusUpdate("001"); 
    ...
    $('#btnFrrrdSave').on('click', function() {
		...
		if( faultyStatusScan == '정상' ) {
			faultyStatusUpdate("002");	//불량
		} else if ( faultyStatusScan == '불량재투입' ) {
			faultyStatusUpdate("004");	//재불량
		}
    });
...
// 		console.log(faultyBarcodeList);
	...
	//생산 전표번호당 초물입력btn
	$('#btnOrdLotNoFirstStepNew').on('click', function() {
...
/* 		if (outputCardTableIndex == null) {
		...
		if (checkWorkOrdStatusTemp) {
			...
			$('#btnFirstStepInsert').removeClass('d-none');		//초물 등록 버튼
			$('#btnSecondStepInsert').addClass('d-none');		//중물 등록 버튼
			$('#btnThirdStepInsert').addClass('d-none');	//중물 등록 버튼
			//$('#btnAddWorkOrder').addClass('d-none');			//작지 추가 버튼
			//$('#btnDeleteWorkOrder').addClass('d-none');		//작지 삭제 버튼
			...
			agtSizeDataRead(); // 에이젼트 치수 데이터 읽기
			agtSizeCondRead(); // 에이전트 치수 조건 읽기
			$('#ordLotNoStepTitle').text(mainMatrlLotNo + ' / 초물');
			$('#ordLotNoStepModal').modal({backdrop: 'static'});
			$('#ordLotNoStepModal').modal('show');
		}
	});
	...
	//생산 전표번호당 중물입력btn
	$('#btnOrdLotNoSecondStepNew').on('click', function() {
		if (workOrdNo == null) {
			toastr.warning("중물을 입력할 작업지시를 선택해주세요!");
			return false;
		}
		...
		if (checkWorkOrdStatusTemp) {
			...
			agtSizeDataRead(); // 에이젼트 치수 데이터 읽기
			agtSizeCondRead(); // 에이전트 치수 조건 읽기
			$('#ordLotNoStepTitle').text(mainMatrlLotNo + ' / 중물');
			$('#ordLotNoStepModal').modal({backdrop: 'static'});
			$('#ordLotNoStepModal').modal('show');
		}
	});
	...
	$('#btnOrdLotNoThirdStepNew').on('click', function() {
		...
		if (checkWorkOrdStatusTemp) {
			...
			agtSizeDataRead(); // 에이젼트 치수 데이터 읽기
			agtSizeCondRead(); // 에이전트 치수 조건 읽기
			$('#ordLotNoStepTitle').text(mainMatrlLotNo + ' / 종물');
			$('#ordLotNoStepModal').modal({backdrop: 'static'});
			$('#ordLotNoStepModal').modal('show');
		}
	});
...
// 		notRunningToday = moment(notRunningToday).format('YYYY-MM-DD HH:mm').replace(' ','T');	//날짜 넣어줄때 'T'가 있어야 값이  들어감
    ...
    //ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ작업자 변경 코드ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
    
    //작업자 변경 클릭 시
    $('#btnWorkerChange').on('click', function(){
    	if($('#workOrderTable tbody tr').hasClass('selected')=='') {
			toastr.warning("변경할 작지를 먼저 선택해주세요.");
			return false;
		}
    	...
    	if($("#workStatusCd" + workOrdIndex).val() == "S" || $("#workStatusCd" + workOrdIndex).val() == "C") {
    		$('#workerIdCd').val('');
        	$('#workerIdNm').val('');
        	$('#workTeamCd').val('');
        	$('#workerChangeModal').modal({backdrop: 'static'});
        	$('#workerChangeModal').modal('show');
		} else {
			toastr.warning('진행 상태 작지만 변경할 수 있습니다!', '', {timeOut: 5000});
		}
    ...
    //모달 작업자 변경 버튼 클릭 시
    $('#btnModalWorkerChange').on('click', function(){
		...
		if($('#workerIdNm').val() == '') {
			...
			$('#btnSelectWorkerId').focus();
			return false;
		}	
    	if($('#workerIdCd').val() == '') {
			toastr.warning("작업자를 다시 선택해주세요.");
			$('#btnSelectWorkerId').focus();
			return false;
		}
    	/*if($('#workTeamCd').val() == '') {
    		toastr.warning("작업 조가 없습니다. 다시 선택해주세요.");
			$('#btnSelectWorkerId').focus();
			return false;
		}*/
		
		let pastWorker = $('#workUserCd').val();
		let nowWorker = $('#workerIdCd').val();
		
		if(pastWorker == nowWorker){
			toastr.warning("현재 작업자와 동일한 작업자 입니다.");
			$('#btnSelectWorkerId').focus();
			return false;
		}
    ...
    //작업자 변경 내역 등록
	function workerChangeCreateFunction(){
		...
		var workTeamCd = workOrderTable.rows('.selected').data()[0].workTeamCd;

		if ($('#workerIdCd').val() == '' || $('#workerIdCd').val() == null) {
    		toastr.warning("변경할 작업자를 선택해주세요!");
			return false;
    	}*/
		...
		//작업자 변경 저장 ajax
		$.ajax({
	    	url: '<c:url value="po/workerChangeCreate"/>',
	        type: 'POST',
	        async: false,
	        data: {
	        	'menuAuth'	 			: 	menuAuth,
	        	...
	        	'workOrdNo'				:	function() { return workOrdNo; 						},	//작업지시번호
	        	'ordDate'				:	function() { return ordDateCal.replace(/-/g, ''); 	},	//작지일자
// 	        	'dayNightCd'			:	function() { return ordGubunCd; 					},	//주야간구분
// 	        	'workTeamCd'			:	function() { return $('#workTeamCd').val();			},	//작업조
	        	'workerId'				:	function() { return $('#workerIdCd').val();			},	//작업자 아이디
	        	'workStatusCd'			:	function() { return workStatusCd; 					},	//작업상태
	        	'workerStatusCd'		:	'H',													//작업자 상태
	        },
	        success: function (res) {
	            var data = res.data;
	       		if(res.result == "ok"){
	       			//reload된 행 다시 잡아주기.
	       			var rows 	= workOrderTable.rows('.selected').indexes();
	       			var index	= $('#workOrderTable').DataTable().row(rows).index();
	       			
	       			$('#workOrderTable').DataTable().ajax.reload(function(){
	       				$('#workOrderTable tbody tr').eq(index).addClass('selected');
		       		});

	       			$('#workerHistoryTable').DataTable().ajax.reload();
	       			$('#workerIdCd').val('');
	       			$('#workTeamCd').val('');
	       			$('#workerIdNm').val('');

// 	       			$('#workerChangeModal').modal('hide');
		       		
	       			toastr.success("작업자가 변경되었습니다.");
	       			workerChangeRead();
	       		} else{
	       			toastr.error(res.message, '', {timeOut: 5000});
	       		}
    ...
    //작업자 변경 작업 시작 시 등록
	function workerChange_workStartCreate(){
...
// 			ordGubunCd = "D";
		...
		$.ajax({
	        ...
	        data: {
	        	...
	        	'ordDate'				:	function() { return ordDateCal.replace(/-/g, ''); 	},	//작지일자
	        	//'dayNightCd'			:	function() { return ordGubunCd;						},	//주야간구분
// 	        	'workTeamCd'			:	function() { return workerChange_workTeamCd;		},	//작업조
	        	'workerId'				:	function() { return workerChange_userNumber;		},	//작업자 아이디
	        	'workStatusCd'			:	function() { return 'S'; 							},	//작업상태
	        	'workerStatusCd'		:	'S',													//작업자 상태
	        },
	        success: function (res) {
	            var data = res.data;
	       		if(res.result == "ok"){
...
// 	       			toastr.success("작업자가 변경되었습니다.");
    ...
    //작업자 변경 작업 종료 시 등록
	function workerChange_workEndCreate(){
...
// 	        	'workTeamCd'			:	function() { return workerChange_workTeamCd;		},	//작업조
	        	'workerId'				:	function() { return workerChange_userNumber;		},	//작업자 아이디
	        	'workStatusCd'			:	function() { return 'C'; 							},	//작업상태
	        	'workerStatusCd'		:	'C',													//작업자 상태
	        },
	        success: function (res) {
	            var data = res.data;
	       		if(res.result == "ok"){
...
//	                 $('#workTeamCd').val(data.teamCd);
	...
	//작업자 상세조회 ajax
	function workerChangeRead(){
		//작업자 상세조회 ajax
		$.ajax({
	    	url: '<c:url value="po/workerChangeRead"/>',
	        type: 'GET',
	        async: false,
	        data: {
	        	'menuAuth'	 			: 	menuAuth,
	        	...
	        	'workOrdNo'				:	function() { return workOrdNo; 						},	//작업지시번호
	        	'ordDate'				:	function() { return ordDateCal.replace(/-/g, ''); 	},	//작지일자
	        	'readCheckCode1'		:	'workerSearch',											//작업자 조회 시 필요한 코드
	        },
	        success: function (res) {
	            var data = res.data;
	       		if(res.result == "ok"){
		       		if(data != null){
		       			$('#workUserNm').text('작업자 '+data.workerIdNm+'님');
		       			$('#workUserCd').val(data.workerId);
			       	}else{
			       		$('#workUserNm').text('현재 작업자가 없습니다.');
			       		$('#workUserCd').val('');
					}
	...
	//담당자 모달이 hide이 됐을 때
   	$('#userPopUpModal').on('hidden.bs.modal', function (e) {
//    		workerIdCd = '';
//    		$('#workerIdCd').val('');
   		$('#userPopUpModal').attr('style', 'display: none; background-color: #14141f52;');
	});
	
   	let	workerHistoryTable;
   	
	//이전 작업자 보기버튼 클릭 시
   	$('#btnWorkerHistory').on('click', function(){

   		//이전 작업자 조회
   	   	workerHistoryTable = $('#workerHistoryTable').on( 'error.dt', function ( e, settings, techNote, message ) {
			if(techNote == 7) {
 				toastr.error("로그인 세션이 만료 되었습니다.<br/>재로그인 해 주세요.", '', {timeOut: 5000});
 				location.href = "/";
 			}
   		 ...
   		 dom: "<'row'<'col-sm-12 col-md-9'><'col-sm-12 col-md-3'>>"
   	        ...
   	        scrollY : "20vh",
   	        ajax: {
   	            url: '<c:url value="/po/workerChangeList"/>',
   	            type: 'GET',
   	            data: {
   	            	'menuAuth'	: 	menuAuth,
   		           	'equipCd'	:	function() { return equipCd; 	},
   	        ...
   	        order: [],
   	        drawCallback: function () {
   	        	$('#workerHistoryTable tbody tr').eq(0).addClass('skyYellow');
   	        },
   	    });
   		//이전 작업자 정보확인

   		$('#workerHistoryLabel').text(workOrdNo);
   	   	
   		//이전 작업자 정보확인
 		$('#workerHistoryTable').DataTable().ajax.reload();

   		$('#workerHistoryModal').fadeIn(300);
   		$('#workerChangeContent').attr('style', 'width: 60%; margin-left: 60%; margin-top: 20%;');
	});

	//이 작업자 조회 닫기 버튼 클릭 시
	$('#workerHistoryClose').on('click', function(){
		$('#workerHistoryModal').fadeOut(300, function(){
			$('#workerChangeContent').attr('style', 'width: 60%; margin-left: 30%; margin-top: 20%;');
   	   	});
	});

	//작업자조회 모달이 hide이 됐을 때
   	$('#workerChangeModal').on('hidden.bs.modal', function (e) {
   		$('#workerHistoryModal').attr('style', 'width: 85vh; display: none;');
   		$('#workerChangeContent').attr('style', 'width: 60%; margin-left: 30%; margin-top: 20%;');
	});
	
    
    //ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ작업자 변경 코드 끝ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
   
    //ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 초물 버튼 여부 칸에 있는 버튼 클릭시 ㅡㅡㅡㅡㅡㅡㅡ
    let creatStatusCd = 0;
    function firstStepCreat(value){

 
	        $('#workOrderTable tbody tr').eq( $('#workOrderTable tbody tr').length - 1 - value ).click();//3공장의 경우 내림차순으로 정렬이 되었기에 맨밑 행의 value값이 0, 그래서 (행갯수-1) - value
			//console.log($('#workOrderTable tbody tr').length - value);
			//workOrdNo = workOrderTable.row(value).data().workOrdNo;
...
// 							}
	    	...
	    	mainMatrlLotNo = $('#workOrderMatrlTable').find('td').eq(3).html();
	    	if (workOrdNo == null || workOrdNo == '') {
				toastr.warning("초물을 입력할 작업지시를 선택해주세요!");
				return false;
			}
    ...
    /* $('#ordLotNoStepModal').on('shown.bs.modal',function(){
  ...
  //ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ테프론,실리콘교체 수정 함수ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ
	...
	$('#btnDeleteWorkOrder').on('click', function() {
		...
		if( $("#workStatusCd" + workOrdIndex).val() == "B" ){
			...
			$('#deleteWorkOrdCheckPopupModal').modal({backdrop: 'static'});
			...
			toastr.warning('미발행 상태의 작지만 삭제 할 수 있습니다!', '', {timeOut: 5000});
			return false;
		} 
    });
	let updateGubun;
    ...
    $('#btnDeleteCheck,#btnDeleteCheckWorkOrdRestart,#btnchangeRegistrantCheck').on('click', function(){
		if( $('#deleteWorkOrdCheckPopupModal').hasClass('show') ){
			...
			authUserId = $('#deleteCheckWorkOrderUserId').val();
			...
			authUserId = $('#changeRegistrantId').val();
    ...
    $('#btnRegistrantChange').on('click', function() {
		if(!$('#outputCardTable Tbody tr').hasClass('selected')){
			toastr.warning('생산 작업자를 변경할 항목을 선택 해주세요!');
			return false;
		}
		$('#changeRegistrantPopUp').modal({backdrop: 'static'});
...
// 				$('#outputCardTable').DataTable().clear().draw(function(){});
    ...
    $('#btnReStart').on('click', function() {
		...
		if($("#workStatusCd" + workOrdIndex).val() == "C") {
			$('#workOrdReStartPopupModal').modal({backdrop: 'static'});
	...
	$('#btnTray').on('click', function(){
		...
		if (secondDiff >= 25200 && secondDiff <= 86399) {
			let minDate = new Date(new Date().setHours(0,0,0,0));
				...
				minDate = getDateType(minDate);
			$('#trayProductDate').attr('min', minDate);
			...
			if( sudel % 2 == 0 ) {
				for(var i=0; i<10; i++){
					if( $(this).find('td').eq(i).length ) {
						rowData = new Object();
						rowData.menuAuth				= menuAuth;
						rowData.trayNumber				= $(this).find('td').eq(i).text();					//트레이 번호
...
//				 		rowData.ordLotNo				= ordLotNo;							//생산전표번호
				...
				/* if( $(this).find('td').eq(1).length ) {
					rowData.preInWhsDate	= $(this).find('td').eq(1).text();
				}
				if( $(this).find('td').eq(2).length ) {
					rowData.preInWhsDate	= $(this).find('td').eq(2).text();
				}
				if( $(this).find('td').eq(3).length ) {
					rowData.preInWhsDate	= $(this).find('td').eq(3).text();
				}
				if( $(this).find('td').eq(4).length ) {
					rowData.preInWhsDate	= $(this).find('td').eq(4).text();
				}
				if( $(this).find('td').eq(5).length ) {
					rowData.preInWhsDate	= $(this).find('td').eq(5).text();
				} */
			}
			// 값 담아주는 부분 종료
			...
			/*//값 담아주는 부분 시작
			if( sudel % 2 == 0 ) {
				$('#trayLabelTable tbody tr').each(function(item, index) {
					switch( index ){
					case 0:
...
// 		console.log(dataArray);
		...
		$.ajax({
			...
			success: function (res) {
				let data = res.data;
				console.log("정장시 부여되는 값 확인 하는 Array");
				console.log(data);
				if (res.result == 'ok') {
					trayCheckView = false;
	...
	$(document).on('click','tr[name=trayTableRow]',function(e) {
		...
		var sudel = $(this);
		sudel.attr('style','border: 5px solid #0275d8;pointer-events : none;');
		setTimeout(function(){
			sudel.attr('style','');
		},150);
	...
	$('#btnVisorIncorporationGubun, #btnIncorporationGubun').on('click', function(){
		...
		if(mixGubun == "M") {
			...
			$('#mixColor')[0].style.backgroundColor = 'indianred';
			$('#minGubunValue').val('M');
		} else if(mixGubun == "V") {
			//비전 혼입인 애들 표시
			for(var i=0; i<$('td[name=incorporationTd]').length; i++){
			    if( $('td[name=incorporationTd]')[i].textContent.includes("_V") ) {
			        $('td[name=incorporationTd]')[i].classList.remove("notMixTd");
			...
			$('#mixColor')[0].style.backgroundColor = 'cornflowerblue'
			$('#minGubunValue').val('V');
		} else {
...
// 							}
	...
	function trayLabelPrint(type, data){
		...
		$.ajax({
			url : '<c:url value="po/productionPerfTrayPrintList_F3"/>',
			type : 'GET',
			async: false,
			data : {
...
// 					toastr.success('조회되었습니다.');
	...
	function labelPrint(printList, count) {
		...
		printOrder  = count % 2;
		printCnt	= (printOrder == 0) ? parseInt(count / 2) : parseInt(count / 2) + 1;
		if (printOrder == 0) {
			printOrder = 2;
		}
			...
			success: function (res) {
				...
				if (res.result == 'ok') {
					...
					for(var i=0; i<data.length; i++){
						...
						//let colorStyle = data[i].incorporationGubun == "Y" ? "style='color: red;'" : data[i].incorporationGubun == "V" ? "style='color: blue;'" : "style=''";
...
// 		rowData.ordLotNo				= ordLotNo;							//생산전표번호
		...
		$('#my-spinner').prepend('<div id="trayLodingLabel" style="width: 55vh;height: 8vh;position: fixed;left: 75vh;top: 55vh;font-size: 25px;color: black;background: white;text-align: center;"><label>현재 생산 실적 트레이를 생성하고 있습니다.</label><br><label>잠시만 기다려 주세요...( ﾉ ﾟｰﾟ)ﾉ</div>');
		$('#my-spinner').show();
