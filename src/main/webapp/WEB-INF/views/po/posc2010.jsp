...
<!-- 					<div id="equipScanDiv"></div> -->
			...
			<div class="right-list workOrder-left-list" id="middleList" style="width:77%; margin-right: 3px;">
				...
				<div class="card-body p-2">
					...
					<div class="row" style="position:relative" id="topButtonLayoutsArea">
						&nbsp;
						<div>
						...
						<div class="row">
							...
							<div style="display: flex; flex-direction: column;">
								<button type="button" class="btn btn-primary ml-4 touch6" id="btnSil1Faulty" style="margin-top:3px;">1차 진접 실리콘 교체</button>
								<button type="button" class="btn btn-primary ml-4 touch6" id="btnSil2Faulty" style="margin-top:3px;">2차 진접 실리콘 교체</button>
							</div>
							
						</div>
						
						
						<div style="position:absolute;right:0;display: flex;flex-direction: column-reverse;align-items: stretch;" >
							<select class="custom-select custom-select-md touch6 mt-1" id="showMenu">
...
<!-- 							<button type="button" class="btn btn-primary float-right touch6 d-none" id="btnCancel" style="margin-right: 5px;">진행 취소</button> -->
							<button type="button" class="btn btn-primary float-right touch6 mt-1" id="closeFullScreen" style="margin-right: 5px;">전체화면 해제</button>
							...
							<table id="workOrderTable" class="table table-bordered">
								...
								<thead class="thead-light">
									<tr>
										...
										<th style=min-width:60px">검사상태</th>
									</tr>
								</thead>
							</table>
						</div>
			...
			<div class="right-list right-70" id="rightList" style="width:9.5%; min-height:825px;">
				...
				<div class="btn-group-vertical" id="btnCard" style="width: 100%;">
					...
					<span><br></span>
					<button type="button" class="btn btn-primary btn-lg btnRight" style="display:none" id="btnRemainQty">잔량등록</button>
					<span><br></span>
					<!-- 
						...
						<table class="table table-bordered" id="outputCardTable" style="padding-left:0px; padding-right:0px;">
							<thead class="thead-light">
								<tr>
			                        ...
			                        <th class="text-center" style="min-width:70px;">등록일</th>
								</tr>
							</thead>
							<tfoot>
								<tr>
							...
							<tr>
								...
								<td>
									<div class="form-group input- m-0 row">
										<input class="form-control touch6" style="min-width:100%;" type="date" id="frrrdDate">
									</div>
								</td>
							</tr>
							<tr>
								<th>불량 비고</th>
								<td>
									<input type="text" id="frrrdDesc" style="max-width: 100%;" class="form-control touch6" />
								</td>
							<tr>
							<th>불량 유형</th>
								<td>
								<c:forEach var="item" items="${matrlFaultyType}">
									<div class="row">
										...
										<div class="col-6 text-center"><input type="checkbox" id="frrrdType${item.baseCd}" style="width: 25px;height: 25px;""></div>	
									</div>
								</c:forEach>
								</td>
							</tr>
	...
	<div class="modal-dialog modal-lg" style="min-width:800px;">
		<div class="modal-content">
			<div class="modal-header" style="padding:12px;">
				...
				<button type="button" class="close" data-dismiss="modal" aria-label="Close" id="ordLotNoStepClose">
					<span aria-hidden="true">&times;</span>
				</button>
			</div> 
			<div class="modal-body">
					...
					<div class="col">
						...
						<div id="equipSizeCondStepOrdLotNoCard"><!-- right-list 클래스 추가 후 rowspan 부분 회색으로 되지만 스크롤, 및 띠 생김 -->
							<ul class="nav nav-tabs card-header-tabs m-0">
								...
								<li class="nav-item"><a class="nav-link" id="tab2Nav" data-toggle="tab" href="#tab2">치수</a></li>
								<li class="nav-item ml-auto">
									<button type="button" class="btn btn-primary float-right mr-2 touch5 d-none" id="btnLastLotNoLoad">불러오기</button>
									<button type="button" class="btn btn-danger float-left mr-2 touch5" id="btnStepDelete">삭제</button>
									<button type="button" class="btn btn-primary float-right mr-2 touch5" id="btnStepSave">저장</button>
									<button type="button" class="btn btn-primary float-right mr-2 touch5" id="btnStepEdit">수정</button>
									<button type="button" class="btn btn-primary float-right mr-2 touch5 d-none" id="btnFirstStepInsert" disabled>초물 등록</button>
									...
									<div class="tab-pane fade" id="tab2">
										<table class="table table-bordered">
											...
											<tr>
												...
												<th class="touch3"><span class="cond" id="thEdgeCon2"></span></th>
											...
											<tr>
												<th class="touch3">Gap of Layer</th>
												<th class="touch3">폭</th>
												<th class="touch3"><span class="cond" id="gapOfLayerCond"></span></th>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 firstStep touch3" id="firstGapOfLayer"></td>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 secondStep touch3" id="secondGapOfLayer"></td>
												<td><input maxlength="8" min="0" max="1000" type="number" step="0.001" class="form-control number-float3 thirdStep touch3" id="thirdGapOfLayer" disabled></td>
											</tr>
			...
			<colgroup>
				...
				<tr>
				    ...
				    <td class="text-center">
				    	<input type="datetime-local" class="form-control touch6" id="ptfe1Date" min="1900-01-01T00:00" max="2100-12-31T00:00" style="min-width:100%; padding-right: 0px; padding-left:3px;" disabled>
				    </td>				 
				</tr>
				<tr>
				    <th>주야 구분</th>
				...
				<tr>
				    <th>불량(KG)</th>
				    <td class="text-center">
				    	<input type="number" class="form-control number-float3 touch6" style="min-width:100%;" maxlength="6" min="0" max="20" step="0.001" id="ptfe1Weight" value="0" disabled>
				    </td>
				</tr>
	    </table>      	
      </div>
		...
		<table class="table table-bordered">
			<colgroup>
				...
				<tr>
				    <th>불량(KG)</th>
				    <td class="text-center">
				    	<input type="number" class="form-control number-float3 touch6" style="min-width:100%;" maxlength="6" min="0" max="20" step="0.001" id="ptfe2Weight" value="0" disabled>
				    </td>
				</tr>
	    </table>      	
      </div>
...
<div class="modal modal-alert fade" id="matrlFaultyCancelModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="matrlFaultyCancelModal" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary touch6" id="btnFaultyCancelSave">불량 취소 처리</button>
				<button class="btn btn-danger d-none" id="btnDeleteConfirmLoading" type="button" disabled="">
					<span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading...
				</button>
				&nbsp;
				<button type="button" class="btn btn-secondary touch6" data-dismiss="modal">취소</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade bs-example-modal-lg shadow-lg" id="fifoCheckModal" tabindex="-1" role="dialog" aria-labelledby="fifoCheckModalLabel" aria-hidden="true" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document" style="margin-top: 3%;">
        <div class="modal-content" style="width: 100%; margin-left: 0%; margin-top: 20%;">
            ...
            <div class="modal-footer" id="">
            	<button type="button" class="btn btn-primary touch6" id="btnFifoInput" data-dismiss="modal">투입</button>
            	<button type="button" class="btn btn-secondary touch6" data-dismiss="modal">닫기</button>
            </div>
        </div>
    </div>
...
<!-- 생산실적(Tray) 프린트 확인 모달 시작 -->
<div class="modal fade" id="trayPrintCheckPopupModal" tabindex="-1" role="dialog" aria-labelledby="trayPrintCheckPopupModalLabel" aria-hidden="true" style="background-color: #2a2a2a2f;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">라벨발행 확인</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<h6>라벨을 프린트 하시겠습니까?</h6>
				<p style="margin-bottom:0px;">*6개 이상에 트레이 라벨이 생성되었습니다.</p>
				<label id="trayLabelTempArrayStorageSpace" style="display:none;"></label>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-success touch6" id="btnTrayPrintCheck" data-dismiss="modal" style="min-width: 70px;">프린트</button>
				<button type="button" class="btn btn btn-secondary touch6" id="" data-dismiss="modal" style="min-width: 70px;">닫기</button>
			</div>
		</div>
	</div>
</div>
<!-- 생산실적(Tray) 프린트 확인 모달 끝 -->

<!-- 작지 추가 시 오늘 날짜랑 다르면 경고  메세지 모달 시작 -->
<div class="modal fade fadebd-example-modal-lg" id="dateStatuseCheckModal" tabindex="-1" role="dialog" aria-labelledby="dateStatuseCheckModalLabel" aria-hidden="false">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">날짜 확인</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				...
				<p style="font-size: 15px;">*생산일과 다른 날짜입니다. 다시 확인 후 작업바랍니다.</p>
				<hr class="text-secondary">
			</div>
			<div class="modal-footer" style="display: flex;justify-content: space-between;">
			<button type="button" class="btn btn btn-danger touch6" style="min-width: 70px;" id="btnIgnore">무시</button>
				<button type="button" class="btn btn btn-primary touch6" data-dismiss="modal" style="min-width: 70px;">확인</button>
			</div>
		</div>
	</div>
</div>
<!-- 작지 추가 시 오늘 날짜랑 다르면 경고  메세지 모달 끝 -->

<!-- 트레이 선택 시 시프트 주야 다르면 경고  메세지 모달 시작 -->
<div class="modal fade fadebd-example-modal-lg" id="shiftDateCheckModal" tabindex="-1" role="dialog" aria-labelledby="shiftDateCheckModalLabel" aria-hidden="false" style="background: #0000005e;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">트레이 생산실적 정보 확인</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<hr class="text-secondary">
				<h6 style="color: black;font-size: 18px;background: aquamarine;text-align: center;font-weight: 500;" id="shiftDateCheckLabel"></h6>
				<label style="font-size: 15px;">*트레이 모달 주야 구분과 생산 날짜를 확인해주세요.</label>
				<br>
				<label style="font-size: 15px;">*확인 후 작업바랍니다.</label>
				<hr class="text-secondary">
			</div>
			<div class="modal-footer" style="display: flex;justify-content: space-between;">
			<button type="button" class="btn btn btn-danger touch6" style="min-width: 70px;" id="btnShiftDateCheckIgnore">무시</button>
				<button type="button" class="btn btn btn-primary touch6" data-dismiss="modal" style="min-width: 70px;">확인</button>
			</div>
		</div>
	</div>
</div>
<!-- 트레이 선택 시 시프트 주야 다르면 경고  메세지 모달 종료 -->


<!-- 초.중.종물 범위 벗어났을 때 경고  메세지 모달 시작 -->
<div class="modal fade fadebd-example-modal-lg" id="conditionErrorModal" tabindex="-1" role="dialog" aria-labelledby="conditionErrorModalLabel" aria-hidden="false" style="background: #0000005e;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">초.중.종물 범위 확인</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<hr class="text-secondary">
				<label style="font-size: 15px;">*초.중.종물 수량이 조건 수량에서 벗어납니다.</label>
				<br>
				<label style="font-size: 15px;">*계속 진행하시겠습니까?</label>
				<input type="hidden" id="currentFocusText">
				<hr class="text-secondary">
			</div>
			<div class="modal-footer" style="display: flex;justify-content: space-between;">
				<button type="button" class="btn btn btn-primary touch6" id="btnConditionCheck">확인</button>
				<button type="button" class="btn btn btn-primary touch6" id="btnConditionEdit">수정</button>
			</div>
		</div>
	</div>
</div>
<!-- 초.중.종물 범위 벗어났을 때 경고  메세지 모달 종료 -->

<!-- 직전작지와 동일한 LOT 일때 나오는 모달 -->
<div class="modal fade fadebd-example-modal-lg" id="matrlInputCheckModal" tabindex="-1" role="dialog" aria-labelledby="matrlInputCheckModalLabel" aria-hidden="false" style="background: #0000005e;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">동일자재 확인</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<hr class="text-secondary">
				<label style="font-size: 15px;">* 동일자재가 재투입됩니다.</label>
				<br>
				<label style="font-size: 15px;">* 재투입하시겠습니까?</label>				
				<hr class="text-secondary">
			</div>
			<div class="modal-footer" style="flex-wrap: nowrap;">				
				<button type="button" class="btn btn btn-primary touch6"  data-dismiss="modal" id="btnMatrlInputCheck">확인</button>
				<button type="button" class="btn btn btn-secondary touch6" id="" data-dismiss="modal">닫기</button>
			</div>
		</div>
	</div>
</div>
...
<!-- 작지일, 생산이 확인 모달 시작 -->
<div class="modal fade" id="dateStateCheckPopupModal" tabindex="-1" role="dialog" aria-labelledby="dateStateCheckPopupModalLabel" aria-hidden="true" style="z-index:99999; background-color: #00000033;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">날짜 확인</h5>
			...
			<div class="modal-body">
				<h6>작지일과 생산일이 다릅니다.</h6>
				<h6>무시하고 계속 진행하시겠습니까?</h6>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-danger touch6" id="btnDateWarningIgnore" data-dismiss="modal" style="min-width: 70px;">진행</button>
				<button type="button" class="btn btn btn-secondary touch6" id="" data-dismiss="modal" style="min-width: 70px;">닫기</button>
			</div>
		</div>
	</div>
...
<script>
	...
	let menuAuth = 'posc2010';
	let currentHref = 'posc2010';
	...
	if(factoryCode == '001' || factoryCode == '002') {
		//1공장 코드, 2공장 코드
		$('#btnRemainQty').attr('style', 'display:none');		//잔량등록

		//2공장 진접 교체 숨김
		if(factoryCode == '002') {
			$('#btnSil1Faulty').attr('style', 'display:none');
			$('#btnSil2Faulty').attr('style', 'display:none');
		}
	} else if(factoryCode == '003'){
		//3공장 코드
		$('#btnSil1Faulty').attr('style', 'display:none');		//1차진접테프론
		$('#btnSil2Faulty').attr('style', 'display:none');		//2차진접테프론
		$('#btnRemainQty').attr('style', '');					//잔량등록
	} else{
	...
	//공통코드 처리 시작
	var downtimeCode = new Array(); // 설치장소
	...
	let trayFunctionCheck = false; //트레이 예외처리
	...
	$('#dateLabel').text("오늘 날짜 : " + "${serverDate}");
...
// 			{ data: 'workOrdLotNo' },
		...
		columnDefs: [
			{ targets: [0,1,5,6,7,8], className: 'text-center' },
...
// 		rowsGroup: [ [0], [1] ],
	...
	//생산 날짜 입력 시
	$('#trayProductDate').keydown(function (event) {
		toastr.warning("날짜는 선택만 가능 합니다.");
		return false;
	});
...
// 			$('#btnFifoCheck').attr('disabled',true);
		...
		//mainView 비전불량 현황 컨트롤
		} else if (mainView == "visionFaulty") {
	...
	$('#btnAddWorkOrder').on('click', function () {
		...
		if( factoryCode == '003' ) {
			if( $('#ordDate').val() != $('#dateLabel').text().replace('오늘 날짜 : ', '')) {
				$('#dateStatuseCheckModal').modal({backdrop: 'static'});
				$('dateStatuseCheckModal').modal('show');
				return false;
			}
		}
	...
	$('#btnIgnore').on('click', function() {
		$('#dateStatuseCheckModal').modal('hide');
		$('#equipWorkOrdPlanListLabel').text('작업지시 추가 ' + ordDateCal);
		$('#equipWorkOrdPlanList').DataTable().ajax.reload( function () {});
		$('#equipWorkOrdPlanListModal').modal('show');
	});
			...
			{ data: 'goodsNm', 
	    		render: function(data, type, row, meta) {
					...
					var goodsNm_html = '<div class="input-sub m-0">';
						...
						goodsNm_html += '<input type="hidden" id="goodsInitial' + row['workNo'] + '" name="goodsInitial' + row['workNo'] + '" value="' + row['baseCdAbbr']  +  '" disabled>';
						goodsNm_html += '<input type="hidden" id="qutyEtcNm' + row['workNo'] + '" name="qutyEtcNm' + row['workNo'] + '" value="' + row['qutyEtcNm']  +  '" disabled>';
...
// 	$('#ordDate').val(ordDateCal);
	...
	$('#workOrderTable tbody').on('click', 'tr', function () {
		...
		if( workOrderTable.row(this).data() == null ){
			return false;
		}
			...
			//}
				...
				if ( $(this).hasClass("selected") ) {
					...
					/* if (!(sideView == null) && !(sideView == '')) {
						...
						if(factoryCode == '003') {
							//초물
							if( workOrderTable.row(this).data().firstStepCheckNm == "등록" ) {
								$('#btnOrdLotNoFirstStepNew').attr('style', "margin-top: 3px;margin-top:3px;background-color: gray;color: white;border: 1px gray solid;");
							} else {
								$('#btnOrdLotNoFirstStepNew').attr('style', "margin-top: 3px;");
							}
							//중물
							if( workOrderTable.row(this).data().secondStepCheckNm == "등록" ) {
								$('#btnOrdLotNoSecondStepNew').attr('style', "margin-top: 3px;margin-top:3px;background-color: gray;color: white;border: 1px gray solid;");
							} else {
								$('#btnOrdLotNoSecondStepNew').attr('style', "margin-top: 3px;");
							}
							//종물
							/* if( workOrderTable.row(this).data().thirdStepCheckNm == "등록" ) {
								$('#btnOrdLotNoThirdStepNew').attr('style', "margin-top: 3px;margin-top:3px;background-color: gray;color: white;border: 1px gray solid;");
							} else {
								$('#btnOrdLotNoThirdStepNew').attr('style', "margin-top: 3px;");
							} */
						}
						
						var sideviewstatus = '';

						if(sideView == 'output' || sideView == 'downtime' || sideView == 'visionFaulty'){
...
// 					$('#btnFifoCheck').attr('disabled', false);
					//$('#my-spinner').hide();
					$('#barcodeNo').focus();

					if (sideviewstatus == 'output') {
						$('#btnOutput').trigger('click');
					} else if (sideviewstatus == 'downtime') {
						$('#btnDowntime').trigger('click');
					} else if (sideviewstatus == 'visionFaulty') {
						$('#btnVisionFaulty').trigger('click');
					}
	        	}
	        }
		}
...
// 	    }
        ...
        if ($(this).hasClass('selected')) {
        	...
        	if (!(sideView == null) && !(sideView == '')) {
        		...
        		if (sideView == "firstStep") {
            		...
            		//goodsCd 첫글자가 A도아니면서 N도 아니면 true
            		if (!($(this).find("#matrlCd").val().substring(0,1) == 'A') && !($(this).find("#matrlCd").val().substring(0,1) == 'N')) {
            			toastr.warning("비전불량수량을 입력할 주자재(MetalLot)를 선택해주세요!");
            			return false;
            		}
            		if ($(this).find('td').eq(3).html() == null || $(this).find('td').eq(3).html() == '') {
            			toastr.warning("비전불량수량을 입력할 주자재(MetalLot)를 선택해주세요!");
			...
			//visionFaulty
				...
				$('#visionFaultyOrdDate').val('');
				$('#visionFaultyDayNightCd').val('');
				$('#visionFaultySumyCnt').val('0');
				$('#visionFaultyRegDate').val('');
				$('#visionBadTotal1').text('0');
				$('#visionBadTotal2').text('0');
    ...
    $("#barcodeNo").keypress(function (e) {
    	...
    	if (e.which == 13){
			...
			let workStatusValuesCheck = $('[id*=workStatusCd]').map(function() { return $(this).val() }).get();
	        
	        if( workStatusCd == "B" && workStatusValuesCheck.indexOf("S") != -1 ) {
	        	$('#barcodeNo').val("");
	            toastr.warning('현재 진행중인 작지가 있습니다.<br/>생산 완료 후  발행할 수 있습니다.');
	            return false;
	        }
	    	...
	    	//작지 자재LOT 확인
	        $.ajax({
	            url: '<c:url value="po/checkLastMatrlLotNo"/>',
	            type: 'POST',
	            async: false,
	            data: {
	            	'menuAuth'	 	: 		menuAuth,	          
				...
				success: function (res) {
					...
					if (res.result == 'ok') {						
						...
						//모달보여주기						
						$('#matrlInputCheckModal').modal('show');
					} else if (res.result == 'error') {
						toastr.error(res.message, '', {timeOut: 5000});
					}
				},
    ...
    $('#btnMatrlInputCheck').on('click',function () {
    	barcodeScanAjax();
    });


	function barcodeScanAjax(){
		$.ajax({
    ...
    $('#btnCancel').on('click', function() {
    	...
    	//$('.default-skin.pace-done').attr('style', 'pointer-events: none;');
...
//             	'workStatusCd'		: 		function() { return workStatusCd; },	//선택한 작업지시
		...
		if (checkWorkOrdStatusTemp) {
			...
			//$('#my-spinner').show();
			$('#my-spinner').hide();
			$('.default-skin.pace-done').attr('style', 'pointer-events: auto;');
			return false;
		} else {
			if($("#workStatusCd" + workOrdIndex).val() == "S") {
    	   	        ...
    	   	        success: function (res) {
    	   	        	if(res.result == 'ok') {
							if(res.check == 3){
								...
								toastr.warning('초,중,종물이 모두 입력되어야 종료 할 수 있습니다!', '', {timeOut: 5000});
							}
            	   	    }
    	   	        }
    		 });
    ...
    function workOrderChargr() {
  	...
  	$('#btnSave').on('click', function() {
        ...
        $('#workOrderMatrlTable tbody tr').each(function() {
        	...
        	var trayMtCdCheck = $(this).find('td').eq(1).find('input').val();
        	var trayMtCdValue = $(this).find('td').eq(3).html();

        	//메탈
        	if( trayMtCdCheck.substring(0,1) == "A" || trayMtCdCheck.substring(0,1) == "N" ) {
				matrlLotNo = trayMtCdValue;
			}

            //필름
			if( trayMtCdCheck.substring(0,1) == "F" ) {
				if( filmLotNo == "" ) {
					filmLotNo = trayMtCdValue;
				} else {
					if( filmLotNo.indexOf( trayMtCdValue ) < 0 ) {
						filmLotNo = filmLotNo + "/" + trayMtCdValue;
					}
				}
			}
...
// 	        }
	...
	*/
	...
	$('#left-expand').on('click', function(){
		...
		$("#rightList").animate({
			...
			$('#visionFaultyCard').addClass("d-none");				//생산실적 입력
			$('#faultyCard').addClass("d-none");					//불량중량 입력
			...
			$('#topButtonLayoutsArea').removeClass('d-none');
	...
	$('#btnFirstStepInsert, #btnSecondStepInsert, #btnThirdStepInsert').on('click',function() {
		...
		//DGS Redis사용 workOrderStepInsertRedis_DB0
		$.ajax({
			url: url,
			type: 'POST',
			async: false,
			...
			complete:function() {
				if(factoryCode == '003') {
					$('#ordLotNoStepModal').modal('hide');
					$('#workOrderTable').DataTable().ajax.reload( function () {
						//해당 작지 관련해서 값 잡아주기
						workOrderTableClick();
					});
				}
				$('#btnLastLotNoLoad').addClass('d-none');
				$('#my-spinner').hide();
			}
		});
	});
   ...
   //초물 삭제 확인
			...
			success: function (res) {
				...
				if (res.result == 'ok') {
					...
					if (ordLotNoStepCd == '001') {
	   					...
	   					//해당 요소안에 id가 first가 포함되면서 type이 number인 것 모두 0값 처리 적용
	   					$("#tab2 [id*='first'][type='number']").val(0);
	   					...
	   					$("#tab2 [id*='second'][type='number']").val(0);
	   					...
	   					$("#tab2 [id*='third'][type='number']").val(0);
	...
	$('#btnOutput').on('click', function() {
		...
		if (workOrdNo == null) {
			toastr.warning("비전불량을 조회할 작업지시를 선택해주세요!");
			return false;
		}
		//자재행 선택하였는지 확인
		if ($("#workOrderMatrlTable").find(".selected").length != 1) {
			toastr.warning("비전불량을 입력할 주자재(MetalLot)를 선택해주세요!");
			return false;
		}
		if (mainMatrlLotNo == null || mainMatrlLotNo == '') {
			toastr.warning("비전불량을 입력할 주자재(MetalLot)를 선택해주세요!");
		...
		if (checkWorkOrdStatusTemp) {
			...
			$("#rightList").animate({
				...
				$('#outPutCard').removeClass("d-none");				//생산실적 입력
				$('#topButtonLayoutsArea').addClass('d-none');
			});
	...
	$('#btnVisionFaulty').on('click', function() {
		...
		if (checkWorkOrdStatusTemp) {
			...
			$("#rightList").animate({
				...
				$('#btnCancel').addClass('d-none');					//작지 추가 버튼
				$('#workUserNm').addClass('d-none');*/
				$('#visionFaultyCard').removeClass("d-none");		//비전불량 현황 입력 시작
				$('#topButtonLayoutsArea').addClass('d-none');
			});
...
// 	    }        
				...
				if(res.result == 'ok') {
					...
					//초,중물,종물 데이터가 있는 경우
						...
						for(var i=0;i<data.length;i++) {
							...
							$('#'+stepNm+'GapOfLayer').val(data[i].gapOfLayer);
   	        ...
   	        success: function (res) {
				...
				//치수 조건
   	            if (res.result == 'ok') {
   	            	...
   	            	$('#thEdgeCond2').text('-'+condStepData.thEdgeAlwnceMinus + ' [' + condStepData.thEdgeCond + '] +' + condStepData.thEdgeAlwncePlus);
	...
	$("#tab2Nav, #ordLotNoStepClose").on('click', function() {
		if(isProgress) {
			return false;
		}
	})
	...
	$('#btnStepSave').on('click', function() {
		...
		if (ordLotNoStepCd == '001') {
			//초물 필수 입력 데이터 값
			if( $('#firstMetalThicknessAlwnce').val() == "0" || $('#firstMetalThicknessAlwnce').val() == "" ) {
				toastr.warning("초물/치수 - METAL(두께) 입력 후 저장해주세요");
				$('#firstMetalThicknessAlwnce').focus();
				return false;
			}
			if( $('#firstThCenterAlwnce').val() == "0" || $('#firstThCenterAlwnce').val() == "" ) {
				toastr.warning("초물/치수 - 총두께(Center) 입력 후 저장해주세요");
				$('#firstThCenterAlwnce').focus();
				return false;
			}
			if( $('#firstThEdgeAlwncePlus').val() == "0" || $('#firstThEdgeAlwncePlus').val() == "" ) {
				toastr.warning("초물/치수 - 총두께(Edge) 입력 후 저장해주세요");
				$('#firstThEdgeAlwncePlus').focus();
				return false;
			}
			if( $('#firstInput').val() == "0" || $('#firstInput').val() == "" ) {
				toastr.warning("초물/치수 - 총두께(Edge2) 입력 후 저장해주세요");
				$('#firstInput').focus();
				return false;
			}
			//초물 필수 입력 데이터 값
			...
			//종물 필수 입력 데이터 값
			if( $('#secondMetalThicknessAlwnce').val() == "0" || $('#secondMetalThicknessAlwnce').val() == "" ) {
				toastr.warning("종물/치수 - METAL(두께) 입력 후 저장해주세요");
				$('#secondMetalThicknessAlwnce').focus();
				return false;
			}
			if( $('#secondThCenterAlwnce').val() == "0" || $('#secondThCenterAlwnce').val() == "" ) {
				toastr.warning("종물/치수 - 총두께(Center) 입력 후 저장해주세요");
				$('#secondThCenterAlwnce').focus();
				return false;
			}
			if( $('#secondThEdgeAlwncePlus').val() == "0" || $('#secondThEdgeAlwncePlus').val() == "" ) {
				toastr.warning("종물/치수 - 총두께(Edge) 입력 후 저장해주세요");
				$('#secondThEdgeAlwncePlus').focus();
				return false;
			}
			if( $('#secondInput').val() == "0" || $('#secondInput').val() == "" ) {
				toastr.warning("종물/치수 - 총두께(Edge2) 입력 후 저장해주세요");
				$('#secondInput').focus();
				return false;
			}
			//종물 필수 입력 데이터 값
			...
			//중물 필수 입력 데이터 값
			if( $('#thirdMetalThicknessAlwnce').val() == "0" || $('#thirdMetalThicknessAlwnce').val() == "" ) {
				toastr.warning("중물/치수 - METAL(두께) 입력 후 저장해주세요");
				$('#thirdMetalThicknessAlwnce').focus();
				return false;
			}
			if( $('#thirdThCenterAlwnce').val() == "0" || $('#thirdThCenterAlwnce').val() == "" ) {
				toastr.warning("중물/치수 - 총두께(Center) 입력 후 저장해주세요");
				$('#thirdThCenterAlwnce').focus();
				return false;
			}
			if( $('#thirdThEdgeAlwncePlus').val() == "0" || $('#thirdThEdgeAlwncePlus').val() == "" ) {
				toastr.warning("중물/치수 - 총두께(Edge) 입력 후 저장해주세요");
				$('#thirdThEdgeAlwncePlus').focus();
				return false;
			}
			if( $('#thirdInput').val() == "0" || $('#thirdInput').val() == "" ) {
				toastr.warning("중물/치수 - 총두께(Edge2) 입력 후 저장해주세요");
				$('#thirdInput').focus();
				return false;
			}
			//중물 필수 입력 데이터 값
		...
		$.ajax({
			...
			data: {
				...
				'gapOfLayer'			:	$('#' + sideView.replace('Step', '') + 'GapOfLayer').val()
			},
			success: function (res) {
				let result = res.result;
				if (res.result == 'ok') {
  	...
  	$('.select_prcssFaulty').on('click', function() {
		if( workOrdNo != null){
			...
			if (prcssTemp == 0){
				...
				//치수 불량 맨 위로 올리는 코드
				var dayHtml1 = "<tr id='" + $('#dayTbody tr').find('th:contains("치수 불량")').parent().attr('id') +"'>" + $('#dayTbody tr').find('th:contains("치수 불량")').parent().html() + "</tr>";
				var dayHtml2 = "<tr>" + $('#dayTbody tr').find('th:contains("치수 불량")').parent().next().html() + "</tr>";

				$('#dayTbody tr').find('th:contains("치수 불량")').parent().next().remove();
				$('#dayTbody tr').find('th:contains("치수 불량")').parent().remove();

				$('#dayTbody').prepend(dayHtml2);
				$('#dayTbody').prepend(dayHtml1);

				
				var nightHtml1 = "<tr id='" + $('#nightTbody tr').find('th:contains("치수 불량")').parent().attr('id') +"'>" + $('#nightTbody tr').find('th:contains("치수 불량")').parent().html() + "</tr>";
				var nightHtml2 = "<tr>" + $('#nightTbody tr').find('th:contains("치수 불량")').parent().next().html() + "</tr>";

				$('#nightTbody tr').find('th:contains("치수 불량")').parent().next().remove();
				$('#nightTbody tr').find('th:contains("치수 불량")').parent().remove();
				
				$('#nightTbody').prepend(nightHtml2);
				$('#nightTbody').prepend(nightHtml1);
				//치수 불량 맨 위로 올리는 코드
...
// 		$('#faultyRegDate').attr('disabled', false);
 ...
 /* -------------------------------------------------- 비가동사유 기능 시작 -------------------------------------------------- */
	...
	$(document).on('focusout','.number-float3', function(event) {
		if( $('#ordLotNoStepModal').hasClass('show') ) {
			
			if( $($(this.parentNode.parentNode).find('th')[0]).text() != 'Edge' && $($(this.parentNode.parentNode).find('th')[0]).text() != 'Edge2' ) {
				
				let data	= $(this.parentNode.parentNode).find('th span').text();
				...
				if( data != "" ) {
					...
					if( min > $(this).val() ) {
						//O
						$('#currentFocusText').val( $(this).attr('id') );
						$('#conditionErrorModal').modal('show');
						isProgress=true;
						return false;
	...
	//확인 눌렀을 때
	$('#btnConditionCheck').on('click', function(){
		$('#conditionErrorModal').modal('hide');
		isProgress = false;
	});
	
	//수정 눌렀을 때
	$('#btnConditionEdit').on('click', function(){
		$('#conditionErrorModal').modal('hide');
		$('#'+$('#currentFocusText').val()).focus();
		isProgress = true;
	});
	
	$('#ordLotNoStepModal').on('hidden.bs.modal', function(e){
		isProgress = false;
	});
	...
	$('#fifoCheckModal').on('shown.bs.modal', function () {
	...
	//선입선출 내역 클릭 시
	$('#fifoCheckHistoryTable tbody').on('click', 'tr', function () {
    	if($('#fifoCheckHistoryTable tbody').text() == '데이터가 없습니다.'){
			return false;
		}
		...
		if ($(this).hasClass('selected')) {
			...
			$('#fifoCheckHistoryTable').DataTable().$('tr.selected').removeClass('selected');
			$(this).addClass('selected');
		}
    });
	
	//선입선출 모달 투입 버튼 클릭 시
	$('#btnFifoInput').on('click', function(){
		
		if( $('#fifoCheckHistoryTable ').DataTable().rows( '.selected' ).data()[0] == null ) {
			toastr.warning("투입목록을 선택해 주세요.");
			return false;
		}
		
		var fifoBarcodeNo = $('#fifoCheckHistoryTable ').DataTable().rows( '.selected' ).data()[0].barcodeNo;
		$('#barcodeNo').val("");
		$('#barcodeNo').val(fifoBarcodeNo);
...
// 	}, 60000);
    ...
    function faultyStatusUpdate(faultySender){
    	...
    	$.ajax({
            ...
            data: {
            	'menuAuth'	 		: 		menuAuth,
            	'workOrdNo'			:		function() { return workOrdNo; },		//선택한 작업지시
            	'lotNo'				: 		function() { return mainMatrlLotNo; },	//선택한 lotNo
	...
	function updateMtrlInOutWhsInspectQty(approvalCd)
    {
		...
		$('#matrlFaultytable tbody tr').each(function(){
			...
			rowData.faultyStatus 	= '002';
			rowData.fautlyByProductionTeam	= 'Y';		//생산팀 불량 구분자
...
/* 		if (outputCardTableIndex == null) {
	...
	function lotNoDuplicateCheck(){
		//작지 자재LOT 확인
        $.ajax({
            url: '<c:url value="po/checkBefoerMatrlLotNo"/>',
            type: 'POST',
            async: false,
            data: {
            	'menuAuth'	 	: 		menuAuth,	          
			...
			success: function (res) {
				...
				if (res.result == 'ok') {						
					...
					// 불러오기 가능
					$('#btnLastLotNoLoad').removeClass('d-none');				
				} else{
					$('#btnLastLotNoLoad').addClass('d-none');
				}
			},
	...
	$('#btnLastLotNoLoad').on('click',function(){
		 $.ajax({
	            url: '<c:url value="po/agtDataLoad"/>',
	            type: 'POST',
	            async: false,
	            data: {
	            	'menuAuth'	 	: 		menuAuth,	          
  ...
  //1차 진접 테프론 교체 모달이 닫힐 때 
    ...
    $('#btnDeleteCheck,#btnDeleteCheckWorkOrdRestart,#btnchangeRegistrantCheck,#btnFifoAuthorityCheck').on('click', function(){
		if( $('#deleteWorkOrdCheckPopupModal').hasClass('show') ){
			...
			authUserId	= $('#fifoAuthorityCheckUserId').val();
...
// 				$('#outputCardTable').DataTable().clear().draw(function(){});
	...
	$('#btnTray').on('click', function(){
		...
		//label 확인
		if( factoryCode == '003' ) {
			if ( $('#qutyEtcNm'+workOrdIndex).val() == null || $('#qutyEtcNm'+workOrdIndex).val() == "" || $('#qutyEtcNm'+workOrdIndex).val() == 'null' ) {
				toastr.warning('해당 작지에 재질이 없습니다. 작지를 확인해주세요.', '', {timeOut: 5000});
				return false;
			}
			if ( $('#goodsInitial'+workOrdIndex).val() == null || $('#goodsInitial'+workOrdIndex).val() == "" || $('#goodsInitial'+workOrdIndex).val() == 'null' ) {
				toastr.warning('해당 제품에 기종코드가 잡혀있지 않습니다.', '', {timeOut: 5000});
				return false;
			}
		}
		//label 확인
		...
		btnShiftDateCheckIgnore = true;	//무시 버튼 기능 초기화
		...
		//현재시간이 19:00:00 ~ 23:59:59 이면 전표(생산)일자는 오늘, 야간으로 표시
		if (secondDiff >= 68400 && secondDiff <= 86400) {
		//현재시간이 14:00:00 ~ 23:59:59 이면 전표(생산)일자는 오늘, 야간으로 표시
// 		if (secondDiff >= 50400 && secondDiff <= 86400) {
			$('#trayDayNight').val("N");
		...
		//현재시간이 07:00:00 ~ 23:59:59 이면 전표(생산)일자는 오늘 날짜로 표시
		if (secondDiff >= 25200 && secondDiff <= 86399) {
		//현재시간이 07:00:00 ~ 14:00:00 이면 전표(생산)일자는 오늘 날짜로 표시
		//if (secondDiff >= 25200 && secondDiff <= 50400) {
		...
		//현재시간이 00:00:00 ~ 06:59:59 이면 전표(생산)일자는 전 날짜로 표시
		if (secondDiff >= 0 && secondDiff <= 25199) {
		//현재시간이 14:00:00 ~ 06:59:59 이면 전표(생산)일자는 전 날짜로 표시
		//if (secondDiff >= 50400 && secondDiff <= 25199) {
			let minusOneday = new Date(new Date().setHours(0,0,0,0));
				minusOneday.setDate(minusOneday.getDate()-1);
				minusOneday = getDateType(minusOneday);
		...
		if(workStatusCd == "C"){
			...
			$('#trayProductDate').attr('disabled', true);				//생산 날짜	
			$('#trayDayNight').attr('disabled', true);					//주야 구분
			...
			$('#trayProductDate').attr('disabled', false);				//생산 날짜	
			$('#trayDayNight').attr('disabled', false);					//주야 구분
		}
		...
		$('#trayProductDate').attr('disabled', true);
	});
	...
	$(document).on('click','button[name=trayLabel]',function(e){
		...
		if( $(this).val() == "1" ) {
			...
			if(btnShiftDateCheckIgnore) {
				//현재시간이 19:00:00 ~ 23:59:59 이면 전표(생산)일자는 오늘, 야간으로 표시
				if (secondDiff >= 68400 && secondDiff <= 86400) {
					//N
					if( workOrderTable.rows('.selected').data()[0].ordGubun == "D" ) {
						$('#shiftDateCheckLabel').text("현재 야간실적 시간입니다. 선택된 작업지시는 주간 입니다.");
						$('#shiftDateCheckModal').modal({backdrop: 'static'});
						$('#shiftDateCheckModal').modal('show');
						return false;
					}
				//현재시간이 00:00:00 ~ 07:00:00 이면 전표(생산)일자는 전날, 야간으로 표시
				} else if (secondDiff >= 0 && secondDiff <= 25200) {
				...
				//현재시간이 07:00:00 ~ 18:59:59 이면 전표(생산)일자는 오늘, 주간으로 표시
					...
					//D
					if( workOrderTable.rows('.selected').data()[0].ordGubun == "N" ) {
						$('#shiftDateCheckLabel').text("현재 주간실적 시간입니다. 선택된 작업지시는 야간 입니다.");
						$('#shiftDateCheckModal').modal({backdrop: 'static'});
						$('#shiftDateCheckModal').modal('show');
						return false;
					}
		...
		if( $(this).hasClass('on') ) {
			...
			//버튼 클릭 MAX 설정
			if( $(this).val() == 17 ) {
				toastr.warning("최대 트레이 선택 개수는 16개입니다.<br>변경 원할 시 관리자에게 문의해주세요.");
				$(this).blur();
				return false;
			}
...
//	 					$('#trayNumber').attr('colspan', countTd);
	...
	let btnShiftDateCheckIgnore = true;
	//시프트 단위와 다른 작진 인 경우 무시 버튼 클릭 시
	$('#btnShiftDateCheckIgnore').on('click', function(){
		btnShiftDateCheckIgnore = false;
		$('#shiftDateCheckModal').modal('hide');
	});
	...
	$('#trayLabelSave').on('click', function() {
		...
		if ( $('#ordDate').val() != $('#trayProductDate').val() ) {
			$('#dateStateCheckPopupModal').modal('show');
			return false;
		}
	...
	//트레이모달 저장 버튼 클릭 시
	$('#btnDateWarningIgnore').on('click', function() {
		trayLabelCreate();
	});
	
	
	function trayLabelCreate(){
		//label 확인
		if( factoryCode == '003' ) {
			if ( equipNm == null || equipNm == "" ) {
				toastr.warning('설비를 선택해주세요.', '', {timeOut: 5000});
				return false;
			}
			if ( $('#qutyEtcNm'+workOrdIndex).val() == null || $('#qutyEtcNm'+workOrdIndex).val() == "" || $('#qutyEtcNm'+workOrdIndex).val() == 'null' ) {
				toastr.warning('해당 작지에 재질이 없습니다. 작지를 확인해주세요.', '', {timeOut: 5000});
			...
			if ( $('#trayProductDate').val() == null || $('#trayProductDate').val() == "" ) {
				toastr.warning('트레이 날짜를 다시 선택해주세요.', '', {timeOut: 5000});
				return false;
			}
			if ( $('#trayProductDate').val() == null || $('#trayProductDate').val() == "" ) {
				toastr.warning('트레이 날짜를 다시 선택해주세요.', '', {timeOut: 5000});
			...
			if ( $('#trayProductDate').val().replaceAll("-", "").substring(2).length != 6 ) {
				toastr.warning('트레이 날짜를 길이가 다릅니다. 다시 선택해주세요.', '', {timeOut: 5000});
				return false;
			}
			if ( $('#trayDayNight option:selected').val() == null || $('#trayDayNight option:selected').val() == "" ) {
				toastr.warning('주간 야간 구분을. 다시 선택해주세요.', '', {timeOut: 5000});
				return false;
			}
		}
		//label 확인
...
//				 		rowData.productQty				= productQty;										//생산수량
				 		...
				 		rowData.incorporationVisonGubun	= $(this).find('td').eq(i).text().indexOf("_V") > 0 ? "Y" : $(this).find('td').eq(i).text().indexOf("_MV") > 0 ? "Y" : "N";
//				 		rowData.ordLotNo				= ordLotNo;											//생산전표번호
		...
		let labelLotNo = equipNm.replaceAll("-", "") +  $('#qutyEtcNm'+workOrdIndex).val() + "-" + $('#goodsInitial'+workOrdIndex).val() + $('#trayProductDate').val().replaceAll("-", "").substring(2) + $('#trayDayNight option:selected').val();
		...
		$.ajax({
			...
			data : {
				...
				'labelLotNo'	:	function() {return labelLotNo;	},
				'lgesGubun'		:	function() {return "N";	},
			},
			success: function (res) {
				let data = res.data;
				if (res.result == 'ok') {
					...
					if( set != "" ) {
						//프린트
						$('#trayPrintCheckPopupModal').modal({backdrop: 'static'});
						$('#trayPrintCheckPopupModal').modal('show');
						$('#trayLabelTempArrayStorageSpace').text("");
						$('#trayLabelTempArrayStorageSpace').text(set);
	...
	//트레이 프린터 버튼 클릭 시
	$('#btnTrayPrintCheck').on('click', function(){
		trayLabelPrint("002", $('#trayLabelTempArrayStorageSpace').text().split(','));
	});
...
/* 		setTimeout(function(){
		...
		if( $(this).attr('id') != "null" ) {
			$.ajax({
				url : '<c:url value="po/productionPerfTrayRankList"/>',
				type : 'GET',
				//async: false,
				data : {
					//'labelLotNo' : function(){ return $(this).attr('id'); },
					'labelLotNo' : function(){ return $('#trayLabelLotNo').text(); },
				},
				success: function (res) {
					let data = res.reprintYn;

					if (res.result == 'ok') {
						
						if( data == 'Y' ) {
							let html = '<label class="ml-2" id="trayReprint">(재출력된 번호입니다.)</label>';
							$('#trayLabelLotNo').after(html);
						}
	...
	$('#btnVisorIncorporationGubun, #btnIncorporationGubun').on('click', function(){
		...
		$('#incorporationGubunTable tbody').find('td.perfectTray, td.beforeImperfectTray').attr('name', 'incorporationTd');
		...
		$('td[name=incorporationTd]').removeClass('beforeImperfectTray');
		...
		if(mixGubun == "M") {
			...
			for(var i=0; i<$('td[name=incorporationTd]').length; i++){
		    	...
		    	if( $('td[name=incorporationTd]')[i].textContent.includes("_M") ) {
			        ...
			        if( !$('td[name=incorporationTd]')[i].textContent.includes("_V") && !$('td[name=incorporationTd]')[i].textContent.includes("_MV") ){
	...
	$(document).on('click','td[name=incorporationTd]',function(e){
		...
		//생산한 제품이 다른 경우 혼입 X
		if( $(this).data('goods') != $("#goodsCd"+workOrdIndex).val() ) {
			toastr.warning("현재 생산 제품과 달라 혼입을 진행할 수 없습니다.");
			return false;
		}
	...
	$('#trayIncorporationSave').on('click', function(){
		...
		if( $('#minGubunValue').val() == "M" ){
			for(var i=0; i<$('td.mixMetalTd').length; i++){
				...
				obj.afterIncorporationVisonGubun 	= $('td.mixMetalTd').eq(i).text().indexOf("_V") > 0 ? "Y" : $('td.mixMetalTd').eq(i).text().indexOf("_MV") > 0 ? "Y" : "N";
				dataArray.push(obj);
			}
			//혼입이 아닌 못난 애기들
			for(var i=0; i<$('td.notMixTd').length; i++){
				...
				obj.afterIncorporationVisonGubun 	= $('td.notMixTd').eq(i).text().indexOf("_V") > 0 ? "Y" : $('td.notMixTd').eq(i).text().indexOf("_MV") > 0 ? "Y" : "N";
				dataArray.push(obj);
			}
		}
		...
		if( $('#minGubunValue').val() == "V" ){
			for(var i=0; i<$('td.mixVisorTd').length; i++){
				...
				obj.afterIncorporationVisonGubun 	= $('td.mixVisorTd').eq(i).text().indexOf("_V") > 0 ? "Y" : $('td.mixVisorTd').eq(i).text().indexOf("_MV") > 0 ? "Y" : "N";
				dataArray.push(obj);
			}
			//혼입이 아닌 못난 애기들
			for(var i=0; i<$('td.notMixTd').length; i++){
...
// 							}
					...
					createTableTd();
					trayUiProc(true);
					$('#btnTrayReset').attr('disabled', false);	//초기화 버튼
	...
	$('#btnTrayDeleteCheck').on('click', function(){
		...
		for(var i=parseInt($('button[name=deleteTrayLabel].trayBtnSlDelete').length)-1; i>=0; i--){
			...
			obj.incorporationVisonGubun		= $('td[name='+$('button[name=deleteTrayLabel].trayBtnSlDelete')[i].textContent+']').eq(1).text().indexOf("_V") > 0 ? "Y" : $('td[name='+$('button[name=deleteTrayLabel].trayBtnSlDelete')[i].textContent+']').eq(1).text().indexOf("_MV") > 0 ? "Y" : "N";		//혼입구분
...
// 			trayNo += "\'[" + $('button[name=deleteTrayLabel].trayBtnSlDelete')[i].textContent + "\]',";
		...
		$.ajax({
            ...
            complete : function() {
            	...
            	if( $('#trayButtonRange button:not(:disabled)').length != 20 ){
            		btnShiftDateCheckIgnore = true;	//무시 버튼 기능 초기화
            	}
			}
		});
	...
	$('#btnTrayPartRePrint').on('click', function(){
		...
		//프린트 관리 - 개별 재출력 클릭 시 업데이트..
		if( factoryCode == '001' || factoryCode == "002" ) {
			//수정
			$.ajax({
				url : '<c:url value="po/trayReprintCheckUpdate"/>',
				type : 'POST',
				data : {
					'labelLotNo'	: function() {return $('#trayLabelLotNo').text(); },
					'trayReprintYn'	: function() {return "Y"; },
				},
				success: function (res) {
					let data = res.data;
					if (res.result == 'ok') {
						toastr.success('재출력 상태값이 업데이트 되었습니다.');
					} else {
						toastr.error(res.message);
					}
	            },
	...
	function trayLabelPrint(type, data){
		...
		if( factoryCode == '001' || factoryCode == "002" ) {
			url = "po/productionPerfTrayPrintList_F2"
		} else {
			url = "po/productionPerfTrayPrintList_F3";	
		}
		...
		$.ajax({
			...
			data : {
				...
				'equipNm'	: function(){ return equipNm.substr(1,1); }
			},
			success: function (res) {
						...
						if( countTr == 0 || countTr == 1 ) {
							...
							if(countTd == 0){
								...
								if( data[i].productStatus == "003" ) {
									...
									html1 += '<td class="perfectTray" '+colorStyle+' name="'+data[i].trayNo+'" data-goods="'+data[i].goodsCd+'">'+data[i].trayNo+'<input type="hidden" value="'+data[i].productStatus+'"></td>';
								} else {
									...
									if(workOrdNo == data[i].workOrdNo){
										html1 += '<td class="imperfectTray" '+colorStyle+' name="'+data[i].trayNo+'" data-goods="'+data[i].goodsCd+'">'+data[i].trayNo+'<input type="hidden" value="'+data[i].productStatus+'"></td>';	
									} else {
										html1 += '<td class="beforeImperfectTray" '+colorStyle+' name="'+data[i].trayNo+'" data-goods="'+data[i].goodsCd+'">'+data[i].trayNo+'<input type="hidden" value="'+data[i].productStatus+'"></td>';
									}
								}
								html1 += '</tr>';
								$('#trayLabelTable tbody').append(html1);
...
// 		rowData.ordLotNo				= ordLotNo;							//생산전표번호
	...
	//비전 데이터 가져오기
	function visionDataGet(){
		$.ajax({
	    	url: '<c:url value="wm/visionDataListGet"/>',
	        type: 'POST',
	        async: false,
	        data: {	        	
	        	'equipNm'				:	function() { return equipNm; 						},	//설비코드
	        	'workOrdNo'				:	function() { return workOrdNo; 						},	//작업지시번호	        	
	        },
	        success: function (res) {
	            var data = res.data;
	       		if(res.result == "ok"){
	       			toastr.success("비전데이터가 저장되었습니다.");
	       		} else{
	       			toastr.error(res.message, '', {timeOut: 5000});
	       		}
	       		$('#my-spinner').hide();
	...
	//해당 작지 관련해서 값 잡아주기
	function workOrderTableClick() {
		for( var i=0; i< workOrderTable.data().length; i++ ) {
		    if( workOrderTable.data()[i].workStatusCd == 'S' ) {
		        //console.log('진행 있음' + workOrderTable.data()[i].workNo);
		        $('#workOrderTable tbody tr').eq( ( workOrderTable.data()[i].workNo - 1) ).trigger("click");
		        break;
		    } else if( workOrderTable.data()[i].workStatusCd == 'P' ) {
		        //console.log('발행있음' + workOrderTable.data()[i].workNo);
		        $('#workOrderTable tbody tr').eq( ( workOrderTable.data()[i].workNo - 1) ).trigger("click");
		    } else if( workOrderTable.data()[i].workStatusCd == 'B' ) {
		        //console.log('발행있음' + workOrderTable.data()[i].workNo);
		        $('#workOrderTable tbody tr').eq( ( workOrderTable.data()[i].workNo - 1) ).trigger("click");
		    } else {}
		}
...
<script>
	...
	webSocket.onmessage = function(message){
		// 출력 area에 메시지를 표시한다.
		if (message.data == 'matrlFalse') {
			toastr.warning("재질이 잘못되었습니다.")
		}
		console.log(message);
	};
	// 서버로 메시지를 전송하는 함수
