	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">신뢰성 결과 조회(48시간)</li>
			</ol>
		</nav>
...
<script>
	...
	let menuAuth = 'qmsc3220';
	let currentHref = 'qmsc3220';
	let currentPage = $('.'+currentHref).attr('id');
	$('#'+currentPage).closest('.has-child','li').addClass('has-open has-active');
	$('#'+currentPage).closest('.menu-item').addClass('has-active');
	$(document).attr("title","신뢰성 결과 조회(48시간)");
	...
	let uploadTable = $('#uploadTable').on( 'error.dt', function ( e, settings, techNote, message ) {
	    ...
	    ajax: {
	        ...
	        data: {
		        ...
		        'shillingGubun' : function(){ return '001'; },
