	...
	<header class="page-title-bar row">
		<nav aria-label="breadcrumb" class="breadcrumb-padding">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">수입검사현황(기존)</li>
			</ol>
		</nav>
	</header>
	<!-- #main============================================================== -->
							...
							<table id="inspectionListTable004" class="table table-bordered">
								<thead class="thead-light">
									<tr>
										...
										<th rowspan="3" class="text-center" style="min-width:60px;">불량유형</th>
										<th rowspan="3" class="text-center" style="min-width:80px;">재검일</th>
										<th colspan="1" class="text-center" style="min-width:60px;" id="matrlHeaderCols004">외관</th>								
										<th colspan="8" class="text-center" style="min-width:60px;" id="matrlHeaderCols014">비고</th>
										<th colspan="3" class="text-center" style="min-width:60px;">치수(평균값)</th>
										<th colspan="5" class="text-center" style="min-width:60px;">면취<!-- (평균값) --></th>
										<th rowspan="3" class="text-center" style="min-width:60px;">내절강도<br>(평균값)</th>
										<th rowspan="3" class="text-center" style="min-width:90px;">공급업체</th>
									...
									<tr  id="matrlHeader004" name="matrlHeader004">
										<!-- <th rowspan="2" class="text-center" style="min-width:60px;">Scarch</th>
										<th rowspan="2" class="text-center" style="min-width:60px;">변색</th>
										<th rowspan="2" class="text-center" style="min-width:60px;">이물</th>
										<th rowspan="2" class="text-center" style="min-width:60px;">도금박리</th>
                ...
                <table id="exteriorMatrlPopUpTable" class="table table-bordered">
				 ...
				 <table id="sizeMatrlPopUpTable" class="table table-bordered">
						...
						<tr>
							...
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_input6_8" value="" disabled/></td>	
						</tr>
						<tr>
...
<!-- 수입검사 필름 모달 시작-->
<div class="modal fade bd-example-modal-lg" id="originFilmPopUpModal" tabindex="-1" role="dialog" aria-labelledby="originFilmPopUpModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" style="min-width:1400px;">
    <div class="modal-content">
	      <div class="modal-header" style="padding-bottom: 0px;">
	        <h5 class="modal-title" id="originMatrlPopUpLabel">필름 수입검사</h5>
	        <h5 class="modal-title mb-1" style="margin-left: 65%;">검사일 : <input type="date" style=" width:165px; border:solid 0px; border-bottom:solid 1px" id="originFilmDate"> </h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div> 
	      <div class="modal-body">
                <table id="exteriorOriginFilmPopUpTable" class="table table-bordered">
                    <thead class="thead-light">
							<tr>								
								<th style="width:20%">관리항목</th>
								<th style="width:20%" colspan="3">규격</th>
						...
						<tbody id="matrlTbody004Origin">
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem1_1" value="Scratch" disabled/></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem1_2" value="유해결점이 없을것" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem1_3"></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem1_4" /></td>
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem2_1" value="변색" disabled/></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem2_2" value="변색 없을 것" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem2_3"></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem2_4" /></td>
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem3_1" value="이물" disabled/></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem3_2" value="이물질 없을 것" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem3_3"></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem3_4" /></td>
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem4_1" value="도금박리" disabled/></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem4_2" value="구리노출 없을 것" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem4_3"></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem4_4" /></td>
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem5_1" value="권취" disabled></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem5_2" value="권취기준 1mm 이내의 정렬권취" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem5_3"></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem5_4" /></td>
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem6_1" value="도금 밀착성" disabled></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem6_2" value="4B 이상" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem6_3"></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem6_4" /></td>
						</tr>
						<tr>							
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem7_1" value="젖음성" disabled></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem7_2" value="물방울이 맺히지 않을 것" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem7_3"></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem7_4" /></td>
						</tr>
						
						
						<tr>							
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem8_1" value="" disabled></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem8_2" value="" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem8_3" disabled></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem8_4" disabled/></td>
						</tr>
						<tr>							
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem9_1" value="" disabled></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem9_2" value="" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem9_3" disabled></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem9_4" disabled/></td>
						</tr>
						<!--
						<tr>							
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem10_1" value="" disabled></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem10_2" value="" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem10_3"disabled></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem10_4" disabled/></td>
						</tr>
						<tr>							
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem11_1" value="" disabled></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem11_2" value="" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem11_3" disabled></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem11_4" disabled/></td>
						</tr>
						<tr>							
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem12_1" value="" disabled></td>
							<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem12_2" value="" disabled/></td>
							<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem12_3" disabled></select></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem12_4" disabled/></td>
						</tr>
						 -->
						 </tbody>
				</table>
				 ...
				 <table id="sizeOriginMatrlPopUpTable" class="table table-bordered">
						...
						<tr>							
							<td	rowspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input1_1" value="치수" disabled></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input1_2" value="두께(mm)" disabled/></td>
							<td	colspan="4" ><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input1_3" value="±0.015" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input1_4" disabled /></td>
							<td	colspan="2"	><input class="form-control number-float3 input1_float" style="max-width:100%" 	type="text" id="filmOld_input1_5" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input1_float" style="max-width:100%" 	type="text" id="filmOld_input1_6" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input1_float" style="max-width:100%" 	type="text" id="filmOld_input1_7" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input1_float" style="max-width:100%" 	type="text" id="filmOld_input1_8" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input1_float" style="max-width:100%" 	type="text" id="filmOld_input1_9" value="0"/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input1_10" /></td>
							
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input2_1" value="폭(mm)" disabled/></td>
							<td	colspan="4" ><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input2_2" value="±0.15" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input2_3" disabled /></td>
							<td	colspan="2"	><input class="form-control number-float3 input2_float" style="max-width:100%" 	type="text" id="filmOld_input2_4" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input2_float" style="max-width:100%" 	type="text" id="filmOld_input2_5" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input2_float" style="max-width:100%" 	type="text" id="filmOld_input2_6" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input2_float" style="max-width:100%" 	type="text" id="filmOld_input2_7" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input2_float" style="max-width:100%" 	type="text" id="filmOld_input2_8" value="0"/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input2_9" /></td>
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input3_1" value="Burr(mm)" disabled/></td>
							<td	colspan="4" ><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input3_2" value="±0.015mm ↓" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input3_3" disabled /></td>
							<td	colspan="2"	><input class="form-control number-float3 input3_float" style="max-width:100%" 	type="text" id="filmOld_input3_4" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input3_float" style="max-width:100%" 	type="text" id="filmOld_input3_5" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input3_float" style="max-width:100%" 	type="text" id="filmOld_input3_6" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input3_float" style="max-width:100%" 	type="text" id="filmOld_input3_7" value="0"/></td>
							<td	colspan="2"	><input class="form-control number-float3 input3_float" style="max-width:100%" 	type="text" id="filmOld_input3_8" value="0"/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input3_9" /></td>
						</tr>
						<tr>
							<td	rowspan="4"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_1" value="면취" disabled></td>
							<td	rowspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_2" value="두께(mm)" disabled/></td>
							<td			 	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_3" value="0.2T" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_4" value="0.3T" disabled /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_5" value="0.4T" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_6" value="0.5T" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_7" disabled/></td>
							<td	colspan="5" ><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_8" value="좌" disabled/></td>
							<td	colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_9" value="우" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input4_10" /></td>
						</tr>
						<tr>
							<td			 	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input5_1" value="200±100" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input5_2" value="300±100" disabled /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input5_3" value="350±100" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input5_4" value="" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input5_5" disabled/></td>
							<td	colspan="5" ><input class="form-control number-float3 input5_float" style="max-width:100%" 	type="number" id="filmOld_input5_6" value="0"/></td>
							<td	colspan="5"	><input class="form-control number-float3 input5_float" style="max-width:100%" 	type="number" id="filmOld_input5_7" value="0" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input5_8" /></td>
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input6_1" value="T두께" disabled/></td>
							<td	colspan="4"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input6_2" value="T+Max20" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input6_3" value="" disabled /></td>
							<td	colspan="10"><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input6_4" value="" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input6_5" value="" /></td>
							
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input7_1" value="ET두께" disabled/></td>
							<td	colspan="4"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input7_2" value="TBD" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input7_3" value="" disabled /></td>
							<td	colspan="10"><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input7_4" value="" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input7_5" value="" /></td>
						</tr>						
					
						<tr>
							<td	rowspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_1" value="내절강도" disabled></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_2" value="" disabled/></td>
							<td			 	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_3" value="0.2T" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_4" value="0.2T(H18)" disabled /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_5" value="0.2T(H14)" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_6" value="0.3T ↑" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_7" value="평균값" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_8" value="1" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_9" value="2" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_10" value="3" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_11" value="4" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_12" value="5" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_13" value="6" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_14" value="7" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_15" value="8" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_16" value="9" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_17" value="10" disabled/></td>												
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input8_18" /></td>
						</tr>
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input9_1" value="" disabled/></td>
							<td			 	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input9_2" value="7회 ↑" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input9_3" value="2회 ↑" disabled /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input9_4" value="3회 ↑" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input9_5" value="6회 ↑" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input9_6" value="" disabled/></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_7" value="0" /></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_8" value="0" /></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_9" value="0" /></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_10" value="0" /></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_11" value="0" /></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_12" value="0" /></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_13" value="0" /></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_14" value="0" /></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_15" value="0" /></td>
							<td				><input class="form-control number-float3 input9_float" style="max-width:100%" 	type="number" id="filmOld_input9_16" value="0" /></td>												
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_input9_17" /></td>
						</tr>
				</table>
	      </div>
	      <div class="modal-footer" style="padding-top: 0px;">
...
<script>
	...
	let menuAuth = 'qmsc3100';
	let currentHref = 'qmsc3100';
...
// 					); 
        ...
        drawCallback : function( settings ) {
			...
			$.each($('#inspectionListTable001').find('tr[name=matrlHeader001]').find('th'),function(index,item){
				if($(this).find('input[name=listTable004Hidden]').val() == '002' || $(this).find('input[name=listTable004Hidden]').val() == '003' || $(this).find('input[name=listTable004Hidden]').val() == '004') {
					$('#inspectionListTable001').find('tr[name=matrlHeader001]').find('th').eq(index).addClass('d-none');
				}
			});
	...
	columnVisibleFun(23, 59, inspectionListTable004);
	columnVisibleFun(68, 104, inspectionListTable004);
	 ...
	 $('#inspectionListTable004 tbody').on('click', 'tr', function () {
	        ...
	        let inWhsDate	= moment(inspectionListTable004.row(this).data().inWhsDate).format('YYYY')
    ...
    function matrlHeader004Create(){
    	...
    	$.each(managementCode, function(index,item){				
    		//if(item.etc1 == '001'){    					
    			Hd_001 += '<th rowspan="2" class="text-center" style="min-width:60px;"><input type="hidden" name="listTable004Hidden" value="'+ item.etc1 +'"><div class="'+viewArrayLength+'"></div>'+ item.baseCdNm + item.etc1 + '</th>';  	
    			viewArrayLength++;
            //}
		}); 
			...
			success: function (res) {
				...
				if (res.result == 'ok') {
					if(matrlGubunCd=="001"){
						...
						$('#originFilmPopUpModal').modal({backdrop:'static'});
						$('#originFilmPopUpModal').modal('show');
					}
	...
	function matrl003_clear() {
	  ...
	  function matrl004_clear() {
		  $('#filmOld_inspectItem1_1').val(""); 
		  	$('#filmOld_inspectItem1_2').val("");
		  	
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem1_3", "001", "");
		  	$('#filmOld_inspectItem1_4').val("");            	
		  	$('#filmOld_inspectItem2_1').val("");
		  	$('#filmOld_inspectItem2_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem2_3", "001", "");
		  	$('#filmOld_inspectItem2_4').val("");
		  	$('#filmOld_inspectItem3_1').val("");
		  	$('#filmOld_inspectItem3_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem3_3", "001", "");
		  	$('#filmOld_inspectItem3_4').val("");
		  	$('#filmOld_inspectItem4_1').val("");
		  	$('#filmOld_inspectItem4_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem4_3", "001", "");
		  	$('#filmOld_inspectItem4_4').val("");
		  	$('#filmOld_inspectItem5_1').val("");
		  	$('#filmOld_inspectItem5_2').val("");
		 	selectBoxAppend(approvalCheck, "filmOld_inspectItem5_3", "001", "");
		  	$('#filmOld_inspectItem5_4').val("");
		  	$('#filmOld_inspectItem6_1').val("");
		  	$('#filmOld_inspectItem6_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem6_3", "001", "");
		  	$('#filmOld_inspectItem6_4').val("");
		  	$('#filmOld_inspectItem7_1').val("");
		  	$('#filmOld_inspectItem7_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem7_3", "001", "");
		  	$('#filmOld_inspectItem7_4').val("");

		  	$('#filmOld_inspectItem8_1').val("");
		  	$('#filmOld_inspectItem8_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem8_3", "", "2");
		  	$('#filmOld_inspectItem8_4').val("")
		  	$('#filmOld_inspectItem9_1').val("");
		  	$('#filmOld_inspectItem9_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem9_3", "", "2");
		  	$('#filmOld_inspectItem9_4').val("")
		  	$('#filmOld_inspectItem10_1').val("");
		  	$('#filmOld_inspectItem10_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem10_3", "", "2");
		  	$('#filmOld_inspectItem10_4').val("")
		  	$('#filmOld_inspectItem11_1').val("");
		  	$('#filmOld_inspectItem11_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem11_3", "", "2");
		  	$('#filmOld_inspectItem11_4').val("")
		  	$('#filmOld_inspectItem12_1').val("");
		  	$('#filmOld_inspectItem12_2').val("");
		  	selectBoxAppend(approvalCheck, "filmOld_inspectItem12_3", "", "2");
		  	$('#filmOld_inspectItem12_4').val("")

		  	
		  	$('#filmOld_input1_1').val("");
		  	$('#filmOld_input1_2').val("");
		  	$('#filmOld_input1_3').val("");
		  	$('#filmOld_input1_4').val("0");
		  	$('#filmOld_input1_5').val("0");
		  	$('#filmOld_input1_6').val("0");
		  	$('#filmOld_input1_7').val("0");
		  	$('#filmOld_input1_8').val("0");
		  	$('#filmOld_input1_9').val("0");
		  	$('#filmOld_input1_10').val("");    	
		  	$('#filmOld_input2_1').val("");
		  	$('#filmOld_input2_2').val("");
		  	$('#filmOld_input2_3').val("0");
		  	$('#filmOld_input2_4').val("0");
		  	$('#filmOld_input2_5').val("0");
		  	$('#filmOld_input2_6').val("0");
		  	$('#filmOld_input2_7').val("0");
		  	$('#filmOld_input2_8').val("0");
		  	$('#filmOld_input2_9').val("");     	
		  	$('#filmOld_input3_1').val("");
		  	$('#filmOld_input3_2').val("");
		  	$('#filmOld_input3_3').val("0");
		  	$('#filmOld_input3_4').val("0");
		  	$('#filmOld_input3_5').val("0");
		  	$('#filmOld_input3_6').val("0");
		  	$('#filmOld_input3_7').val("0");
		  	$('#filmOld_input3_8').val("0");
		  	$('#filmOld_input3_9').val("");     	
		  	$('#filmOld_input4_1').val("");
		  	$('#filmOld_input4_2').val("");
		  	$('#filmOld_input4_3').val("");
		  	$('#filmOld_input4_4').val("");
		  	$('#filmOld_input4_5').val("");
		  	$('#filmOld_input4_6').val("");
		  	$('#filmOld_input4_7').val("");
		  
		  	$('#filmOld_input4_10').val("");      	
		  	$('#filmOld_input5_1').val("");
		  	$('#filmOld_input5_2').val("");
		  	$('#filmOld_input5_3').val("");
		  	$('#filmOld_input5_4').val("");
		  	$('#filmOld_input5_5').val("0");
		  	$('#filmOld_input5_6').val("0");
		  	$('#filmOld_input5_7').val("0");
		  	$('#filmOld_input5_8').val("");     	
		  	$('#filmOld_input6_1').val("");
		  	$('#filmOld_input6_2').val("");
		  	$('#filmOld_input6_3').val("");
		  	$('#filmOld_input6_4').val("");
		  	$('#filmOld_input6_5').val("");     	
		  	$('#filmOld_input7_1').val("");
		  	$('#filmOld_input7_2').val("");
		  	$('#filmOld_input7_3').val("");
		  	$('#filmOld_input7_4').val("");
		  	$('#filmOld_input7_5').val("");
		  	  	
		  	$('#filmOld_input8_1').val("");
		  	$('#filmOld_input8_2').val("");
		  	$('#filmOld_input8_3').val("");
		  	$('#filmOld_input8_4').val("");
		  	$('#filmOld_input8_5').val("");
		  	$('#filmOld_input8_6').val("");
		  	//$('#filmOld_input8_7').val("");
		  
		  	$('#filmOld_input8_18').val("");	            	
		  	$('#filmOld_input9_1').val("");
		  	$('#filmOld_input9_2').val("");
		  	$('#filmOld_input9_3').val("");
		  	$('#filmOld_input9_4').val("");
		  	$('#filmOld_input9_5').val("");
		  	$('#filmOld_input9_6').val("0");
		  	$('#filmOld_input9_7').val("0");
		  	$('#filmOld_input9_8').val("0");
		  	$('#filmOld_input9_9').val("0");
		  	$('#filmOld_input9_10').val("0");
		  	$('#filmOld_input9_11').val("0");
		  	$('#filmOld_input9_12').val("0");
		  	$('#filmOld_input9_13').val("0");
		  	$('#filmOld_input9_14').val("0");
		  	$('#filmOld_input9_15').val("0");
		  	$('#filmOld_input9_16').val("0");
		  	$('#filmOld_input9_17').val("");
...
//		matrlData.depth 폭
	...
	function matrl004_enable_list(data,data2,data3, matrlData){
		...
		$('#originFilmDate').val(data3[0].inspectDate);
		...
		$.each(data3, function(index, item){
			if(item.matrlGubunCd == "004"){
				inspectHtml += '<tr>';
				inspectHtml += '<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem' + (index + 1) + '_1" value="'+item.managementNm+'" disabled/>';
				inspectHtml += '<input  	type="hidden" id="filmOld_inspectItem' + (index + 1) + '" value="'+item.managementCd+'"/> </td>';
				inspectHtml += '<td colspan="3"	><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem' + (index + 1) + '_2" value="'+item.modelNm+'" disabled/></td>';
				inspectHtml += '<td				><select class="custom-select custom-select-sm" id="filmOld_inspectItem' + (index + 1) + '_3"></select></td>';
				inspectHtml += '<td				><input class="form-control" style="max-width:100%" 	type="text" id="filmOld_inspectItem' + (index + 1) + '_4" value="'+item.inspectEtc+'"/></td>';			    
				inspectHtml += '</tr>';                                                         
				matrl001_list_idx++;                                                  
			}
		});
		$('#matrlTbody004Origin').html(inspectHtml);
		$.each(data3, function(index, item){
			selectBoxAppend(approvalCheck, "filmOld_inspectItem"+(index+1)+"_3", ""+ item.resultCd +"", "");			
		});		

		$('#filmOld_input1_1').val(data[11][0]);
		$('#filmOld_input1_2').val(data[11][1]);
		$('#filmOld_input1_3').val(data[11][2] + " " + gongcha(data[11][3],data[11][4]));
		$('#filmOld_input2_1').val(data[11][5]);
		$('#filmOld_input2_2').val(data[11][6] + " " + gongcha(data[11][7],data[11][8]));
		$('#filmOld_input3_1').val(data[11][9]);
		$('#filmOld_input3_2').val(data[11][10]);
		
		$('#filmOld_input4_1').val(data[12][0]);
		$('#filmOld_input4_2').val(data[12][1]);
		$('#filmOld_input4_3').val(data[12][2]);
		$('#filmOld_input4_4').val(data[12][3]);
		$('#filmOld_input4_5').val(data[12][4]);
		$('#filmOld_input4_6').val(data[12][5]);		            	
		$('#filmOld_input5_1').val(data[12][8]);
		$('#filmOld_input5_2').val(data[12][9]);
		$('#filmOld_input5_3').val(data[12][10]);
		$('#filmOld_input5_4').val(data[12][11]);
		// $('#filmOld_input5_5').val(data[12][4]);
		
		$('#filmOld_input6_1').val(data[12][14]);
		$('#filmOld_input6_2').val(data[12][15]);
		
		$('#filmOld_input7_1').val(data[12][18]);
		$('#filmOld_input7_2').val(data[12][19]);
		
		$('#filmOld_input8_1').val(data[13][0]);
		$('#filmOld_input8_2').val(data[13][1]);
		$('#filmOld_input8_3').val(data[13][2]);
		$('#filmOld_input8_4').val(data[13][3]);
		$('#filmOld_input8_5').val(data[13][4]);
		$('#filmOld_input8_6').val(data[13][5]);
		
		$('#filmOld_input9_1').val(data[13][1]);
		$('#filmOld_input9_2').val(data[13][8]);
		$('#filmOld_input9_3').val(data[13][9]);
		$('#filmOld_input9_4').val(data[13][10]);
		$('#filmOld_input9_5').val(data[13][11]);
		


		
		$('#filmOld_input1_4').val(data2[0][3]);
		$('#filmOld_input1_5').val(data2[0][4]);
		$('#filmOld_input1_6').val(data2[0][5]);
		$('#filmOld_input1_7').val(data2[0][6]);
		$('#filmOld_input1_8').val(data2[0][7]);
		$('#filmOld_input1_9').val(data2[0][8]);
		$('#filmOld_input1_10').val(data2[0][9]); 
		
		$('#filmOld_input2_3').val(data2[1][2]);
		$('#filmOld_input2_4').val(data2[1][3]);
		$('#filmOld_input2_5').val(data2[1][4]);
		$('#filmOld_input2_6').val(data2[1][5]);
		$('#filmOld_input2_7').val(data2[1][6]);
		$('#filmOld_input2_8').val(data2[1][7]);
		$('#filmOld_input2_9').val(data2[1][8]);     	
		
		$('#filmOld_input3_3').val(data2[2][2]);
		$('#filmOld_input3_4').val(data2[2][3]);
		$('#filmOld_input3_5').val(data2[2][4]);
		$('#filmOld_input3_6').val(data2[2][5]);
		$('#filmOld_input3_7').val(data2[2][6]);
		$('#filmOld_input3_8').val(data2[2][7]);
		$('#filmOld_input3_9').val(data2[2][8]);     	
		
		$('#filmOld_input4_10').val(data2[3][9]); 
		
		$('#filmOld_input5_5').val(data2[4][4]);
		$('#filmOld_input5_6').val(data2[4][5]);
		$('#filmOld_input5_7').val(data2[4][6]);
		$('#filmOld_input5_8').val(data2[4][7]);     
		
		$('#filmOld_input6_4').val(data2[5][3]);
		$('#filmOld_input6_5').val(data2[5][4]); 
		
		$('#filmOld_input7_4').val(data2[6][3]);
		$('#filmOld_input7_5').val(data2[6][4]);     	
		
		$('#filmOld_input8_18').val(data2[7][17]);			            	
		
		$('#filmOld_input9_6').val(data2[8][5]);
		$('#filmOld_input9_7').val(data2[8][6]);
		$('#filmOld_input9_8').val(data2[8][7]);
		$('#filmOld_input9_9').val(data2[8][8]);
		$('#filmOld_input9_10').val(data2[8][9]);
		$('#filmOld_input9_11').val(data2[8][10]);
		$('#filmOld_input9_12').val(data2[8][11]);
		$('#filmOld_input9_13').val(data2[8][12]);
		$('#filmOld_input9_14').val(data2[8][13]);
		$('#filmOld_input9_15').val(data2[8][14]);
		$('#filmOld_input9_16').val(data2[8][15]);
		$('#filmOld_input9_17').val(data2[8][16]);
		$('.modal-body').find('input').attr('disabled', true);
		$('.modal-body').find('select').attr('disabled', true);
