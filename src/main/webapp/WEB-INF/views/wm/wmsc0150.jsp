...
<!-- 						<div class="row p-1" id="ordDateDiv" >
						...
						<button type="button" class="btn btn-primary float-right mr-5 ml-2 touch6" id="btnWorkOrdRetv" style="margin-top:3px;">전체조회</button> 
	    ...
	    <div class="modal-dialog modal-lg" role="document" style="width: 85vh;">
	        <div class="modal-content" style="width: 60%; margin-left: 30%; margin-top: 20%;" id="workerChangeContent">
	            ...
	            <div class="modal-body">
	            	<br>
					<div class="mb-2 row">
						<label class="input-label-sm touch6">LOT를 추가 하시겠습니까?</label>
...
// 	faultyHdCreate6();
    ...
    let outputCardTable = $('#outputCardTable').DataTable({
		...
		pageLength: 99999,
        ajax: {
			url: '<c:url value="/qm/reShipInspSelectList"/>',
			type: 'GET',
			async: false,
			data: {
				'menuAuth'			: 	menuAuth,
			...
			complete:function() {
				//출하불량 TB 상세조회
 		        $.ajax({
 		            ...
 		            data: {
 		            	'menuAuth'	 	: 		menuAuth,
 		            	'workOrdNo'		:		function(){return workOrdNo;},		//작업지시
	...
	$('#btnSave').on('click', function() {
       ...
       /*  if (parseInt(removeCommas($('#appearOutputCnt').val())) > 99999) {
        ...
        //if (trueFalse) {
    		...
    		url = '<c:url value="/qm/reShipInspectUpdate"/>';
 ...
 */
		$.ajax({
			url: '<c:url value="qm/getAddLotNo_Fn2"/>',
            type: 'POST',
            data: {		      
	            'trayNo'			: 	labelLotNoSeq,     
            	'reInspStatus'		:	'002',            	
