		...
		<div class="row table-wrap-hid">
			...
			<div class="left-list" id="left-list">
				...
				<div id="tab3View"  class="d-none">
					<div class="thirdTable table-responsive" style="padding-bottom: 5px;">
...
<script>
	...
	let menuAuth = 'wmsc1230';
	let currentHref = 'wmsc1230';
    ...
    function monthProductPresentTableFunc(){
        ...
        let tempTableData = $('#productionPlanMainTable').on( 'error.dt', function ( e, settings, techNote, message ) {
        		...
        		ajax: {
                    url: '<c:url value="/wm/monthProductionPlanSumListMTP"/>',
                    type: 'POST',
                    data: {
                    	'menuAuth'		:		menuAuth,
        		...
        		/* 		if($('.day27').text()==""){
        			...
        			$.ajax({
                		url: '<c:url value="wm/monthProductionPlanSummaryDataMTP"/>',
            			type: 'POST',  
            			async: false,
            			data: {
            				'menuAuth'	:	menuAuth,
    ...
    function monthProductPresentTableFunc2(){
        ...
        let tempTableData = $('#productionPlanGijongTable').on( 'error.dt', function ( e, settings, techNote, message ) {
        		...
        		ajax: {
                    url: '<c:url value="/wm/monthProductionPlanGijongListMTP"/>',
                    type: 'POST',
                    data: {
                    	'menuAuth'		:		menuAuth,
                    	'fpDate'		:		function(){return inWhsDateCal.replace(/-/g,"");},                    	
    ...
    function monthProductPresentTableFunc3(){
        ...
        let tempTableData = $('#productionPlanDtlTable').on( 'error.dt', function ( e, settings, techNote, message ) {
        		...
        		ajax: {
                    url: '<c:url value="/wm/monthProductionPlanDtlListMTP"/>',
                    type: 'POST',
                    data: {
                    	'menuAuth'		:		menuAuth,
                    	'fpDate'		:		function(){return inWhsDateCal.replace(/-/g,"");},     
    ...
    function monthProductPresentTableFunc4(){
        ...
        let tempTableData = $('#gijongDailyTable').on( 'error.dt', function ( e, settings, techNote, message ) {
        		...
        		ajax: {
                    url: '<c:url value="/wm/gijongDailyPlan1MTP"/>',
                    type: 'POST',
                    data: {
                    	'menuAuth'		:		menuAuth,
                    	'fpDate'		:		function(){return inWhsDateCal.replace(/-/g,"");},
    ...
    function monthProductPresentTableFunc5(){
        ...
        let tempTableData = $('#gijongDailyTable2').on( 'error.dt', function ( e, settings, techNote, message ) {
        		...
        		ajax: {
                    url: '<c:url value="/wm/gijongDailyPlan2MTP"/>',
                    type: 'POST',
                    data: {
                    	'menuAuth'		:		menuAuth,
                    	'fpDate'		:		function(){return inWhsDateCal.replace(/-/g,"");},
    ...
    $('#btnTheory').on('click', function() {
    	$.ajax({
			url: '<c:url value="wm/createMonthSumDataReadMTP"/>',
			type: 'POST',  
			async: false,
			data: {
				'menuAuth'	:	menuAuth,
    ...
    $('#btnSave').on('click', function() {
    	$.ajax({
			url: '<c:url value="wm/createMonthSumDataMTP"/>',
			type: 'POST',  
			async: false,
			data: {
				'menuAuth'	:	menuAuth,
   ...
   $('#btnDailyInvenReal').on('click', function() {
 	...
 	let dailyInvenTable =$('#dailyInvenTable').on( 'error.dt', function ( e, settings, techNote, message ) {
			...
			pageLength : 20,
			ajax : {
				url : '<c:url value="wm/dailyInvenListMTP"/>',
				type : 'GET',
				data : {					
 	...
 	$('#modelRetv').on('click', function () {	
 		...
 		$.ajax({
			url: '<c:url value="wm/dailyInvenReadMTP"/>',
			type: 'POST',  
			async: false,
			data: {
				'menuAuth'	:	menuAuth,
	...
	$('#btnSaveDailyInven').on('click', function () {
		...
		if(check){
			$('#my-spinner').show();
			$.ajax({
	            url: '<c:url value="/wm/dailyInvenCreateMTP"/>',
	            type: 'POST',
	...
	$('#btnSaveDailyInven2').on('click', function () {
		...
		$('#my-spinner').show();
		$.ajax({
            url: '<c:url value="/wm/dailyInvenCreateRealMTP"/>',
            type: 'POST',
            data: {
	...
	$('#rowAdd').on('click', function() {		
	 ...
	 $(document).on('dblclick','#productionPlanMainTable tbody tr td',function(){
	    ...
	    $('#btnMemoSave').on('click',function(){    
	   		...
	   		$.ajax({
		   		url: '<c:url value="wm/createMonthProductionMemoMTP"/>',
				type: 'POST',
				async: false,
				data: {
					'menuAuth'	:	menuAuth,					
	    ...
	    $('#btnCreateStock').on('click',function(){    
	   		...
	   		$.ajax({
		   		url: '<c:url value="wm/createNextMonthStockMTP"/>',
				type: 'POST',
				async: false,
				data: {
					'menuAuth'	:	menuAuth,			
