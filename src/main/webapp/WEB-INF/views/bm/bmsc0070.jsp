				...
				<div id="matrl001" class="d-none">
					...
					<table  class="table table-bordered">
						...
						<tr>
							...
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem1_2" value="유해결점이 없을것" disabled/></td>
						...
						<tr>
							...
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem2_2" value="변색 없을 것" disabled/></td>
						...
						<tr>
							...
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem3_2" value="이물질 없을 것" disabled/></td>
						...
						<tr>
							...
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem4_2" value="구리노출 없을 것" disabled/></td>
						...
						<tr>
							...
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem5_2" value="권취기준 1mm 이내의 정렬권취" disabled/></td>
						...
						<tr>
							...
							<td				><select class="custom-select custom-select-sm" id="matrl001_seletBox001" style="min-width:100%"></select></td>
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem6_1" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem6_2" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem6_3" /></td>
						</tr>
						<tr>
							<td align=center>7</td>
							<td				><select class="custom-select custom-select-sm" id="matrl001_seletBox002" style="min-width:100%"></select></td>
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem7_1" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem7_2" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem7_3" /></td>
						</tr>
						<tr>
							<td align=center>8</td>
							<td				><select class="custom-select custom-select-sm" id="matrl001_seletBox003" style="min-width:100%"></select></td>
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem8_1" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem8_2" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem8_3" /></td>
						</tr>
						<tr>
							<td align=center>9</td>
							<td				><select class="custom-select custom-select-sm" id="matrl001_seletBox004" style="min-width:100%"></select></td>
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem9_1" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem9_2" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem9_3" /></td>
						</tr>
						<tr>
							<td align=center>10</td>
							<td				><select class="custom-select custom-select-sm" id="matrl001_seletBox005" style="min-width:100%"></select></td>
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem10_1" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem10_2" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem10_3" /></td>
						</tr>
						<tr>
							...
							<td colspan="4"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem11_3" value="" disabled/></td>
						...
						<tr>
							...
							<td colspan="4"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem11_7" value="" disabled/></td>
						...
						<tr>
							...
							<td colspan="4"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem11_11" value="0.015mm 이하" disabled/></td>
						...
						<tr>
							...
							<td	rowspan="4"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_1" value="면취" disabled></td>
							...
							<td 			><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_6" value="0.5T" disabled/></td>
						...
						<tr>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_9" value="200 ±100" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_10" value="300 ±100" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_11" value="350 ±100" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_12" disabled/></td>
						...
						<tr>
							<td 			><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_15" value="T두께" disabled/></td>
							<td colspan="4"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_16" value="T+Max20" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_17" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_18" /></td>
						</tr>
						<tr>
							<td 			><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_19" value="ET두께" disabled/></td>
							<td colspan="4"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_20" value="TBD" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_21" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem12_22" /></td>
						</tr>
						<tr>
							...
							<td 			><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem13_4" value="0.2T (H18)" disabled/></td>
							<td 			><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem13_5" value="0.2T (H14)" disabled/></td>
							<td 			><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem13_6" value="0.3T ↑" disabled/></td>
						...
						<tr>
							<td 			><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem13_9" value="7회  ↑" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem13_10" value="2회  ↑" disabled>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem13_11" value="3회  ↑" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem13_12" value="6회  ↑" disabled/></td>
						...
						<tr>
							...
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem14_1" value="도금 밀창성" disabled/></td>
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem14_2" value="4B 이상" disabled/></td>
						...
						<tr>
							...
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem15_1" value="젖음성" disabled/></td>
							<td colspan="5"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem15_2" value="물방울이 맺히지 않을 것" disabled/></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem15_3" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl001_inspectItem15_4" /></td>
						</tr>
					</table>
				</div>
				...
				<div id="matrl002" class="d-none">
					...
					<table  class="table table-bordered">
						...
						<tr>
							...
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem1_2" value="유해결점이 없을것" disabled/></td>
						...
						<tr>
							...
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem2_2" value="얼룩이 없을것" disabled/></td>
						...
						<tr>
							...
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem3_2" value="환경관리물질 규격에 만족할것" disabled/></td>
						...
						<tr>
							<td align=center>4</td>
							<td				><select class="custom-select custom-select-sm" id="matrl002_seletBox001" style="min-width:100%"></select></td>
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem4_1" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem4_2" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem4_3" /></td>
						</tr>
						<tr>
							<td align=center>5</td>
							<td				><select class="custom-select custom-select-sm" id="matrl002_seletBox002" style="min-width:100%"></select></td>
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem5_1" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem5_2" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem5_3" /></td>
						</tr>
						<tr>
							...
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem6_3" value="" disabled/></td>
						...
						<tr>
							...
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl002_inspectItem6_7" value="" disabled/></td>
				...
				<div id="matrl003" class="d-none">
					...
					<table  class="table table-bordered">
						...
						<tr>
							...
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem1_2" value="유해결점이 없을것" disabled/></td>
						...
						<tr>
							...
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem2_2" value="얼룩이 없을것" disabled/></td>
						...
						<tr>
							...
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem3_2" value="환경관리물질 규격에 만족할것" disabled/></td>
						...
						<tr>
							<td align=center>4</td>
							<td				><select class="custom-select custom-select-sm" id="matrl003_seletBox001" style="min-width:100%"></select></td>
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem4_1" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem4_2" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem4_3" /></td>
						</tr>
						<tr>
							<td align=center>5</td>
							<td				><select class="custom-select custom-select-sm" id="matrl003_seletBox002" style="min-width:100%"></select></td>
							<td colspan="2"	><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem5_1" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem5_2" /></td>
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem5_3" /></td>
						</tr>
						<tr>
							<td align=center>6</td>
							...
							<td				><input class="form-control" style="max-width:100%" 	type="text" id="matrl003_inspectItem6_3" value="" disabled/></td>
...
<script>
	...
	function readInspectInfo() {
		//자재 조회
        $.ajax({
           url: '<c:url value="/bm/inspectInfoAdmRead"/>',
           type: 'GET',
           data: {
           	'menuAuth'	 	: 		menuAuth,
	...
	$('#001btnSave').on('click', function () {
		if ( $("#matrl001_seletBox001 option:selected").val() == "" && $.trim($('#matrl001_inspectItem6_1').val()) ) {
			toastr.warning('관리항목을 선택해주세요!');
			$('#matrl001_seletBox001').focus();
			return false;
		}
		if ( $("#matrl001_seletBox001 option:selected").val() != "" && !$.trim($('#matrl001_inspectItem6_1').val()) ) {
			toastr.warning('규격을 입력해주세요!');
			$('#matrl001_inspectItem6_1').focus();
			return false;
		}
		if ( $("#matrl001_seletBox002 option:selected").val() == "" && $.trim($('#matrl001_inspectItem7_1').val()) ) {
			toastr.warning('관리항목을 선택해주세요!');
			$('#matrl001_seletBox002').focus();
			return false;
		}
		if ( $("#matrl001_seletBox002 option:selected").val() != "" && !$.trim($('#matrl001_inspectItem7_1').val()) ) {
			toastr.warning('규격을 입력해주세요!');
			$('#matrl001_inspectItem7_1').focus();
			return false;
		}
		if ( $("#matrl001_seletBox003 option:selected").val() == "" && $.trim($('#matrl001_inspectItem8_1').val()) ) {
			toastr.warning('관리항목을 선택해주세요!');
			$('#matrl001_seletBox003').focus();
			return false;
		}
		if ( $("#matrl001_seletBox003 option:selected").val() != "" && !$.trim($('#matrl001_inspectItem8_1').val()) ) {
			toastr.warning('규격을 입력해주세요!');
			$('#matrl001_inspectItem8_1').focus();
			return false;
		}
		if ( $("#matrl001_seletBox004 option:selected").val() == "" && $.trim($('#matrl001_inspectItem9_1').val()) ) {
			toastr.warning('관리항목을 선택해주세요!');
			$('#matrl001_seletBox004').focus();
			return false;
		}
		
		if ( $("#matrl001_seletBox004 option:selected").val() != "" && !$.trim($('#matrl001_inspectItem9_1').val()) ) {
			toastr.warning('규격을 입력해주세요!');
			$('#matrl001_inspectItem9_1').focus();
			return false;
		}
		if ( $("#matrl001_seletBox005 option:selected").val() == "" && $.trim($('#matrl001_inspectItem10_1').val()) ) {
			toastr.warning('관리항목을 선택해주세요!');
			$('#matrl001_seletBox005').focus();
			return false;
		}
		
		if ( $("#matrl001_seletBox005 option:selected").val() != "" && !$.trim($('#matrl001_inspectItem10_1').val()) ) {
			toastr.warning('규격을 입력해주세요!');
			$('#matrl001_inspectItem10_1').focus();
			return false;
		}
			...
			inspectItem12 += replaceSlash($('#matrl001_inspectItem12_21').val()) + "/" + replaceSlash($('#matrl001_inspectItem12_22').val());
		...
		if (sideView == 'create') {
			url = '<c:url value="/bm/inspectInfoAdmCreate"/>';
		} else if (sideView == 'edit'){
			url = '<c:url value="/bm/inspectInfoAdmUpdate"/>';
		}
	...
	$('#002btnSave').on('click', function () {
		...
		if ( $("#matrl002_seletBox001 option:selected").val() == "" && $.trim($('#matrl002_inspectItem4_1').val()) ) {
			toastr.warning('관리항목을 선택해주세요!');
			$('#matrl002_seletBox001').focus();
			return false;
		}
		if ( $("#matrl002_seletBox001 option:selected").val() != "" && !$.trim($('#matrl002_inspectItem4_1').val()) ) {
			toastr.warning('규격을 입력해주세요!');
			$('#matrl002_inspectItem4_1').focus();
			return false;
		}
		if ( $("#matrl002_seletBox002 option:selected").val() == "" && $.trim($('#matrl002_inspectItem5_1').val()) ) {
			toastr.warning('관리항목을 선택해주세요!');
			$('#matrl002_seletBox002').focus();
			return false;
		}
		if ( $("#matrl002_seletBox002 option:selected").val() != "" && !$.trim($('#matrl002_inspectItem5_1').val()) ) {
			toastr.warning('규격을 입력해주세요!');
			$('#matrl002_inspectItem5_1').focus();
			return false;
		}
	...
	$('#003btnSave').on('click', function () {
		...
		if ( $("#matrl003_seletBox001 option:selected").val() == "" && $.trim($('#matrl003_inspectItem4_1').val()) ) {
			toastr.warning('관리항목을 선택해주세요!');
			$('#matrl003_seletBox001').focus();
			return false;
		}
		if ( $("#matrl003_seletBox001 option:selected").val() != "" && !$.trim($('#matrl003_inspectItem4_1').val()) ) {
			toastr.warning('규격을 입력해주세요!');
			$('#matrl003_inspectItem4_1').focus();
			return false;
		}
		if ( $("#matrl003_seletBox002 option:selected").val() == "" && $.trim($('#matrl003_inspectItem5_1').val()) ) {
			toastr.warning('관리항목을 선택해주세요!');
			$('#matrl003_seletBox002').focus();
			return false;
		}
		if ( $("#matrl003_seletBox002 option:selected").val() != "" && !$.trim($('#matrl003_inspectItem5_1').val()) ) {
			toastr.warning('규격을 입력해주세요!');
			$('#matrl003_inspectItem5_1').focus();
			return false;
		}
	...
	function matrl001_clear() {
		...
		$('#matrl001_inspectItem12_17').val("");
		$('#matrl001_inspectItem12_18').val("");
