          ...
          <div class="container-fluid" id="main">
              <div class="row table-wrap-hid">	
                  ...
                  <div class="left-list left-60" id="left-60" style="width:25%;">
	                ...
	                <div class="right-list right-40" id="myrSidenav" style="width:50%;">
		                ...
		                <div class="card-body col-sm-12">		                
							...
							<table class="table table-bordered">
								...
								<tr>
									...
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeWpLeftCond" name="wpLeftCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeWpLeftAlwncePlus" name="wpLeftAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeWpLeftAlwnceMinus" name="wpLeftAlwnceMinus"></td>
								</tr>
								<tr>
								<tr>
									<th>Welding Part(우)</th>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeWpRightCond" name="wpRightCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeWpRightAlwncePlus" name="wpRightAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeWpRightAlwnceMinus" name="wpRightAlwnceMinus"></td>
								</tr>
								<tr>
									<th>Pitch(좌)</th>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePitchLeftCond" name="pitchLeftCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePitchLeftAlwncePlus" name="pitchLeftAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePitchLeftAlwnceMinus" name="pitchLeftAlwnceMinus"></td>
								</tr>
								<tr>
									<th>Pitch(우)</th>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePitchRightCond" name="pitchRightCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePitchRightAlwncePlus" name="pitchRightAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePitchRightAlwnceMinus" name="pitchRightAlwnceMinus"></td>
								</tr>
								<tr>
									<th>P.P Film 날개(좌)</th>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfWingLeftCond" name="ppfWingLeftCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfWingLeftAlwncePlus" name="ppfWingLeftAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfWingLeftAlwnceMinus" name="ppfWingLeftAlwnceMinus"></td>
								</tr>
								<tr>
									<th>P.P Film 날개(우)</th>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfWingRightCond" name="ppfWingRightCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfWingRightAlwncePlus" name="ppfWingRightAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfWingRightAlwnceMinus" name="ppfWingRightAlwnceMinus"></td>
								</tr>
								<tr>
									<th>P.P File 폭(좌)	</th>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfDepthLeftCond" name="ppfDepthLeftCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfDepthLeftAlwncePlus" name="ppfDepthLeftAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfDepthLeftAlwnceMinus" name="ppfDepthLeftAlwnceMinus"></td>
								</tr>
								<tr>
									<th>P.P File 폭(우)	</th>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfDepthRightCond" name="ppfDepthRightCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfDepthRightAlwncePlus" name="ppfDepthRightAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizePpfDepthRightAlwnceMinus" name="ppfDepthRightAlwnceMinus"></td>
								</tr>
								<tr>
									<th>Film</th>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeFilmCond" name="filmCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeFilmAlwncePlus" name="filmAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeFilmAlwnceMinus" name="filmAlwnceMinus"></td>
								</tr>
								<tr>
									<th>Metal(폭)</th>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeMetalDepthCond" name="metalDepthCond"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeMetalDepthAlwncePlus" name="metalDepthAlwncePlus"></td>
									<td><input style="max-width:100%;" maxlength="6" min="-1000" max="1000" type="number" step="0.1" class="form-control number-float1" id="sizeMetalDepthAlwnceMinus" name="metalDepthAlwnceMinus"></td>
								</tr>
								<tr>
									<th>Metal(두께)	</th>
								...
								<tr class="d-none" id="golHiddenYn">
									<th>Gap of Layer</th>
			...
			//치수
		        ...
		        $.ajax({
		            ...
		            success: function (res) {
						...
						$('#sizeForm input[name="burrAlwnceMinus"]').val(data.burrAlwnceMinus);
						$('#sizeForm input[name="gapOfLayerCond"]').val(data.gapOfLayerCond);
						$('#sizeForm input[name="gapOfLayerPlus"]').val(data.gapOfLayerPlus);
						$('#sizeForm input[name="gapOfLayerMinus"]').val(data.gapOfLayerMinus);
    ...
    $('#sizeBtnSave').on('click', function() {
		...
		$.ajax({
            ...
            data: {
            	...
            	'metalThicknessCond'		: 		$('#sizeForm input[name=metalThicknessCond]').val(),
            	'metalThicknessAlwncePlus'	: 		$('#sizeForm input[name=metalThicknessAlwncePlus]').val(),
            	'metalThicknessAlwnceMinus'	: 		$('#sizeForm input[name=metalThicknessAlwnceMinus]').val(),
            	'thCenterCond'				: 		$('#sizeForm input[name=thCenterCond]').val(),
            	'thCenterAlwncePlus'		: 		$('#sizeForm input[name=thCenterAlwncePlus]').val(),
            	'thCenterAlwnceMinus'		: 		$('#sizeForm input[name=thCenterAlwnceMinus]').val(),
            	'thEdgeCond'				: 		$('#sizeForm input[name=thEdgeCond]').val(),
            	'thEdgeAlwncePlus'			: 		$('#sizeForm input[name=thEdgeAlwncePlus]').val(),
            	'thEdgeAlwnceMinus'			: 		$('#sizeForm input[name=thEdgeAlwnceMinus]').val(),
            	'burrCond'					: 		$('#sizeForm input[name=burrCond]').val(),
            	'burrAlwncePlus'			: 		$('#sizeForm input[name=burrAlwncePlus]').val(),
            	'burrAlwnceMinus'			: 		$('#sizeForm input[name=burrAlwnceMinus]').val(),
            	'gapOfLayerCond'			: 		$('#sizeForm input[name=gapOfLayerCond]').val(),
            	'gapOfLayerPlus'			: 		$('#sizeForm input[name=gapOfLayerPlus]').val(),
            	'gapOfLayerMinus'			: 		$('#sizeForm input[name=gapOfLayerMinus]').val(),
