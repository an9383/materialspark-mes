...
@Data
public class EquipCondPressureAdmVo {
	
	private String menuAuth;            //메뉴권한
	private String pressureCondCd;      //압력조건코드
	private String pressureCondNm;      //압력조건명
	...
	private String push1Cond;           //푸셔1차조건
	private String push1AlwncePlus;     //푸셔1차공차최대값
	private String push1AlwnceMinus;    //푸셔1차공차최저값.
	...
	//private String coolCond;			//냉각 조건			-	7.31 추가		- 10. 15 삭제
	//private String coolAlwncePlus;	//냉각공차 최대값		-	7.31 추가		- 10. 15 삭제
	//private String coolAlwnceMinus;	//냉각공차 최저값		- 	7.31 추가		- 10. 15 삭제
