...
@Repository
public class MonthProductionPlanMTP2DAOImpl implements MonthProductionPlanMTP2DAO{
	
	@Inject
	private SqlSession session;
	
	private static String namespace = "mes.mappers.wm.monthProductionPlanMTP2Mapper";
