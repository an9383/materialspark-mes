...
@Repository
public class MonthProductionPlanMTPDAOImpl implements MonthProductionPlanMTPDAO{
	
	@Inject
	private SqlSession session;
	
	private static String namespace = "mes.mappers.wm.monthProductionPlanMTPMapper";
	...
	public List<MonthProductionPlanVo> performanceAginstPlanMonth(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		return session.selectList(namespace + ".performanceAginstPlanMonth", monthProductionPlanVo);
	}
	...
	public List<MonthProductionPlanVo> performanceAginstPlanTotal(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		return session.selectList(namespace + ".performanceAginstPlanTotal", monthProductionPlanVo);
	}
	
	//매출계획대비실적 입력
	@Override
	public void createPerformanceAgainstPlan(List<MonthProductionPlanVo> monthProductionPlanVo) throws Exception{
		session.insert(namespace + ".createPerformanceAgainstPlan", monthProductionPlanVo);
	}
	...
	public List<MonthProductionPlanVo> readPerformanceAgainstPlan(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		return session.selectList(namespace + ".readPerformanceAgainstPlan", monthProductionPlanVo);
	}
	
	//매출계획대비실적 삭제
	@Override
	public void deletePerformanceAgainstPlan(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		session.delete(namespace + ".deletePerformanceAgainstPlan", monthProductionPlanVo);
	}
