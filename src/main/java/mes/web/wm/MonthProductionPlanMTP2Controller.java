...
import mes.service.wm.MonthProductionPlanMTP2Service;
import mes.service.wm.WorkOrderPlanService;
import mes.web.ut.DateUtil;
import mes.web.ut.Utils;

@Controller
public class MonthProductionPlanMTP2Controller {
	...
	@Inject
	private MonthProductionPlanMTP2Service monthProductionPlanService;
	...
	private static final Logger logger = LoggerFactory.getLogger(MonthProductionPlanMTP2Controller.class);

	//생산관리 - SLD 월별 FP
	@RequestMapping(value = "/wmsc2210", method = RequestMethod.GET)
	public String wmsc2210GET(Locale locale, Model model) throws Exception {

		logger.info("SLD 월별 FP 메인");
		SystemCommonCodeVo systemCommonCodeVo = new SystemCommonCodeVo();
		EquipCodeAdmVo equipCodeAdmVo = new EquipCodeAdmVo();
		equipCodeAdmVo.setEtc1("2222");
		List<EquipCodeAdmVo> equipCodeAdmList = equipCodeAdmService.listEquipMTP2(equipCodeAdmVo);
	...
	//생산관리 - SLD 월별 FP
	@RequestMapping(value = "/wmsc2220", method = RequestMethod.GET)
	public String wmsc2220GET(Locale locale, Model model) throws Exception {
	...
	//생산관리 - SLD 월별 FP
	@RequestMapping(value = "/wmsc2230", method = RequestMethod.GET)
	public String wmsc2230GET(Locale locale, Model model) throws Exception {
	...
	@RequestMapping(value = "/wm/checkCompleteYnMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> checkCompleteYnMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/checkJobChangeMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> checkJobChangeMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/updateCompleteYnModifyMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> updateCompleteYnModifyMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/updateCompleteYnMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> updateCompleteYnMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/jobChangeModalMTP2", method = RequestMethod.GET)
	public @ResponseBody Map<String, Object> jobChangeModalMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/jobChangeGoodsModalMTP2", method = RequestMethod.GET)
	public @ResponseBody Map<String, Object> jobChangeGoodsModalMTP2(GoodsCodeAdmVo goodsCodeAdmVo) throws Exception {
	...
	@RequestMapping(value = "/wm/readMonthPlanBodySLDMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> readMonthPlanBodySLDMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//생산관리/SLD 월별 FP - DataTable Data(List) 생성
	@RequestMapping(value = "/wm/readMonthPlanBodySLDModifyMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> readMonthPlanBodySLDModifyMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//생산관리-생산계획 등록&수정 처리
	@RequestMapping(value = "/wm/insertMonthProductionPlanMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> insertMonthProductionPlanMTP2(@RequestBody List<Map<String, Object>> dataList) throws Exception {
	...
	//생산관리-생산계획 잡체인지 등록
	@RequestMapping(value = "/wm/insertMonthProductionPlanJobChangeMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> insertMonthProductionPlanJobChangeMTP2(@RequestBody List<Map<String, Object>> dataList) throws Exception {
		...
		try {
			...
			for (Map<String, Object> m : dataList) {				
				...
				//monthProductionPlanVo2.setPlanCnt(Double.toString((((Double.parseDouble(opTime) * 60 * 60) * (Integer.parseInt(equipCodeAdmList.get(0).getEquipCapa())) * Double.parseDouble(readVo.getYeild1()) * Double.parseDouble(readVo.getYeild2()))) / Double.parseDouble(tecTime)) );
	...
	//생산관리 - 월별 FP 작업자 조회
	@RequestMapping(value = "/wm/monthProductionManMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> monthProductionManMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//생산관리 - 월별 FP 작업자 등록
	@RequestMapping(value = "/wm/createManMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> createManMTP2(@RequestBody List<Map<String, Object>> dataList) throws Exception {
	...
	@RequestMapping(value = "/wm/monthProductionPlanSumListMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> monthProductionPlanSumListMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/monthProductionPlanGijongListMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> monthProductionPlanGijongListMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/monthProductionPlanDtlListMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> monthProductionPlanDtlListMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/monthProductionPlanSummaryDataMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> monthProductionPlanSummaryDataMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//생산관리 - SLD 월별 FP 목표등록
	@RequestMapping(value = "/wm/createMonthSumDataMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> createMonthSumDataMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/createMonthSumDataReadMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> createMonthSumDataReadMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/monthProductionPlanYeildReadMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> monthProductionPlanYeildReadMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/monthProductionPlanYeildCreateMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> monthProductionPlanYeildCreateMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	@RequestMapping(value = "/wm/monthProductionPlanYeildDeleteMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> monthProductionPlanYeildDeleteMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//잡체인지 목록 모달
	@RequestMapping(value = "/wm/jcModalListMTP2", method = RequestMethod.GET)
	public @ResponseBody Map<String, Object> jcModalListMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//잡체인지 삭제
	@RequestMapping(value = "/wm/deleteMonthProductionPlanMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> deleteMonthProductionPlanMTP2(@RequestBody List<Map<String, Object>> dataList) throws Exception {
		...
		try {			
			...
			for (Map<String, Object> m : dataList) {
				...
				for(int i = 0; i < 31; i++) {
					...
					//monthProductionPlanVo2.setPlanCnt(Double.toString((((opTime * 60 * 60) * (Integer.parseInt(equipCodeAdmList.get(0).getEquipCapa())) * Double.parseDouble(readVo.getYeild1()) * Double.parseDouble(readVo.getYeild2()))) / Double.parseDouble(tecTime)) );			
					monthProductionPlanVo2.setPlanCnt(Double.toString((((opTime * 60 * 60) * (Double.parseDouble(equipCodeAdmList.get(0).getEquipCapa())) * Double.parseDouble(readVo.getYeild1()) * Double.parseDouble(readVo.getYeild2()))) / Double.parseDouble(tecTime)) );
					monthProductionPlanVo2.setRegId(Utils.getUserId());
	...
	@RequestMapping(value = "/wm/readMonthPlanBodySLDCheckMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> readMonthPlanBodySLDCheckMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//FP 데이터 삭제
	@RequestMapping(value = "/wm/deleteMonthProductionPlanMainMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> deleteMonthProductionPlanMainMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//메모 등록
	@RequestMapping(value = "/wm/createMonthProductionMemoMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> createMonthProductionMemoMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//메모 조회
	@RequestMapping(value = "/wm/memoMonthProductionMemoMTP2", method = RequestMethod.GET)
	public @ResponseBody Map<String, Object> memoMonthProductionMemoMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//기종별일일재고 목록 모달
	@RequestMapping(value = "/wm/dailyInvenListMTP2", method = RequestMethod.GET)
	public @ResponseBody Map<String, Object> dailyInvenListMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//기종별일일재고 목록 모달
	@RequestMapping(value = "/wm/dailyInvenReadMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> dailyInvenReadMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//기종별일일재고 등록
	@RequestMapping(value = "/wm/dailyInvenCreateMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> dailyInvenCreateMTP2(@RequestBody List<Map<String, Object>> dataList) throws Exception {
	...
	//기종별일일재고 실재고 등록
	@RequestMapping(value = "/wm/dailyInvenCreateRealMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> dailyInvenCreateRealMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//기종별일일재고 실데이터
	@RequestMapping(value = "/wm/gijongDailyPlan1MTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> gijongDailyPlan1MTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//기종별일일재고 실데이터
	@RequestMapping(value = "/wm/gijongDailyPlan2MTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> gijongDailyPlan2MTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
	...
	//기종별일일재고 실데이터 마감
	@RequestMapping(value = "/wm/createNextMonthStockMTP2", method = RequestMethod.POST)
	public @ResponseBody Map<String, Object> createNextMonthStockMTP2(MonthProductionPlanVo monthProductionPlanVo) throws Exception {
