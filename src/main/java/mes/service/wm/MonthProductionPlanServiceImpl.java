...
import mes.persistence.wm.MonthProductionPlanDAO;

@Service
public class MonthProductionPlanServiceImpl implements MonthProductionPlanService {

	@Inject
	private MonthProductionPlanDAO dao;
	...
	public List<MonthProductionPlanVo> dailyInvenDtlList(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		return dao.dailyInvenDtlList(monthProductionPlanVo);
	}
}
