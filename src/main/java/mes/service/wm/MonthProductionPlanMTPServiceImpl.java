...
import mes.persistence.wm.MonthProductionPlanMTPDAO;

@Service
public class MonthProductionPlanMTPServiceImpl implements MonthProductionPlanMTPService {

	@Inject
	private MonthProductionPlanMTPDAO dao;
	...
	//FP일지 1번리스트
	public List<MonthProductionPlanVo> fpDailyList1(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		List<MonthProductionPlanVo> list = dao.fpDailyList1(monthProductionPlanVo);
		List<MonthProductionPlanVo> list2 = dao.fpDailyList2(monthProductionPlanVo);
		List<MonthProductionPlanVo> complete = new ArrayList<MonthProductionPlanVo>();
		int i = 0;
		for(MonthProductionPlanVo m : list) {
			m.setOutputCnt(list2.get(i).getSumOutputCnt());			
			complete.add(m);
			i++;
		}
	...
	//FP일지 2번리스트
	public List<MonthProductionPlanVo> fpDailyList2(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		return dao.fpDailyList2(monthProductionPlanVo);
	}
	
	//FP일지 3번리스트
	public List<MonthProductionPlanVo> fpDailyList3(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		return dao.fpDailyList3(monthProductionPlanVo);
	}
	
	//계획대비실적 월별
	@Override
	public List<MonthProductionPlanVo> performanceAginstPlanMonth(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		return dao.performanceAginstPlanMonth(monthProductionPlanVo);
	}
	
	//계획대비실적 합계
	@Override
	public List<MonthProductionPlanVo> performanceAginstPlanTotal(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		return dao.performanceAginstPlanTotal(monthProductionPlanVo);
	}
	
	//매출계획대비실적 입력
	@Override
	public void createPerformanceAgainstPlan(List<MonthProductionPlanVo> monthProductionPlanVo) throws Exception{
		dao.createPerformanceAgainstPlan(monthProductionPlanVo);
	}
	
	//매출계획대비실적 조회
	@Override
	public List<MonthProductionPlanVo> readPerformanceAgainstPlan(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		return dao.readPerformanceAgainstPlan(monthProductionPlanVo);
	}
	
	//매출계획대비실적 삭제
	@Override
	public void deletePerformanceAgainstPlan(MonthProductionPlanVo monthProductionPlanVo) throws Exception{
		dao.deletePerformanceAgainstPlan(monthProductionPlanVo);
	}
}
