...
public interface LocationGroupService {
	 ...
	 * inspectInfoRead(SystemCommonGroupVo Vo) throws Exception;
	 * 
	 * //품질정보그룹 Create public void inspectInfoCreate(SystemCommonGroupVo Vo) throws
	 * Exception;
	 * 
	 * //품질정보그룹 Update public void inspectInfoUpdate(SystemCommonGroupVo Vo) throws
	 * Exception;
	 * 
